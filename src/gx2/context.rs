use crate::{bindings as c_wut, rrc::RrcGuard};
...
impl State for Tv {
    fn on_ready() {
        unsafe {
            c_wut::WHBGfxBeginRenderTV();
        }
    }

    fn on_finish() {
        unsafe {
            c_wut::WHBGfxFinishRenderTV();
        }
    }
}
impl State for Drc {
    fn on_ready() {
        unsafe {
            c_wut::WHBGfxBeginRenderDRC();
        }
    }

    fn on_finish() {
        unsafe {
            c_wut::WHBGfxFinishRenderDRC();
        }
    }
}
