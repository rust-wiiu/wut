...
impl Into<i32> for Language {
    fn into(self) -> i32 {
        ...
        const _: () = {
            macro_rules! check_lang_types {
                ($($variant:ident),*) => {
                    ...
                    const _: bool = {
                        $(
                            c_wut::nn_erreula_LangType::$variant ==
                            c_wut::nn_swkbd_LanguageType::$variant
                        )&&*
                    };
                }
            }
        ...
        use c_wut::nn_erreula_LangType as T;
        match self {
...
impl Into<i32> for Controller {
    fn into(self) -> i32 {
        ...
        const _: () = {
            macro_rules! check_lang_types {
                ($($variant:ident),*) => {
                    ...
                    const _: bool = {
                        $(
                            c_wut::nn_erreula_ControllerType::$variant ==
                            c_wut::nn_swkbd_ControllerType::$variant
                        )&&*
                    };
                }
            }
        ...
        use c_wut::nn_swkbd_ControllerType as T;
        match self {
...
impl Into<i32> for Region {
    fn into(self) -> i32 {
        ...
        const _: () = {
            macro_rules! check_lang_types {
                ($($variant:ident),*) => {
                    ...
                    const _: bool = {
                        $(
                            c_wut::nn_erreula_RegionType::$variant ==
                            c_wut::nn_swkbd_RegionType::$variant
                        )&&*
                    };
                }
            }
        ...
        use c_wut::nn_swkbd_RegionType as T;
        match self {
            Self::Japan => T::Japan,
            Self::USA => T::USA,
...
pub(crate) struct ControllerInfo {
    pub vpad: c_wut::VPADStatus,
    pub kpad: [c_wut::KPADStatus; 4],
}
...
impl ControllerInfo {
    pub fn read_vpad(&mut self) {
        unsafe {
            c_wut::VPADRead(
                c_wut::VPADChan::VPAD_CHAN_0,
                &mut self.vpad,
                1,
                core::ptr::null_mut(),
            );
            c_wut::VPADGetTPCalibratedPoint(
                c_wut::VPADChan::VPAD_CHAN_0,
    ...
    pub fn as_swkbd(&mut self) -> c_wut::nn_swkbd_ControllerInfo {
        c_wut::nn_swkbd_ControllerInfo {
            vpad: &mut self.vpad,
            kpad: [
                &mut self.kpad[0],
                &mut self.kpad[0],
    ...
    pub fn as_erreula(&mut self) -> c_wut::nn_erreula_ControllerInfo {
        c_wut::nn_erreula_ControllerInfo {
            vpad: &self.vpad,
