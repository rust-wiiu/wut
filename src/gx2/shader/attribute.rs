...
use crate::{bindings as c, math::FloatingMathExt};
use ::core::{
    marker::PhantomData,
...
pub trait Attributes: Sized {
    fn new(group: &mut c::WHBGfxShaderGroup) -> Result<Self, ()>;
}
...
impl AttributeFormat for Float4 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_FLOAT_32_32_32_32
    }
}
...
impl AttributeFormat for Float3 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_FLOAT_32_32_32
    }
}
...
impl AttributeFormat for Float2 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_FLOAT_32_32
    }
}
...
impl AttributeFormat for Float {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_FLOAT_32
    }
}
...
impl AttributeFormat for Int4 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_SINT_8_8_8_8
    }
}
...
impl AttributeFormat for Int2 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_SINT_8_8
    }
}
...
impl AttributeFormat for Int {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_SINT_8
    }
}
...
impl AttributeFormat for Uint4 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_UINT_8_8_8_8
    }
}
...
impl AttributeFormat for Uint2 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_UINT_8_8
    }
}
...
impl AttributeFormat for Uint {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_UINT_8
    }
}
...
impl AttributeFormat for Snorm4 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_SNORM_8_8_8_8
    }
}
...
impl AttributeFormat for Snorm2 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_SNORM_8_8
    }
}
...
impl AttributeFormat for Snorm {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_SNORM_8
    }
}
...
impl AttributeFormat for Norm4 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_UNORM_8_8_8_8
    }
}
...
impl AttributeFormat for Norm2 {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_UNORM_8_8
    }
}
...
impl AttributeFormat for Norm {
    fn gx2_attribute_format() -> c::GX2AttribFormat::Type {
        c::GX2AttribFormat::GX2_ATTRIB_FORMAT_UNORM_8
    }
}
