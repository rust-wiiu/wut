...
pub const OSMessageFlags_OS_MESSAGE_FLAGS_NONE: OSMessageFlags = 0;
pub const OSMessageFlags_OS_MESSAGE_FLAGS_BLOCKING: OSMessageFlags = 1;
pub const OSMessageFlags_OS_MESSAGE_FLAGS_HIGH_PRIORITY: OSMessageFlags = 2;
pub type OSMessageFlags = ::core::ffi::c_uint;
pub const OSFunctionType_OS_FUNCTION_TYPE_HIO_OPEN: OSFunctionType = 1;
pub const OSFunctionType_OS_FUNCTION_TYPE_HIO_READ_ASYNC: OSFunctionType = 2;
pub const OSFunctionType_OS_FUNCTION_TYPE_HIO_WRITE_ASYNC: OSFunctionType = 3;
pub const OSFunctionType_OS_FUNCTION_TYPE_FSA_CMD_ASYNC: OSFunctionType = 4;
pub const OSFunctionType_OS_FUNCTION_TYPE_FSA_PR_CMD_ASYNC: OSFunctionType = 5;
pub const OSFunctionType_OS_FUNCTION_TYPE_FSA_PR_CMD_ASYNC_NO_ALLOC: OSFunctionType = 6;
pub const OSFunctionType_OS_FUNCTION_TYPE_FSA_ATTACH_EVENT: OSFunctionType = 7;
pub const OSFunctionType_OS_FUNCTION_TYPE_FS_CMD_ASYNC: OSFunctionType = 8;
pub const OSFunctionType_OS_FUNCTION_TYPE_FS_CMD_HANDLER: OSFunctionType = 9;
pub const OSFunctionType_OS_FUNCTION_TYPE_FS_ATTACH_EVENT: OSFunctionType = 10;
pub const OSFunctionType_OS_FUNCTION_TYPE_FS_STATE_CHANGE_EVENT: OSFunctionType = 11;
...
pub struct OSCalendarTime {
    #[doc = "! Seconds after the minute. The range is 0-59."]
    pub tm_sec: i32,
    #[doc = "! Minutes after the hour. The range is 0-59."]
    pub tm_min: i32,
    #[doc = "! Hours since midnight. The range is 0-23."]
    pub tm_hour: i32,
    #[doc = "! Day of the month. The range is 1-31."]
    pub tm_mday: i32,
    #[doc = "! Month since January. The range is 0-11."]
    pub tm_mon: i32,
    #[doc = "! Years in AD. The range is 1-...."]
    pub tm_year: i32,
    #[doc = "! Days since Sunday. The range is 0-6."]
    pub tm_wday: i32,
    #[doc = "! Days since January 1. The range is 0-365."]
    pub tm_yday: i32,
    #[doc = "! Milliseconds after the second. The range is 0-999."]
    pub tm_msec: i32,
    #[doc = "! Microseconds after the millisecond. The range is 0-999."]
    pub tm_usec: i32,
}
extern "C" {
...
pub const IOSOpenMode_IOS_OPEN_READ: IOSOpenMode = 1;
pub const IOSOpenMode_IOS_OPEN_WRITE: IOSOpenMode = 2;
pub const IOSOpenMode_IOS_OPEN_READWRITE: IOSOpenMode = 3;
pub type IOSOpenMode = ::core::ffi::c_uint;
pub const IOSError_IOS_ERROR_OK: IOSError = 0;
pub const IOSError_IOS_ERROR_ACCESS: IOSError = -1;
pub const IOSError_IOS_ERROR_EXISTS: IOSError = -2;
pub const IOSError_IOS_ERROR_INTR: IOSError = -3;
pub const IOSError_IOS_ERROR_INVALID: IOSError = -4;
pub const IOSError_IOS_ERROR_MAX: IOSError = -5;
pub const IOSError_IOS_ERROR_NOEXISTS: IOSError = -6;
pub const IOSError_IOS_ERROR_QEMPTY: IOSError = -7;
pub const IOSError_IOS_ERROR_QFULL: IOSError = -8;
pub const IOSError_IOS_ERROR_UNKNOWN: IOSError = -9;
pub const IOSError_IOS_ERROR_NOTREADY: IOSError = -10;
pub const IOSError_IOS_ERROR_ECC: IOSError = -11;
pub const IOSError_IOS_ERROR_ECCCRIT: IOSError = -12;
pub const IOSError_IOS_ERROR_BADBLOCK: IOSError = -13;
pub const IOSError_IOS_ERROR_INVALIDOBJTYPE: IOSError = -14;
pub const IOSError_IOS_ERROR_INVALIDRNG: IOSError = -15;
pub const IOSError_IOS_ERROR_INVALIDFLAG: IOSError = -16;
pub const IOSError_IOS_ERROR_INVALIDFORMAT: IOSError = -17;
pub const IOSError_IOS_ERROR_INVALIDVERSION: IOSError = -18;
pub const IOSError_IOS_ERROR_INVALIDSIGNER: IOSError = -19;
pub const IOSError_IOS_ERROR_FAILCHECKVALUE: IOSError = -20;
pub const IOSError_IOS_ERROR_FAILINTERNAL: IOSError = -21;
pub const IOSError_IOS_ERROR_FAILALLOC: IOSError = -22;
pub const IOSError_IOS_ERROR_INVALIDSIZE: IOSError = -23;
pub const IOSError_IOS_ERROR_NOLINK: IOSError = -24;
pub const IOSError_IOS_ERROR_ANFAILED: IOSError = -25;
pub const IOSError_IOS_ERROR_MAXSEMCOUNT: IOSError = -26;
pub const IOSError_IOS_ERROR_SEMUNAVAILABLE: IOSError = -27;
pub const IOSError_IOS_ERROR_INVALIDHANDLE: IOSError = -28;
pub const IOSError_IOS_ERROR_INVALIDARG: IOSError = -29;
pub const IOSError_IOS_ERROR_NORESOURCE: IOSError = -30;
pub const IOSError_IOS_ERROR_BUSY: IOSError = -31;
pub const IOSError_IOS_ERROR_TIMEOUT: IOSError = -32;
pub const IOSError_IOS_ERROR_ALIGNMENT: IOSError = -33;
pub const IOSError_IOS_ERROR_BSP: IOSError = -34;
pub const IOSError_IOS_ERROR_DATAPENDING: IOSError = -35;
pub const IOSError_IOS_ERROR_EXPIRED: IOSError = -36;
pub const IOSError_IOS_ERROR_NOREADACCESS: IOSError = -37;
pub const IOSError_IOS_ERROR_NOWRITEACCESS: IOSError = -38;
pub const IOSError_IOS_ERROR_NOREADWRITEACCESS: IOSError = -39;
pub const IOSError_IOS_ERROR_CLIENTTXNLIMIT: IOSError = -40;
pub const IOSError_IOS_ERROR_STALEHANDLE: IOSError = -41;
pub const IOSError_IOS_ERROR_UNKNOWNVALUE: IOSError = -42;
...
#[doc = "! A bitfield of enum OS_CONTEXT_STATE."]
pub type OSContextState = u16;
pub const OS_CONTEXT_STATE_OS_CONTEXT_STATE_OSCALLBACK: OS_CONTEXT_STATE = 8;
pub const OS_CONTEXT_STATE_OS_CONTEXT_STATE_USERMODE_SAVED: OS_CONTEXT_STATE = 16;
...
pub const FSErrorFlag_FS_ERROR_FLAG_NONE: FSErrorFlag = 0;
pub const FSErrorFlag_FS_ERROR_FLAG_MAX: FSErrorFlag = 1;
pub const FSErrorFlag_FS_ERROR_FLAG_ALREADY_OPEN: FSErrorFlag = 2;
pub const FSErrorFlag_FS_ERROR_FLAG_EXISTS: FSErrorFlag = 4;
pub const FSErrorFlag_FS_ERROR_FLAG_NOT_FOUND: FSErrorFlag = 8;
pub const FSErrorFlag_FS_ERROR_FLAG_NOT_FILE: FSErrorFlag = 16;
pub const FSErrorFlag_FS_ERROR_FLAG_NOT_DIR: FSErrorFlag = 32;
pub const FSErrorFlag_FS_ERROR_FLAG_ACCESS_ERROR: FSErrorFlag = 64;
pub const FSErrorFlag_FS_ERROR_FLAG_PERMISSION_ERROR: FSErrorFlag = 128;
pub const FSErrorFlag_FS_ERROR_FLAG_FILE_TOO_BIG: FSErrorFlag = 256;
pub const FSErrorFlag_FS_ERROR_FLAG_STORAGE_FULL: FSErrorFlag = 512;
pub const FSErrorFlag_FS_ERROR_FLAG_UNSUPPORTED_CMD: FSErrorFlag = 1024;
pub const FSErrorFlag_FS_ERROR_FLAG_JOURNAL_FULL: FSErrorFlag = 2048;
pub const FSErrorFlag_FS_ERROR_FLAG_ALL: FSErrorFlag = 4294967295;
pub type FSErrorFlag = ::core::ffi::c_uint;
pub const FSStatus_FS_STATUS_OK: FSStatus = 0;
pub const FSStatus_FS_STATUS_CANCELLED: FSStatus = -1;
pub const FSStatus_FS_STATUS_END: FSStatus = -2;
pub const FSStatus_FS_STATUS_MAX: FSStatus = -3;
pub const FSStatus_FS_STATUS_ALREADY_OPEN: FSStatus = -4;
pub const FSStatus_FS_STATUS_EXISTS: FSStatus = -5;
pub const FSStatus_FS_STATUS_NOT_FOUND: FSStatus = -6;
pub const FSStatus_FS_STATUS_NOT_FILE: FSStatus = -7;
pub const FSStatus_FS_STATUS_NOT_DIR: FSStatus = -8;
pub const FSStatus_FS_STATUS_ACCESS_ERROR: FSStatus = -9;
pub const FSStatus_FS_STATUS_PERMISSION_ERROR: FSStatus = -10;
pub const FSStatus_FS_STATUS_FILE_TOO_BIG: FSStatus = -11;
pub const FSStatus_FS_STATUS_STORAGE_FULL: FSStatus = -12;
pub const FSStatus_FS_STATUS_JOURNAL_FULL: FSStatus = -13;
pub const FSStatus_FS_STATUS_UNSUPPORTED_CMD: FSStatus = -14;
pub const FSStatus_FS_STATUS_MEDIA_NOT_READY: FSStatus = -15;
pub const FSStatus_FS_STATUS_MEDIA_ERROR: FSStatus = -17;
pub const FSStatus_FS_STATUS_CORRUPTED: FSStatus = -18;
pub const FSStatus_FS_STATUS_FATAL_ERROR: FSStatus = -1024;
pub type FSStatus = ::core::ffi::c_int;
pub const FSError_FS_ERROR_OK: FSError = 0;
pub const FSError_FS_ERROR_NOT_INIT: FSError = -196609;
pub const FSError_FS_ERROR_BUSY: FSError = -196610;
pub const FSError_FS_ERROR_CANCELLED: FSError = -196611;
pub const FSError_FS_ERROR_END_OF_DIR: FSError = -196612;
pub const FSError_FS_ERROR_END_OF_FILE: FSError = -196613;
pub const FSError_FS_ERROR_MAX_MOUNT_POINTS: FSError = -196624;
pub const FSError_FS_ERROR_MAX_VOLUMES: FSError = -196625;
pub const FSError_FS_ERROR_MAX_CLIENTS: FSError = -196626;
pub const FSError_FS_ERROR_MAX_FILES: FSError = -196627;
pub const FSError_FS_ERROR_MAX_DIRS: FSError = -196628;
pub const FSError_FS_ERROR_ALREADY_OPEN: FSError = -196629;
pub const FSError_FS_ERROR_ALREADY_EXISTS: FSError = -196630;
pub const FSError_FS_ERROR_NOT_FOUND: FSError = -196631;
pub const FSError_FS_ERROR_NOT_EMPTY: FSError = -196632;
pub const FSError_FS_ERROR_ACCESS_ERROR: FSError = -196633;
pub const FSError_FS_ERROR_PERMISSION_ERROR: FSError = -196634;
pub const FSError_FS_ERROR_DATA_CORRUPTED: FSError = -196635;
pub const FSError_FS_ERROR_STORAGE_FULL: FSError = -196636;
pub const FSError_FS_ERROR_JOURNAL_FULL: FSError = -196637;
pub const FSError_FS_ERROR_UNAVAILABLE_COMMAND: FSError = -196639;
pub const FSError_FS_ERROR_UNSUPPORTED_COMMAND: FSError = -196640;
pub const FSError_FS_ERROR_INVALID_PARAM: FSError = -196641;
pub const FSError_FS_ERROR_INVALID_PATH: FSError = -196642;
pub const FSError_FS_ERROR_INVALID_BUFFER: FSError = -196643;
pub const FSError_FS_ERROR_INVALID_ALIGNMENT: FSError = -196644;
pub const FSError_FS_ERROR_INVALID_CLIENTHANDLE: FSError = -196645;
pub const FSError_FS_ERROR_INVALID_FILEHANDLE: FSError = -196646;
pub const FSError_FS_ERROR_INVALID_DIRHANDLE: FSError = -196647;
pub const FSError_FS_ERROR_NOT_FILE: FSError = -196648;
pub const FSError_FS_ERROR_NOT_DIR: FSError = -196649;
pub const FSError_FS_ERROR_FILE_TOO_BIG: FSError = -196650;
pub const FSError_FS_ERROR_OUT_OF_RANGE: FSError = -196651;
pub const FSError_FS_ERROR_OUT_OF_RESOURCES: FSError = -196652;
pub const FSError_FS_ERROR_MEDIA_NOT_READY: FSError = -196672;
pub const FSError_FS_ERROR_MEDIA_ERROR: FSError = -196673;
pub const FSError_FS_ERROR_WRITE_PROTECTED: FSError = -196674;
pub const FSError_FS_ERROR_INVALID_MEDIA: FSError = -196675;
pub type FSError = ::core::ffi::c_int;
pub const FSMode_FS_MODE_READ_OWNER: FSMode = 1024;
pub const FSMode_FS_MODE_WRITE_OWNER: FSMode = 512;
pub const FSMode_FS_MODE_EXEC_OWNER: FSMode = 256;
pub const FSMode_FS_MODE_READ_GROUP: FSMode = 64;
pub const FSMode_FS_MODE_WRITE_GROUP: FSMode = 32;
pub const FSMode_FS_MODE_EXEC_GROUP: FSMode = 16;
pub const FSMode_FS_MODE_READ_OTHER: FSMode = 4;
pub const FSMode_FS_MODE_WRITE_OTHER: FSMode = 2;
pub const FSMode_FS_MODE_EXEC_OTHER: FSMode = 1;
pub type FSMode = ::core::ffi::c_uint;
#[doc = "! The retrieved file entry is a (link to a) directory."]
pub const FSStatFlags_FS_STAT_DIRECTORY: FSStatFlags = 2147483648;
#[doc = "! The retrieved file entry also has a quota set."]
pub const FSStatFlags_FS_STAT_QUOTA: FSStatFlags = 1610612736;
#[doc = "! The retrieved file entry is a (link to a) file."]
pub const FSStatFlags_FS_STAT_FILE: FSStatFlags = 16777216;
#[doc = "! The retrieved file entry also is encrypted and can't be opened (see vWii files for example)."]
pub const FSStatFlags_FS_STAT_ENCRYPTED_FILE: FSStatFlags = 8388608;
#[doc = "! The retrieved file entry also is a link to a different file on the filesystem.\n! Note: It's currently not known how one can read the linked-to file entry."]
pub const FSStatFlags_FS_STAT_LINK: FSStatFlags = 65536;
#[doc = "! Flags for \\link FSStat \\endlink.\n! One can return multiple flags, so for example a file that's encrypted or a linked directory."]
pub type FSStatFlags = ::core::ffi::c_uint;
pub const FSVolumeState_FS_VOLUME_STATE_INITIAL: FSVolumeState = 0;
pub const FSVolumeState_FS_VOLUME_STATE_READY: FSVolumeState = 1;
pub const FSVolumeState_FS_VOLUME_STATE_NO_MEDIA: FSVolumeState = 2;
pub const FSVolumeState_FS_VOLUME_STATE_INVALID_MEDIA: FSVolumeState = 3;
pub const FSVolumeState_FS_VOLUME_STATE_DIRTY_MEDIA: FSVolumeState = 4;
pub const FSVolumeState_FS_VOLUME_STATE_WRONG_MEDIA: FSVolumeState = 5;
pub const FSVolumeState_FS_VOLUME_STATE_MEDIA_ERROR: FSVolumeState = 6;
pub const FSVolumeState_FS_VOLUME_STATE_DATA_CORRUPTED: FSVolumeState = 7;
pub const FSVolumeState_FS_VOLUME_STATE_WRITE_PROTECTED: FSVolumeState = 8;
pub const FSVolumeState_FS_VOLUME_STATE_JOURNAL_FULL: FSVolumeState = 9;
pub const FSVolumeState_FS_VOLUME_STATE_FATAL: FSVolumeState = 10;
pub const FSVolumeState_FS_VOLUME_STATE_INVALID: FSVolumeState = 11;
pub type FSVolumeState = ::core::ffi::c_uint;
pub const FSMediaState_FS_MEDIA_STATE_READY: FSMediaState = 0;
pub const FSMediaState_FS_MEDIA_STATE_NO_MEDIA: FSMediaState = 1;
pub const FSMediaState_FS_MEDIA_STATE_INVALID_MEDIA: FSMediaState = 2;
pub const FSMediaState_FS_MEDIA_STATE_DIRTY_MEDIA: FSMediaState = 3;
pub const FSMediaState_FS_MEDIA_STATE_MEDIA_ERROR: FSMediaState = 4;
pub type FSMediaState = ::core::ffi::c_uint;
pub const FSMountSourceType_FS_MOUNT_SOURCE_SD: FSMountSourceType = 0;
pub const FSMountSourceType_FS_MOUNT_SOURCE_UNK: FSMountSourceType = 1;
pub type FSMountSourceType = ::core::ffi::c_uint;
#[doc = "! Open file normally"]
pub const FSOpenFileFlags_FS_OPEN_FLAG_NONE: FSOpenFileFlags = 0;
#[doc = "! Open (new) unencrypted file. Used for vWii files since it allows for direct access without the Wii U filesystem through it's block address."]
pub const FSOpenFileFlags_FS_OPEN_FLAG_UNENCRYPTED: FSOpenFileFlags = 1;
#[doc = "! Preallocates new file size using given size"]
pub const FSOpenFileFlags_FS_OPEN_FLAG_PREALLOC_SIZE: FSOpenFileFlags = 2;
...
#[doc = " Link entry used for FSClientBodyQueue."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct FSClientBody {
    ...
    #[doc = "! IOSHandle returned from fsaShimOpen."]
    pub clientHandle: IOSHandle,
    #[doc = "! State machine."]
    pub fsm: FSFsm,
    #[doc = "! Command queue of FS commands."]
    pub cmdQueue: FSCmdQueue,
    #[doc = "! The last dequeued command."]
    pub lastDequeuedCommand: *mut FSCmdBlockBody,
    #[doc = "! Emulated error, set with FSSetEmulatedError."]
    pub emulatedError: FSError,
    pub __unk14: [::core::ffi::c_char; 148usize],
    #[doc = "! Mutex used to protect FSClientBody data."]
    pub mutex: OSFastMutex,
    pub __unk15: [::core::ffi::c_char; 4usize],
    #[doc = "! Alarm used by fsm for unknown reasons."]
    pub fsmAlarm: OSAlarm,
    #[doc = "! Error of last FS command."]
    pub lastError: FSError,
    pub isLastErrorWithoutVolume: bool,
    #[doc = "! Message used to send FsCmdHandler message when FSA async callback is received."]
    pub fsCmdHandlerMsg: FSMessage,
    #[doc = "! Device name of the last mount source returned by FSGetMountSourceNext."]
    pub lastMountSourceDevice: [::core::ffi::c_char; 16usize],
    #[doc = "! Mount source type to find with FSGetMountSourceNext."]
    pub findMountSourceType: FSMountSourceType,
    #[doc = "! Link used for linked list of clients."]
    pub link: FSClientBodyLink,
    #[doc = "! Pointer to unaligned FSClient structure."]
...
extern "C" {
    #[doc = "! File times aren't always available in which case it returns the default 1980-01-01."]
...
#[doc = "! Channel 0."]
pub const WPADChan_WPAD_CHAN_0: WPADChan = 0;
#[doc = "! Channel 1."]
pub const WPADChan_WPAD_CHAN_1: WPADChan = 1;
#[doc = "! Channel 2."]
pub const WPADChan_WPAD_CHAN_2: WPADChan = 2;
#[doc = "! Channel 3."]
pub const WPADChan_WPAD_CHAN_3: WPADChan = 3;
#[doc = "! Channel 4."]
pub const WPADChan_WPAD_CHAN_4: WPADChan = 4;
#[doc = "! Channel 5."]
pub const WPADChan_WPAD_CHAN_5: WPADChan = 5;
#[doc = "! Channel 6."]
pub const WPADChan_WPAD_CHAN_6: WPADChan = 6;
#[doc = "! Wii Remote channel."]
pub type WPADChan = ::core::ffi::c_uint;
#[doc = "! Wii Remote buttons"]
pub const WPADDataFormat_WPAD_FMT_CORE: WPADDataFormat = 0;
#[doc = "! Wii Remote buttons and accelerometer"]
pub const WPADDataFormat_WPAD_FMT_CORE_ACC: WPADDataFormat = 1;
#[doc = "! Wii Remote buttons, accelerometer and IR pos"]
pub const WPADDataFormat_WPAD_FMT_CORE_ACC_DPD: WPADDataFormat = 2;
#[doc = "! Wii Remote buttons, Nunchuk"]
pub const WPADDataFormat_WPAD_FMT_NUNCHUK: WPADDataFormat = 3;
#[doc = "! Wii Remote buttons, accelerometer, Nunchuk"]
pub const WPADDataFormat_WPAD_FMT_NUNCHUK_ACC: WPADDataFormat = 4;
#[doc = "! Wii Remote buttons, accelerometer, IR pos, Nunchuk"]
pub const WPADDataFormat_WPAD_FMT_NUNCHUK_ACC_DPD: WPADDataFormat = 5;
#[doc = "! Wii Remote buttons, Classic Controller"]
pub const WPADDataFormat_WPAD_FMT_CLASSIC: WPADDataFormat = 6;
#[doc = "! Wii Remote buttons, accelerometer, Classic Controller"]
pub const WPADDataFormat_WPAD_FMT_CLASSIC_ACC: WPADDataFormat = 7;
#[doc = "! Wii Remote buttons, accelerometer, IR pos, Classic Controller"]
pub const WPADDataFormat_WPAD_FMT_CLASSIC_ACC_DPD: WPADDataFormat = 8;
#[doc = "! Wii Remote buttons, accelerometer and IR pos with bounds"]
pub const WPADDataFormat_WPAD_FMT_CORE_ACC_DPD_FULL: WPADDataFormat = 9;
#[doc = "! Wii Remote, Densha De GO! Shinkansen Controller"]
pub const WPADDataFormat_WPAD_FMT_TRAIN: WPADDataFormat = 10;
#[doc = "! Guitar Hero Guitar"]
pub const WPADDataFormat_WPAD_FMT_GUITAR: WPADDataFormat = 11;
#[doc = "! Wii Balance Board"]
pub const WPADDataFormat_WPAD_FMT_BALANCE_BOARD: WPADDataFormat = 12;
#[doc = "! Guitar Hero World Tour Drums"]
pub const WPADDataFormat_WPAD_FMT_DRUM: WPADDataFormat = 15;
#[doc = "! Wii Remote buttons, accelerometer, IR pos, Motion Plus gyroscope"]
pub const WPADDataFormat_WPAD_FMT_MPLUS: WPADDataFormat = 16;
#[doc = "! Wii Remote, Taiko no Testsujin TaTaCon"]
pub const WPADDataFormat_WPAD_FMT_TAIKO: WPADDataFormat = 17;
#[doc = "! Wii U Pro Controller"]
pub const WPADDataFormat_WPAD_FMT_PRO_CONTROLLER: WPADDataFormat = 22;
#[doc = "! Data format."]
pub type WPADDataFormat = ::core::ffi::c_uint;
#[doc = "! Wii Remote with no extension."]
pub const WPADExtensionType_WPAD_EXT_CORE: WPADExtensionType = 0;
#[doc = "! Nunchuk."]
pub const WPADExtensionType_WPAD_EXT_NUNCHUK: WPADExtensionType = 1;
#[doc = "! Classic Controller."]
pub const WPADExtensionType_WPAD_EXT_CLASSIC: WPADExtensionType = 2;
#[doc = "! Motion Plus."]
pub const WPADExtensionType_WPAD_EXT_MPLUS: WPADExtensionType = 5;
#[doc = "! Motion Plus with Nunchuk."]
pub const WPADExtensionType_WPAD_EXT_MPLUS_NUNCHUK: WPADExtensionType = 6;
#[doc = "! Motion Plus with Classic Controller."]
pub const WPADExtensionType_WPAD_EXT_MPLUS_CLASSIC: WPADExtensionType = 7;
#[doc = "! Pro Controller."]
pub const WPADExtensionType_WPAD_EXT_PRO_CONTROLLER: WPADExtensionType = 31;
#[doc = "! No controller found."]
pub const WPADExtensionType_WPAD_EXT_DEV_NOT_FOUND: WPADExtensionType = 253;
#[doc = "! Extension unknown."]
pub const WPADExtensionType_WPAD_EXT_UNKNOWN: WPADExtensionType = 255;
#[doc = "! Extension type."]
pub type WPADExtensionType = ::core::ffi::c_uint;
#[doc = "! The left button of the D-pad."]
pub const WPADButton_WPAD_BUTTON_LEFT: WPADButton = 1;
#[doc = "! The right button of the D-pad."]
pub const WPADButton_WPAD_BUTTON_RIGHT: WPADButton = 2;
#[doc = "! The down button of the D-pad."]
pub const WPADButton_WPAD_BUTTON_DOWN: WPADButton = 4;
#[doc = "! The up button of the D-pad."]
pub const WPADButton_WPAD_BUTTON_UP: WPADButton = 8;
#[doc = "! The + button."]
pub const WPADButton_WPAD_BUTTON_PLUS: WPADButton = 16;
#[doc = "! The 2 button."]
pub const WPADButton_WPAD_BUTTON_2: WPADButton = 256;
#[doc = "! The 1 button."]
pub const WPADButton_WPAD_BUTTON_1: WPADButton = 512;
#[doc = "! The B button."]
pub const WPADButton_WPAD_BUTTON_B: WPADButton = 1024;
#[doc = "! The A button."]
pub const WPADButton_WPAD_BUTTON_A: WPADButton = 2048;
#[doc = "! The - button."]
pub const WPADButton_WPAD_BUTTON_MINUS: WPADButton = 4096;
#[doc = "! The Z button on the Nunchuk extension."]
pub const WPADButton_WPAD_BUTTON_Z: WPADButton = 8192;
#[doc = "! The C button on the Nunchuk extension."]
pub const WPADButton_WPAD_BUTTON_C: WPADButton = 16384;
#[doc = "! The HOME button."]
pub const WPADButton_WPAD_BUTTON_HOME: WPADButton = 32768;
#[doc = "! Wii Remote buttons."]
...
pub const WPADNunchukButton_WPAD_NUNCHUK_STICK_EMULATION_LEFT: WPADNunchukButton = 1;
#[doc = "! The emulated right button on the Nunchuk stick or the right button of the D-pad on the Wii Remote."]
pub const WPADNunchukButton_WPAD_NUNCHUK_STICK_EMULATION_RIGHT: WPADNunchukButton = 2;
#[doc = "! The emulated down button on the Nunchuk stick or the down button of the D-pad on the Wii Remote."]
pub const WPADNunchukButton_WPAD_NUNCHUK_STICK_EMULATION_DOWN: WPADNunchukButton = 4;
#[doc = "! The emulated up button on the Nunchuk stick or the up button of the D-pad on the Wii Remote."]
pub const WPADNunchukButton_WPAD_NUNCHUK_STICK_EMULATION_UP: WPADNunchukButton = 8;
#[doc = "! The Z button."]
pub const WPADNunchukButton_WPAD_NUNCHUK_BUTTON_Z: WPADNunchukButton = 8192;
#[doc = "! The C button."]
pub const WPADNunchukButton_WPAD_NUNCHUK_BUTTON_C: WPADNunchukButton = 16384;
#[doc = "! Nunchuk buttons."]
pub type WPADNunchukButton = ::core::ffi::c_uint;
#[doc = "! The up button of the D-pad."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_UP: WPADClassicButton = 1;
#[doc = "! The left button of the D-pad."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_LEFT: WPADClassicButton = 2;
#[doc = "! The ZR button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_ZR: WPADClassicButton = 4;
#[doc = "! The X button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_X: WPADClassicButton = 8;
#[doc = "! The A button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_A: WPADClassicButton = 16;
#[doc = "! The Y button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_Y: WPADClassicButton = 32;
#[doc = "! The B button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_B: WPADClassicButton = 64;
#[doc = "! The ZL button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_ZL: WPADClassicButton = 128;
#[doc = "! The R button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_R: WPADClassicButton = 512;
#[doc = "! The + button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_PLUS: WPADClassicButton = 1024;
#[doc = "! The HOME button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_HOME: WPADClassicButton = 2048;
#[doc = "! The - button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_MINUS: WPADClassicButton = 4096;
#[doc = "! The L button."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_L: WPADClassicButton = 8192;
#[doc = "! The down button of the D-pad."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_DOWN: WPADClassicButton = 16384;
#[doc = "! The right button of the D-pad."]
pub const WPADClassicButton_WPAD_CLASSIC_BUTTON_RIGHT: WPADClassicButton = 32768;
#[doc = "! The emulated left button on the left stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_L_EMULATION_LEFT: WPADClassicButton = 65536;
#[doc = "! The emulated right button on the left stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_L_EMULATION_RIGHT: WPADClassicButton = 131072;
#[doc = "! The emulated down button on the left stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_L_EMULATION_DOWN: WPADClassicButton = 262144;
#[doc = "! The emulated up button on the left stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_L_EMULATION_UP: WPADClassicButton = 524288;
#[doc = "! The emulated left button on the right stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_R_EMULATION_LEFT: WPADClassicButton = 1048576;
#[doc = "! The emulated right button on the right stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_R_EMULATION_RIGHT: WPADClassicButton = 2097152;
#[doc = "! The emulated down button on the right stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_R_EMULATION_DOWN: WPADClassicButton = 4194304;
#[doc = "! The emulated up button on the right stick."]
pub const WPADClassicButton_WPAD_CLASSIC_STICK_R_EMULATION_UP: WPADClassicButton = 8388608;
#[doc = "! Classic Controller buttons."]
pub type WPADClassicButton = ::core::ffi::c_uint;
#[doc = "! The up button of the D-pad."]
pub const WPADProButton_WPAD_PRO_BUTTON_UP: WPADProButton = 1;
#[doc = "! The left button of the D-pad."]
pub const WPADProButton_WPAD_PRO_BUTTON_LEFT: WPADProButton = 2;
#[doc = "! The ZR button."]
pub const WPADProButton_WPAD_PRO_TRIGGER_ZR: WPADProButton = 4;
#[doc = "! The X button."]
pub const WPADProButton_WPAD_PRO_BUTTON_X: WPADProButton = 8;
#[doc = "! The A button."]
pub const WPADProButton_WPAD_PRO_BUTTON_A: WPADProButton = 16;
#[doc = "! The Y button."]
pub const WPADProButton_WPAD_PRO_BUTTON_Y: WPADProButton = 32;
#[doc = "! The B button."]
pub const WPADProButton_WPAD_PRO_BUTTON_B: WPADProButton = 64;
#[doc = "! The ZL button."]
pub const WPADProButton_WPAD_PRO_TRIGGER_ZL: WPADProButton = 128;
#[doc = "! Reserved."]
pub const WPADProButton_WPAD_PRO_RESERVED: WPADProButton = 256;
#[doc = "! The right trigger button."]
pub const WPADProButton_WPAD_PRO_TRIGGER_R: WPADProButton = 512;
#[doc = "! The + button."]
pub const WPADProButton_WPAD_PRO_BUTTON_PLUS: WPADProButton = 1024;
#[doc = "! The HOME button."]
pub const WPADProButton_WPAD_PRO_BUTTON_HOME: WPADProButton = 2048;
#[doc = "! The - button."]
pub const WPADProButton_WPAD_PRO_BUTTON_MINUS: WPADProButton = 4096;
#[doc = "! The left trigger button."]
pub const WPADProButton_WPAD_PRO_TRIGGER_L: WPADProButton = 8192;
#[doc = "! The down button of the D-pad."]
pub const WPADProButton_WPAD_PRO_BUTTON_DOWN: WPADProButton = 16384;
#[doc = "! The right button of the D-pad."]
pub const WPADProButton_WPAD_PRO_BUTTON_RIGHT: WPADProButton = 32768;
#[doc = "! The right stick button."]
pub const WPADProButton_WPAD_PRO_BUTTON_STICK_R: WPADProButton = 65536;
#[doc = "! The left stick button."]
pub const WPADProButton_WPAD_PRO_BUTTON_STICK_L: WPADProButton = 131072;
#[doc = "! The emulated up button on the left stick."]
pub const WPADProButton_WPAD_PRO_STICK_L_EMULATION_UP: WPADProButton = 2097152;
#[doc = "! The emulated down button on the left stick."]
pub const WPADProButton_WPAD_PRO_STICK_L_EMULATION_DOWN: WPADProButton = 1048576;
#[doc = "! The emulated left button on the left stick."]
pub const WPADProButton_WPAD_PRO_STICK_L_EMULATION_LEFT: WPADProButton = 262144;
#[doc = "! The emulated right button on the left stick."]
pub const WPADProButton_WPAD_PRO_STICK_L_EMULATION_RIGHT: WPADProButton = 524288;
#[doc = "! The emulated up button on the right stick."]
pub const WPADProButton_WPAD_PRO_STICK_R_EMULATION_UP: WPADProButton = 33554432;
#[doc = "! The emulated down button on the right stick."]
pub const WPADProButton_WPAD_PRO_STICK_R_EMULATION_DOWN: WPADProButton = 16777216;
#[doc = "! The emulated left button on the right stick."]
pub const WPADProButton_WPAD_PRO_STICK_R_EMULATION_LEFT: WPADProButton = 4194304;
#[doc = "! The emulated right button on the right stick."]
pub const WPADProButton_WPAD_PRO_STICK_R_EMULATION_RIGHT: WPADProButton = 8388608;
#[doc = "! Pro Controller buttons."]
pub type WPADProButton = ::core::ffi::c_uint;
pub const WPADLed_WPAD_LED_ONE: WPADLed = 1;
pub const WPADLed_WPAD_LED_TWO: WPADLed = 2;
pub const WPADLed_WPAD_LED_THREE: WPADLed = 4;
pub const WPADLed_WPAD_LED_FOUR: WPADLed = 8;
#[doc = "! WPAD Led flags"]
pub type WPADLed = ::core::ffi::c_uint;
#[doc = "! Disable IR"]
pub const WPADDpdFormat_WPAD_DPD_FMT_NONE: WPADDpdFormat = 0;
#[doc = "! Disable IR"]
pub const WPADDpdFormat_WPAD_DPD_FMT_BASIC: WPADDpdFormat = 1;
#[doc = "! Disable IR"]
pub const WPADDpdFormat_WPAD_DPD_FMT_EXTENDED: WPADDpdFormat = 3;
#[doc = "! Disable IR"]
pub const WPADDpdFormat_WPAD_DPD_FMT_FULL: WPADDpdFormat = 5;
#[doc = "!  WPAD Infrared Format. For more information see <a href=\"https://wiibrew.org/wiki/Wiimote#Data_Formats\">IR Data Formats</a>"]
pub type WPADDpdFormat = ::core::ffi::c_uint;
#[doc = "! Deinitializes and turns off speaker"]
pub const WPADSpeakerCmd_WPAD_SPEAKER_CMD_OFF: WPADSpeakerCmd = 0;
#[doc = "! Turns on and initializes speaker to use 4-bit Yamaha ADPCM data format at 3000 Hz"]
pub const WPADSpeakerCmd_WPAD_SPEAKER_CMD_ON: WPADSpeakerCmd = 1;
#[doc = "! Mutes speaker"]
pub const WPADSpeakerCmd_WPAD_SPEAKER_CMD_MUTE: WPADSpeakerCmd = 2;
#[doc = "! Unmutes speaker"]
pub const WPADSpeakerCmd_WPAD_SPEAKER_CMD_UNMUTE: WPADSpeakerCmd = 3;
#[doc = "! Allows sound to play"]
pub const WPADSpeakerCmd_WPAD_SPEAKER_CMD_PLAY: WPADSpeakerCmd = 4;
#[doc = "! Does the same as WPAD_SPEAKER_CMD_ON"]
pub const WPADSpeakerCmd_WPAD_SPEAKER_CMD_ON_ALT: WPADSpeakerCmd = 5;
#[doc = "! WPAD Speaker Command."]
pub type WPADSpeakerCmd = ::core::ffi::c_uint;
pub const WPADMplsMode_WPAD_MPLS_MODE_DISABLE: WPADMplsMode = 0;
#[doc = "! MotionPlus exclusive mode"]
pub const WPADMplsMode_WPAD_MPLS_MODE_MPLS_ONLY: WPADMplsMode = 4;
#[doc = "! Nunchuk passthrough mode"]
pub const WPADMplsMode_WPAD_MPLS_MODE_MPLS_NUNCHUK: WPADMplsMode = 5;
#[doc = "! Classic passthrough mode"]
pub const WPADMplsMode_WPAD_MPLS_MODE_MPLS_CLASSIC: WPADMplsMode = 7;
#[doc = "! MotionPlus Mode."]
pub type WPADMplsMode = ::core::ffi::c_uint;
pub const WPADPeripheralSpace_WPAD_PERIPHERAL_SPACE_SPEAKER: WPADPeripheralSpace = 162;
#[doc = "! Any extension other than Motion Plus"]
pub const WPADPeripheralSpace_WPAD_PERIPHERAL_SPACE_EXTENSION: WPADPeripheralSpace = 164;
#[doc = "! Any extension other than Motion Plus"]
pub const WPADPeripheralSpace_WPAD_PERIPHERAL_SPACE_MOTIONPLUS: WPADPeripheralSpace = 166;
#[doc = "! Infrared"]
pub const WPADPeripheralSpace_WPAD_PERIPHERAL_SPACE_DPD: WPADPeripheralSpace = 176;
#[doc = "! WPAD Peripheral Memory Space Prefixes"]
...
extern "C" {
    #[doc = " Returns the associated controller's IR mode"]
    pub fn WPADGetDpdFormat(chan: WPADChan) -> WPADDpdFormat;
}
extern "C" {
    #[doc = " Controls the associated WPADChan's rumble motor."]
    pub fn WPADControlMotor(chan: WPADChan, motorEnabled: BOOL);
}
extern "C" {
    #[doc = " Sets the wiimote speaker mode"]
...
extern "C" {
    #[doc = " Reads from the registers of the Wii Remote's peripherals\n \\param address address within the peripheral's memory space\n \\sa\n - WPADReadMemoryAsync()\n - WPADWriteExtReg()"]
...
extern "C" {
    #[doc = " Sets power save mode, this makes the controller only report input data\n when it changes"]
    pub fn WPADSetPowerSaveMode(chan: WPADChan, powerSave: BOOL);
}
extern "C" {
    #[doc = " \\return FALSE, if power save mode is off"]
    pub fn WPADGetPowerSaveMode(chan: WPADChan) -> BOOL;
}
extern "C" {
    #[doc = " Retrieves the bluetooth address of the controller"]
    pub fn WPADGetAddress(chan: WPADChan, outAddress: *mut WPADAddress);
}
extern "C" {
    #[doc = " Enables/disables motors globally"]
    pub fn WPADEnableMotor(enable: BOOL);
}
extern "C" {
    #[doc = " Returns whether motors are disabled globally"]
    pub fn WPADIsMotorEnabled() -> BOOL;
}
extern "C" {
    #[doc = " Enables/disables Wii U Pro Controller support"]
    pub fn WPADEnableURCC(enable: BOOL);
}
extern "C" {
    #[doc = " Returns whether Wii U Pro Controllers are supported"]
    pub fn WPADIsEnabledURC() -> BOOL;
}
extern "C" {
    #[doc = " Enables/disables Wii Balance Board support"]
    pub fn WPADEnableWBC(enable: BOOL);
}
extern "C" {
    #[doc = " Returns whether Wii Balance Boards are supported"]
    pub fn WPADIsEnableWBC() -> BOOL;
}
extern "C" {
    #[doc = " Enables/disables Wii Remote support"]
...
extern "C" {
    #[doc = " Set function to be run upon controller connect/disconnect\n \\returns the previously used callback"]
...
extern "C" {
    #[doc = " Set the function to be run upon extension connect and motion plus activation\n \\return the previously used callback"]
...
extern "C" {
    #[doc = " Queues HID Report for setting data reporting mode\n used internally by \\link WPADSetPowerSaveMode \\endlink\n \\return TRUE if successfully added to queue"]
...
extern "C" {
    #[doc = " Queues HID Report for enabling the IR Camera clock\n used internally by \\link WPADControlDpd \\endlink\n \\return TRUE if successfully added to queue"]
...
extern "C" {
    #[doc = " Queues HID Report for enabling IR Camera\n used internally by \\link WPADControlDpd \\endlink\n \\return TRUE if successfully added to queue"]
...
extern "C" {
    #[doc = " Queues HID Report for muting speakers\n used internally by \\link WPADControlSpeaker \\link\n \\return TRUE if successfully added to queue"]
...
extern "C" {
    #[doc = " Queues HID Report for sending speaker stream data\n used internally by \\link WPADSendStreamData \\endlink\n \\return TRUE if successfully added to queue"]
...
extern "C" {
    #[doc = " Queues HID Report for a single-byte memory write\n \\return TRUE if successfully added to queue"]
...
extern "C" {
    #[doc = " Queues HID Report for a multi-byte memory write\n used internally by \\link WPADWriteMemory \\endlink\n \\return TRUE if successfully added to queue"]
...
pub const KPADError_KPAD_ERROR_OK: KPADError = 0;
#[doc = "! There was no sample new data available to write."]
pub const KPADError_KPAD_ERROR_NO_SAMPLES: KPADError = -1;
#[doc = "! The requested controller or channel was invalid."]
pub const KPADError_KPAD_ERROR_INVALID_CONTROLLER: KPADError = -2;
#[doc = "! WPAD is uninitialized, shouldn't happen unless WPADShutdown() is manually called"]
pub const KPADError_KPAD_ERROR_WPAD_UNINIT: KPADError = -3;
#[doc = "! KPAD channel is busy, perhaps being accessed by another thread"]
pub const KPADError_KPAD_ERROR_BUSY: KPADError = -4;
#[doc = "! KPAD is uninitialized, need to call KPADInit()"]
pub const KPADError_KPAD_ERROR_UNINITIALIZED: KPADError = -5;
#[doc = "! Error."]
...
#[doc = "! A structure containing the Wii Remote data."]
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
    #[doc = " Enable IR pointing"]
    pub fn KPADEnableDPD(chan: KPADChan);
}
extern "C" {
    #[doc = " Disable IR pointing"]
    pub fn KPADDisableDPD(chan: KPADChan);
}
#[doc = "! Channel 0."]
pub const VPADChan_VPAD_CHAN_0: VPADChan = 0;
#[doc = "! Channel 1."]
pub const VPADChan_VPAD_CHAN_1: VPADChan = 1;
#[doc = "! Wii U GamePad channel."]
pub type VPADChan = ::core::ffi::c_uint;
#[doc = "! Indicates that there is pending data which can be received"]
pub const VPADIRCStatusFlags_VPAD_IRC_STATUS_FLAG_HAS_DATA: VPADIRCStatusFlags = 1;
#[doc = "! Indicates that another device is connected"]
pub const VPADIRCStatusFlags_VPAD_IRC_STATUS_FLAG_CONNECTED: VPADIRCStatusFlags = 2;
pub type VPADIRCStatusFlags = ::core::ffi::c_uint;
extern "C" {
    #[doc = " Initializes the VPADBASE library for use.\n\n \\note\n This is internally called by vpad and does not need to be called manually.\n\n \\sa\n - \\link VPADBASEShutdown \\endlink"]
    pub fn VPADBASEInit();
}
extern "C" {
    #[doc = " Deinitializes the VPADBASE library.\n\n \\note\n This is internally called by vpad and does not need to be called manually.\n\n \\sa\n - \\link VPADBASEInit \\endlink"]
    pub fn VPADBASEShutdown();
}
extern "C" {
    #[doc = " Checks if VPADBASE is initialized.\n\n \\returns\n \\c TRUE if initialized."]
...
#[doc = "! The A button."]
pub const VPADButtons_VPAD_BUTTON_A: VPADButtons = 32768;
#[doc = "! The B button."]
pub const VPADButtons_VPAD_BUTTON_B: VPADButtons = 16384;
#[doc = "! The X button."]
pub const VPADButtons_VPAD_BUTTON_X: VPADButtons = 8192;
#[doc = "! The Y button."]
pub const VPADButtons_VPAD_BUTTON_Y: VPADButtons = 4096;
#[doc = "! The left button of the D-pad."]
pub const VPADButtons_VPAD_BUTTON_LEFT: VPADButtons = 2048;
#[doc = "! The right button of the D-pad."]
pub const VPADButtons_VPAD_BUTTON_RIGHT: VPADButtons = 1024;
#[doc = "! The up button of the D-pad."]
pub const VPADButtons_VPAD_BUTTON_UP: VPADButtons = 512;
#[doc = "! The down button of the D-pad."]
pub const VPADButtons_VPAD_BUTTON_DOWN: VPADButtons = 256;
#[doc = "! The ZL button."]
pub const VPADButtons_VPAD_BUTTON_ZL: VPADButtons = 128;
#[doc = "! The ZR button."]
pub const VPADButtons_VPAD_BUTTON_ZR: VPADButtons = 64;
#[doc = "! The L button."]
pub const VPADButtons_VPAD_BUTTON_L: VPADButtons = 32;
#[doc = "! The R button."]
pub const VPADButtons_VPAD_BUTTON_R: VPADButtons = 16;
#[doc = "! The + button."]
pub const VPADButtons_VPAD_BUTTON_PLUS: VPADButtons = 8;
#[doc = "! The - button."]
pub const VPADButtons_VPAD_BUTTON_MINUS: VPADButtons = 4;
#[doc = "! The HOME button."]
pub const VPADButtons_VPAD_BUTTON_HOME: VPADButtons = 2;
#[doc = "! The SYNC button."]
pub const VPADButtons_VPAD_BUTTON_SYNC: VPADButtons = 1;
#[doc = "! The right stick button."]
pub const VPADButtons_VPAD_BUTTON_STICK_R: VPADButtons = 131072;
#[doc = "! The left stick button."]
pub const VPADButtons_VPAD_BUTTON_STICK_L: VPADButtons = 262144;
#[doc = "! The TV button."]
pub const VPADButtons_VPAD_BUTTON_TV: VPADButtons = 65536;
#[doc = "! The emulated left button on the right stick."]
pub const VPADButtons_VPAD_STICK_R_EMULATION_LEFT: VPADButtons = 67108864;
#[doc = "! The emulated right button on the right stick."]
pub const VPADButtons_VPAD_STICK_R_EMULATION_RIGHT: VPADButtons = 33554432;
#[doc = "! The emulated up button on the right stick."]
pub const VPADButtons_VPAD_STICK_R_EMULATION_UP: VPADButtons = 16777216;
#[doc = "! The emulated down button on the right stick."]
pub const VPADButtons_VPAD_STICK_R_EMULATION_DOWN: VPADButtons = 8388608;
#[doc = "! The emulated left button on the left stick."]
pub const VPADButtons_VPAD_STICK_L_EMULATION_LEFT: VPADButtons = 1073741824;
#[doc = "! The emulated right button on the left stick."]
pub const VPADButtons_VPAD_STICK_L_EMULATION_RIGHT: VPADButtons = 536870912;
#[doc = "! The emulated up button on the left stick."]
pub const VPADButtons_VPAD_STICK_L_EMULATION_UP: VPADButtons = 268435456;
#[doc = "! The emulated down button on the left stick."]
pub const VPADButtons_VPAD_STICK_L_EMULATION_DOWN: VPADButtons = 134217728;
#[doc = "! Wii U GamePad buttons."]
pub type VPADButtons = ::core::ffi::c_uint;
#[doc = "! Both X and Y touchpad positions are accurate."]
pub const VPADTouchPadValidity_VPAD_VALID: VPADTouchPadValidity = 0;
#[doc = "! X position is inaccurate."]
pub const VPADTouchPadValidity_VPAD_INVALID_X: VPADTouchPadValidity = 1;
#[doc = "! Y position is inaccurate."]
pub const VPADTouchPadValidity_VPAD_INVALID_Y: VPADTouchPadValidity = 2;
#[doc = "! Touch pad validity."]
pub type VPADTouchPadValidity = ::core::ffi::c_uint;
#[doc = "! 1920 x 1080 resolution."]
pub const VPADTouchPadResolution_VPAD_TP_1920X1080: VPADTouchPadResolution = 0;
#[doc = "! 1280 x 720 resolution."]
pub const VPADTouchPadResolution_VPAD_TP_1280X720: VPADTouchPadResolution = 1;
#[doc = "! 854 x 480 resolution."]
pub const VPADTouchPadResolution_VPAD_TP_854X480: VPADTouchPadResolution = 2;
#[doc = "! Touch pad resolution."]
pub type VPADTouchPadResolution = ::core::ffi::c_uint;
#[doc = "! No error occurred, and data was written to the buffers."]
pub const VPADReadError_VPAD_READ_SUCCESS: VPADReadError = 0;
#[doc = "! There was no sample new data available to write."]
pub const VPADReadError_VPAD_READ_NO_SAMPLES: VPADReadError = -1;
#[doc = "! The requested controller or channel was invalid."]
pub const VPADReadError_VPAD_READ_INVALID_CONTROLLER: VPADReadError = -2;
#[doc = "! VPAD channel is busy, perhaps being accessed by another thread"]
pub const VPADReadError_VPAD_READ_BUSY: VPADReadError = -4;
#[doc = "! VPAD is uninitialized, need to call VPADInit()"]
pub const VPADReadError_VPAD_READ_UNINITIALIZED: VPADReadError = -5;
#[doc = "! Read error."]
pub type VPADReadError = ::core::ffi::c_int;
#[doc = "! Display is in standby and will turn back on if any buttons are pressed."]
pub const VPADLcdMode_VPAD_LCD_STANDBY: VPADLcdMode = 0;
#[doc = "! Display is completely off and will remain so until explicitly changed."]
pub const VPADLcdMode_VPAD_LCD_OFF: VPADLcdMode = 1;
#[doc = "! Display is on as normal."]
pub const VPADLcdMode_VPAD_LCD_ON: VPADLcdMode = 255;
#[doc = "! LCD mode."]
pub type VPADLcdMode = ::core::ffi::c_uint;
pub const VPADGyroZeroDriftMode_VPAD_GYRO_ZERODRIFT_LOOSE: VPADGyroZeroDriftMode = 0;
pub const VPADGyroZeroDriftMode_VPAD_GYRO_ZERODRIFT_STANDARD: VPADGyroZeroDriftMode = 1;
pub const VPADGyroZeroDriftMode_VPAD_GYRO_ZERODRIFT_TIGHT: VPADGyroZeroDriftMode = 2;
pub const VPADGyroZeroDriftMode_VPAD_GYRO_ZERODRIFT_NONE: VPADGyroZeroDriftMode = 3;
#[doc = "! Gyro zero drift mode."]
...
pub const MICError_MIC_ERROR_OK: MICError = 0;
pub const MICError_MIC_ERROR_NOT_OPENED: MICError = -1;
pub const MICError_MIC_ERROR_INVALID_HANDLE: MICError = -2;
pub const MICError_MIC_ERROR_INIT: MICError = -5;
pub const MICError_MIC_ERROR_ALREADY_CLOSED: MICError = -7;
pub const MICError_MIC_ERROR_INVALID_INSTANCE: MICError = -8;
pub type MICError = ::core::ffi::c_int;
pub const MICInstance_MIC_INSTANCE_0: MICInstance = 0;
pub const MICInstance_MIC_INSTANCE_1: MICInstance = 1;
pub type MICInstance = ::core::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct MICWorkMemory {
    #[doc = "! Maximum amount of samples at a time must be at least 0x2800."]
    pub sampleMaxCount: usize,
    #[doc = "! A 0x40 aligned buffer of size sampleMaxCount * 2."]
...
extern "C" {
    #[doc = " The second parameter to MICInit is unused, any value is valid."]
    pub fn MICInit(
...
pub const NFCMode_NFC_MODE_INVALID: NFCMode = -1;
#[doc = "! NFC is idle"]
pub const NFCMode_NFC_MODE_IDLE: NFCMode = 0;
#[doc = "! NFC is discovering / has an active tag"]
pub const NFCMode_NFC_MODE_ACTIVE: NFCMode = 1;
pub type NFCMode = ::core::ffi::c_int;
pub const NFCProtocolEnum_NFC_PROTOCOL_UNKNOWN: NFCProtocolEnum = 0;
pub const NFCProtocolEnum_NFC_PROTOCOL_T1T: NFCProtocolEnum = 1;
pub const NFCProtocolEnum_NFC_PROTOCOL_T2T: NFCProtocolEnum = 2;
pub const NFCProtocolEnum_NFC_PROTOCOL_T3T: NFCProtocolEnum = 3;
pub const NFCProtocolEnum_NFC_PROTOCOL_ISO_DEP: NFCProtocolEnum = 4;
pub const NFCProtocolEnum_NFC_PROTOCOL_15693: NFCProtocolEnum = 131;
pub type NFCProtocolEnum = ::core::ffi::c_uint;
pub const NFCTechnologyEnum_NFC_TECHNOLOGY_A: NFCTechnologyEnum = 0;
pub const NFCTechnologyEnum_NFC_TECHNOLOGY_B: NFCTechnologyEnum = 1;
pub const NFCTechnologyEnum_NFC_TECHNOLOGY_F: NFCTechnologyEnum = 2;
pub const NFCTechnologyEnum_NFC_TECHNOLOGY_ISO15693: NFCTechnologyEnum = 6;
pub type NFCTechnologyEnum = ::core::ffi::c_uint;
pub const NFCTechnologyMaskEnum_NFC_TECHNOLOGY_MASK_ALL: NFCTechnologyMaskEnum = 0;
pub const NFCTechnologyMaskEnum_NFC_TECHNOLOGY_MASK_A: NFCTechnologyMaskEnum = 1;
pub const NFCTechnologyMaskEnum_NFC_TECHNOLOGY_MASK_B: NFCTechnologyMaskEnum = 2;
pub const NFCTechnologyMaskEnum_NFC_TECHNOLOGY_MASK_F: NFCTechnologyMaskEnum = 4;
pub const NFCTechnologyMaskEnum_NFC_TECHNOLOGY_MASK_ISO15693: NFCTechnologyMaskEnum = 8;
pub type NFCTechnologyMaskEnum = ::core::ffi::c_uint;
#[doc = "! Tag is read only"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_READ_ONLY: NFCNDEFFlagsEnum = 1;
#[doc = "! Tag formated for NDEF"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_FORMATED: NFCNDEFFlagsEnum = 2;
#[doc = "! NDEF supported by the tag"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_SUPPORTED: NFCNDEFFlagsEnum = 4;
#[doc = "! Unable to find if tag is ndef capable/formated/read only"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_UNKNOWN: NFCNDEFFlagsEnum = 8;
#[doc = "! Tag supports format operation"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_FORMATABLE: NFCNDEFFlagsEnum = 16;
#[doc = "! Tag can be soft locked"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_SOFT_LOCKABLE: NFCNDEFFlagsEnum = 32;
#[doc = "! Tag can be hard locked"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_HARD_LOCKABLE: NFCNDEFFlagsEnum = 64;
#[doc = "! Tag is one time programmable"]
pub const NFCNDEFFlagsEnum_NFC_NDEF_FLAG_OTP: NFCNDEFFlagsEnum = 128;
...
pub struct NFCReadT2TResult {
    #[doc = "! The amount of reads which have been performed"]
    pub numReads: u8,
    pub read0Start: u8,
    pub read0End: u8,
    pub read1Start: u8,
...
>;
#[doc = " Callback function for \\link NFCSendRawData \\endlink and variations.\n\n \\param chan\n The channel this callback is coming from.\n\n \\param error\n 0 on success.\n\n \\param responseSize\n The size of the responseData.\n\n \\param responseData\n The data received from the tag.\n\n \\param userContext\n User provided value."]
...
>;
#[doc = " Callback function for \\link NFCGetTagInfo \\endlink.\n\n \\param chan\n The channel this callback is coming from.\n\n \\param error\n 0 on success.\n\n \\param tagInfo\n The tag info.\n\n \\param userContext\n User provided value."]
...
>;
extern "C" {
    #[doc = " Initializes the NFC library.\n\n \\param chan\n The DRC channel to use.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Set a callback which will be called once a tag is attached / removed.\n\n \\param chan\n The DRC channel to use.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback."]
...
extern "C" {
    #[doc = " Start tag discovery and provide info about the first detected tag.\n\n \\param chan\n The DRC channel to use.\n\n \\param discoveryTimeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
    pub fn NFCDetect(
        chan: VPADChan,
...
extern "C" {
    #[doc = " Check if the tag is NDEF Formatable. If yes, format the tag.\n\n \\param chan\n The DRC channel to use.\n\n \\param discoveryTimeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param uid\n The UID of the expected tag.\n\n \\param uidMask\n The UID of the tag will be masked with this mask before compared to the expected UID.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
    pub fn NFCFormat(
        chan: VPADChan,
        discoveryTimeout: u32,
        uid: *mut NFCUid,
...
extern "C" {
    #[doc = " Obtain info about multiple tags.\n\n \\param chan\n The DRC channel to use.\n\n \\param discoveryTimeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Check if a tag is still present.\n\n \\param chan\n The DRC channel to use.\n\n \\param discoveryTimeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param uid\n The UID of the expected tag.\n\n \\param uidMask\n The UID of the tag will be masked with this mask before compared to the expected UID.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Make a Type 1 Tag read only by setting the RWA byte.\n\n \\param chan\n The DRC channel to use.\n\n \\param discoveryTimeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param uid\n The UID of the expected tag.\n\n \\param uidMask\n The UID of the tag will be masked with this mask before compared to the expected UID.\n\n \\param readOnly\n \\c TRUE if read only, \\c FALSE otherwise.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Abort and call pending callbacks.\n\n \\param chan\n The DRC channel to use.\n\n \\return\n 0 on success."]
    pub fn __NFCSystemAbort(chan: VPADChan) -> NFCError;
}
pub const GX2AAMode_GX2_AA_MODE1X: GX2AAMode = 0;
pub const GX2AAMode_GX2_AA_MODE2X: GX2AAMode = 1;
pub const GX2AAMode_GX2_AA_MODE4X: GX2AAMode = 2;
pub const GX2AAMode_GX2_AA_MODE8X: GX2AAMode = 3;
pub type GX2AAMode = ::core::ffi::c_uint;
pub const GX2AlphaToMaskMode_GX2_ALPHA_TO_MASK_MODE_NON_DITHERED: GX2AlphaToMaskMode = 0;
pub const GX2AlphaToMaskMode_GX2_ALPHA_TO_MASK_MODE_DITHER_0: GX2AlphaToMaskMode = 1;
pub const GX2AlphaToMaskMode_GX2_ALPHA_TO_MASK_MODE_DITHER_90: GX2AlphaToMaskMode = 2;
pub const GX2AlphaToMaskMode_GX2_ALPHA_TO_MASK_MODE_DITHER_180: GX2AlphaToMaskMode = 3;
pub const GX2AlphaToMaskMode_GX2_ALPHA_TO_MASK_MODE_DITHER_270: GX2AlphaToMaskMode = 4;
pub type GX2AlphaToMaskMode = ::core::ffi::c_uint;
pub const GX2AspectRatio_GX2_ASPECT_RATIO_4_3: GX2AspectRatio = 0;
pub const GX2AspectRatio_GX2_ASPECT_RATIO_16_9: GX2AspectRatio = 1;
pub type GX2AspectRatio = ::core::ffi::c_uint;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_8: GX2AttribFormat = 0;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_4_4: GX2AttribFormat = 1;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_16: GX2AttribFormat = 2;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_16_FLOAT: GX2AttribFormat = 3;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_8_8: GX2AttribFormat = 4;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32: GX2AttribFormat = 5;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32_FLOAT: GX2AttribFormat = 6;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_16_16: GX2AttribFormat = 7;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_16_16_FLOAT: GX2AttribFormat = 8;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_10_11_11_FLOAT: GX2AttribFormat = 9;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_8_8_8_8: GX2AttribFormat = 10;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_10_10_10_2: GX2AttribFormat = 11;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32_32: GX2AttribFormat = 12;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32_32_FLOAT: GX2AttribFormat = 13;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_16_16_16_16: GX2AttribFormat = 14;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_16_16_16_16_FLOAT: GX2AttribFormat = 15;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32_32_32: GX2AttribFormat = 16;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32_32_32_FLOAT: GX2AttribFormat = 17;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32_32_32_32: GX2AttribFormat = 18;
pub const GX2AttribFormat_GX2_ATTRIB_TYPE_32_32_32_32_FLOAT: GX2AttribFormat = 19;
pub const GX2AttribFormat_GX2_ATTRIB_FLAG_INTEGER: GX2AttribFormat = 256;
pub const GX2AttribFormat_GX2_ATTRIB_FLAG_SIGNED: GX2AttribFormat = 512;
pub const GX2AttribFormat_GX2_ATTRIB_FLAG_DEGAMMA: GX2AttribFormat = 1024;
pub const GX2AttribFormat_GX2_ATTRIB_FLAG_SCALED: GX2AttribFormat = 2048;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_UNORM_8: GX2AttribFormat = 0;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_UNORM_8_8: GX2AttribFormat = 4;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_UNORM_8_8_8_8: GX2AttribFormat = 10;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_UINT_8: GX2AttribFormat = 256;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_UINT_8_8: GX2AttribFormat = 260;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_UINT_8_8_8_8: GX2AttribFormat = 266;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_SNORM_8: GX2AttribFormat = 512;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_SNORM_8_8: GX2AttribFormat = 516;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_SNORM_8_8_8_8: GX2AttribFormat = 522;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_SINT_8: GX2AttribFormat = 768;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_SINT_8_8: GX2AttribFormat = 772;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_SINT_8_8_8_8: GX2AttribFormat = 778;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_FLOAT_32: GX2AttribFormat = 2054;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_FLOAT_32_32: GX2AttribFormat = 2061;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_FLOAT_32_32_32: GX2AttribFormat = 2065;
pub const GX2AttribFormat_GX2_ATTRIB_FORMAT_FLOAT_32_32_32_32: GX2AttribFormat = 2067;
pub type GX2AttribFormat = ::core::ffi::c_uint;
pub const GX2AttribIndexType_GX2_ATTRIB_INDEX_PER_VERTEX: GX2AttribIndexType = 0;
pub const GX2AttribIndexType_GX2_ATTRIB_INDEX_PER_INSTANCE: GX2AttribIndexType = 1;
pub type GX2AttribIndexType = ::core::ffi::c_uint;
pub const GX2BlendMode_GX2_BLEND_MODE_ZERO: GX2BlendMode = 0;
pub const GX2BlendMode_GX2_BLEND_MODE_ONE: GX2BlendMode = 1;
pub const GX2BlendMode_GX2_BLEND_MODE_SRC_COLOR: GX2BlendMode = 2;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_SRC_COLOR: GX2BlendMode = 3;
pub const GX2BlendMode_GX2_BLEND_MODE_SRC_ALPHA: GX2BlendMode = 4;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_SRC_ALPHA: GX2BlendMode = 5;
pub const GX2BlendMode_GX2_BLEND_MODE_DST_ALPHA: GX2BlendMode = 6;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_DST_ALPHA: GX2BlendMode = 7;
pub const GX2BlendMode_GX2_BLEND_MODE_DST_COLOR: GX2BlendMode = 8;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_DST_COLOR: GX2BlendMode = 9;
pub const GX2BlendMode_GX2_BLEND_MODE_SRC_ALPHA_SAT: GX2BlendMode = 10;
pub const GX2BlendMode_GX2_BLEND_MODE_BOTH_SRC_ALPHA: GX2BlendMode = 11;
pub const GX2BlendMode_GX2_BLEND_MODE_BOTH_INV_SRC_ALPHA: GX2BlendMode = 12;
pub const GX2BlendMode_GX2_BLEND_MODE_BLEND_FACTOR: GX2BlendMode = 13;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_BLEND_FACTOR: GX2BlendMode = 14;
pub const GX2BlendMode_GX2_BLEND_MODE_SRC1_COLOR: GX2BlendMode = 15;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_SRC1_COLOR: GX2BlendMode = 16;
pub const GX2BlendMode_GX2_BLEND_MODE_SRC1_ALPHA: GX2BlendMode = 17;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_SRC1_ALPHA: GX2BlendMode = 18;
pub const GX2BlendMode_GX2_BLEND_MODE_CONSTANT_ALPHA: GX2BlendMode = 19;
pub const GX2BlendMode_GX2_BLEND_MODE_INV_CONSTANT_ALPHA: GX2BlendMode = 20;
pub type GX2BlendMode = ::core::ffi::c_uint;
pub const GX2BlendCombineMode_GX2_BLEND_COMBINE_MODE_ADD: GX2BlendCombineMode = 0;
pub const GX2BlendCombineMode_GX2_BLEND_COMBINE_MODE_SUB: GX2BlendCombineMode = 1;
pub const GX2BlendCombineMode_GX2_BLEND_COMBINE_MODE_MIN: GX2BlendCombineMode = 2;
pub const GX2BlendCombineMode_GX2_BLEND_COMBINE_MODE_MAX: GX2BlendCombineMode = 3;
pub const GX2BlendCombineMode_GX2_BLEND_COMBINE_MODE_REV_SUB: GX2BlendCombineMode = 4;
pub type GX2BlendCombineMode = ::core::ffi::c_uint;
pub const GX2BufferingMode_GX2_BUFFERING_MODE_SINGLE: GX2BufferingMode = 1;
pub const GX2BufferingMode_GX2_BUFFERING_MODE_DOUBLE: GX2BufferingMode = 2;
pub const GX2BufferingMode_GX2_BUFFERING_MODE_TRIPLE: GX2BufferingMode = 3;
pub type GX2BufferingMode = ::core::ffi::c_uint;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_R: GX2ChannelMask = 1;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_G: GX2ChannelMask = 2;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_RG: GX2ChannelMask = 3;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_B: GX2ChannelMask = 4;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_RB: GX2ChannelMask = 5;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_GB: GX2ChannelMask = 6;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_RGB: GX2ChannelMask = 7;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_A: GX2ChannelMask = 8;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_RA: GX2ChannelMask = 9;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_GA: GX2ChannelMask = 10;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_RGA: GX2ChannelMask = 11;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_BA: GX2ChannelMask = 12;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_RBA: GX2ChannelMask = 13;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_GBA: GX2ChannelMask = 14;
pub const GX2ChannelMask_GX2_CHANNEL_MASK_RGBA: GX2ChannelMask = 15;
pub type GX2ChannelMask = ::core::ffi::c_uint;
pub const GX2ClearFlags_GX2_CLEAR_FLAGS_DEPTH: GX2ClearFlags = 1;
pub const GX2ClearFlags_GX2_CLEAR_FLAGS_STENCIL: GX2ClearFlags = 2;
pub const GX2ClearFlags_GX2_CLEAR_FLAGS_BOTH: GX2ClearFlags = 3;
pub type GX2ClearFlags = ::core::ffi::c_uint;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_NEVER: GX2CompareFunction = 0;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_LESS: GX2CompareFunction = 1;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_EQUAL: GX2CompareFunction = 2;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_LEQUAL: GX2CompareFunction = 3;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_GREATER: GX2CompareFunction = 4;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_NOT_EQUAL: GX2CompareFunction = 5;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_GEQUAL: GX2CompareFunction = 6;
pub const GX2CompareFunction_GX2_COMPARE_FUNC_ALWAYS: GX2CompareFunction = 7;
pub type GX2CompareFunction = ::core::ffi::c_uint;
pub const GX2DrcRenderMode_GX2_DRC_RENDER_MODE_DISABLED: GX2DrcRenderMode = 0;
pub const GX2DrcRenderMode_GX2_DRC_RENDER_MODE_SINGLE: GX2DrcRenderMode = 1;
pub const GX2DrcRenderMode_GX2_DRC_RENDER_MODE_DOUBLE: GX2DrcRenderMode = 2;
pub type GX2DrcRenderMode = ::core::ffi::c_uint;
pub const GX2EventType_GX2_EVENT_TYPE_START_OF_PIPE_INTERRUPT: GX2EventType = 0;
pub const GX2EventType_GX2_EVENT_TYPE_END_OF_PIPE_INTERRUPT: GX2EventType = 1;
pub const GX2EventType_GX2_EVENT_TYPE_VSYNC: GX2EventType = 2;
pub const GX2EventType_GX2_EVENT_TYPE_FLIP: GX2EventType = 3;
pub const GX2EventType_GX2_EVENT_TYPE_DISPLAY_LIST_OVERRUN: GX2EventType = 4;
pub type GX2EventType = ::core::ffi::c_uint;
pub const GX2EndianSwapMode_GX2_ENDIAN_SWAP_NONE: GX2EndianSwapMode = 0;
pub const GX2EndianSwapMode_GX2_ENDIAN_SWAP_8_IN_16: GX2EndianSwapMode = 1;
pub const GX2EndianSwapMode_GX2_ENDIAN_SWAP_8_IN_32: GX2EndianSwapMode = 2;
pub const GX2EndianSwapMode_GX2_ENDIAN_SWAP_DEFAULT: GX2EndianSwapMode = 3;
pub type GX2EndianSwapMode = ::core::ffi::c_uint;
pub const GX2FetchShaderType_GX2_FETCH_SHADER_TESSELLATION_NONE: GX2FetchShaderType = 0;
pub const GX2FetchShaderType_GX2_FETCH_SHADER_TESSELLATION_LINE: GX2FetchShaderType = 1;
pub const GX2FetchShaderType_GX2_FETCH_SHADER_TESSELLATION_TRIANGLE: GX2FetchShaderType = 2;
pub const GX2FetchShaderType_GX2_FETCH_SHADER_TESSELLATION_QUAD: GX2FetchShaderType = 3;
pub type GX2FetchShaderType = ::core::ffi::c_uint;
pub const GX2FrontFace_GX2_FRONT_FACE_CCW: GX2FrontFace = 0;
pub const GX2FrontFace_GX2_FRONT_FACE_CW: GX2FrontFace = 1;
pub type GX2FrontFace = ::core::ffi::c_uint;
pub const GX2IndexType_GX2_INDEX_TYPE_U16_LE: GX2IndexType = 0;
pub const GX2IndexType_GX2_INDEX_TYPE_U32_LE: GX2IndexType = 1;
pub const GX2IndexType_GX2_INDEX_TYPE_U16: GX2IndexType = 4;
pub const GX2IndexType_GX2_INDEX_TYPE_U32: GX2IndexType = 9;
pub type GX2IndexType = ::core::ffi::c_uint;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_NONE: GX2InvalidateMode = 0;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_ATTRIBUTE_BUFFER: GX2InvalidateMode = 1;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_TEXTURE: GX2InvalidateMode = 2;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_UNIFORM_BLOCK: GX2InvalidateMode = 4;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_SHADER: GX2InvalidateMode = 8;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_COLOR_BUFFER: GX2InvalidateMode = 16;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_DEPTH_BUFFER: GX2InvalidateMode = 32;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_CPU: GX2InvalidateMode = 64;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_STREAM_OUT_BUFFER: GX2InvalidateMode = 128;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_EXPORT_BUFFER: GX2InvalidateMode = 256;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_CPU_ATTRIBUTE_BUFFER: GX2InvalidateMode = 65;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_CPU_TEXTURE: GX2InvalidateMode = 66;
pub const GX2InvalidateMode_GX2_INVALIDATE_MODE_CPU_SHADER: GX2InvalidateMode = 72;
pub type GX2InvalidateMode = ::core::ffi::c_uint;
pub const GX2InitAttributes_GX2_INIT_END: GX2InitAttributes = 0;
pub const GX2InitAttributes_GX2_INIT_CMD_BUF_BASE: GX2InitAttributes = 1;
pub const GX2InitAttributes_GX2_INIT_CMD_BUF_POOL_SIZE: GX2InitAttributes = 2;
pub const GX2InitAttributes_GX2_INIT_ARGC: GX2InitAttributes = 7;
pub const GX2InitAttributes_GX2_INIT_ARGV: GX2InitAttributes = 8;
pub const GX2InitAttributes_GX2_INIT_PROFILE_MODE: GX2InitAttributes = 9;
pub const GX2InitAttributes_GX2_INIT_TOSS_STAGE: GX2InitAttributes = 10;
pub const GX2InitAttributes_GX2_INIT_APP_IO_THREAD_STACK_SIZE: GX2InitAttributes = 11;
pub type GX2InitAttributes = ::core::ffi::c_uint;
pub const GX2LogicOp_GX2_LOGIC_OP_CLEAR: GX2LogicOp = 0;
pub const GX2LogicOp_GX2_LOGIC_OP_NOR: GX2LogicOp = 17;
pub const GX2LogicOp_GX2_LOGIC_OP_INV_AND: GX2LogicOp = 34;
pub const GX2LogicOp_GX2_LOGIC_OP_INV_COPY: GX2LogicOp = 51;
pub const GX2LogicOp_GX2_LOGIC_OP_REV_AND: GX2LogicOp = 68;
pub const GX2LogicOp_GX2_LOGIC_OP_INV: GX2LogicOp = 85;
pub const GX2LogicOp_GX2_LOGIC_OP_XOR: GX2LogicOp = 102;
pub const GX2LogicOp_GX2_LOGIC_OP_NOT_AND: GX2LogicOp = 119;
pub const GX2LogicOp_GX2_LOGIC_OP_AND: GX2LogicOp = 136;
pub const GX2LogicOp_GX2_LOGIC_OP_EQUIV: GX2LogicOp = 153;
pub const GX2LogicOp_GX2_LOGIC_OP_NOP: GX2LogicOp = 170;
pub const GX2LogicOp_GX2_LOGIC_OP_INV_OR: GX2LogicOp = 187;
pub const GX2LogicOp_GX2_LOGIC_OP_COPY: GX2LogicOp = 204;
pub const GX2LogicOp_GX2_LOGIC_OP_REV_OR: GX2LogicOp = 221;
pub const GX2LogicOp_GX2_LOGIC_OP_OR: GX2LogicOp = 238;
pub const GX2LogicOp_GX2_LOGIC_OP_SET: GX2LogicOp = 255;
pub type GX2LogicOp = ::core::ffi::c_uint;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_POINTS: GX2PrimitiveMode = 1;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_LINES: GX2PrimitiveMode = 2;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_LINE_STRIP: GX2PrimitiveMode = 3;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_TRIANGLES: GX2PrimitiveMode = 4;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_TRIANGLE_FAN: GX2PrimitiveMode = 5;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_TRIANGLE_STRIP: GX2PrimitiveMode = 6;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_LINES_ADJACENCY: GX2PrimitiveMode = 10;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_LINE_STRIP_ADJACENCY: GX2PrimitiveMode = 11;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_TRIANGLES_ADJACENCY: GX2PrimitiveMode = 12;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_TRIANGLE_STRIP_ADJACENCY: GX2PrimitiveMode = 13;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_RECTS: GX2PrimitiveMode = 17;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_LINE_LOOP: GX2PrimitiveMode = 18;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_QUADS: GX2PrimitiveMode = 19;
pub const GX2PrimitiveMode_GX2_PRIMITIVE_MODE_QUAD_STRIP: GX2PrimitiveMode = 20;
pub type GX2PrimitiveMode = ::core::ffi::c_uint;
pub const GX2PolygonMode_GX2_POLYGON_MODE_POINT: GX2PolygonMode = 0;
pub const GX2PolygonMode_GX2_POLYGON_MODE_LINE: GX2PolygonMode = 1;
pub const GX2PolygonMode_GX2_POLYGON_MODE_TRIANGLE: GX2PolygonMode = 2;
pub type GX2PolygonMode = ::core::ffi::c_uint;
pub const GX2RenderTarget_GX2_RENDER_TARGET_0: GX2RenderTarget = 0;
pub const GX2RenderTarget_GX2_RENDER_TARGET_1: GX2RenderTarget = 1;
pub const GX2RenderTarget_GX2_RENDER_TARGET_2: GX2RenderTarget = 2;
pub const GX2RenderTarget_GX2_RENDER_TARGET_3: GX2RenderTarget = 3;
pub const GX2RenderTarget_GX2_RENDER_TARGET_4: GX2RenderTarget = 4;
pub const GX2RenderTarget_GX2_RENDER_TARGET_5: GX2RenderTarget = 5;
pub const GX2RenderTarget_GX2_RENDER_TARGET_6: GX2RenderTarget = 6;
pub const GX2RenderTarget_GX2_RENDER_TARGET_7: GX2RenderTarget = 7;
pub type GX2RenderTarget = ::core::ffi::c_uint;
pub const GX2RoundingMode_GX2_ROUNDING_MODE_ROUND_TO_EVEN: GX2RoundingMode = 0;
pub const GX2RoundingMode_GX2_ROUNDING_MODE_TRUNCATE: GX2RoundingMode = 1;
pub type GX2RoundingMode = ::core::ffi::c_uint;
pub const GX2SamplerVarType_GX2_SAMPLER_VAR_TYPE_SAMPLER_1D: GX2SamplerVarType = 0;
pub const GX2SamplerVarType_GX2_SAMPLER_VAR_TYPE_SAMPLER_2D: GX2SamplerVarType = 1;
pub const GX2SamplerVarType_GX2_SAMPLER_VAR_TYPE_SAMPLER_3D: GX2SamplerVarType = 3;
pub const GX2SamplerVarType_GX2_SAMPLER_VAR_TYPE_SAMPLER_CUBE: GX2SamplerVarType = 4;
pub type GX2SamplerVarType = ::core::ffi::c_uint;
pub const GX2ScanTarget_GX2_SCAN_TARGET_TV0: GX2ScanTarget = 1;
pub const GX2ScanTarget_GX2_SCAN_TARGET_TV1: GX2ScanTarget = 2;
pub const GX2ScanTarget_GX2_SCAN_TARGET_DRC0: GX2ScanTarget = 4;
pub const GX2ScanTarget_GX2_SCAN_TARGET_DRC1: GX2ScanTarget = 8;
pub const GX2ScanTarget_GX2_SCAN_TARGET_TV: GX2ScanTarget = 1;
pub const GX2ScanTarget_GX2_SCAN_TARGET_DRC: GX2ScanTarget = 4;
pub type GX2ScanTarget = ::core::ffi::c_uint;
pub const GX2ShaderMode_GX2_SHADER_MODE_UNIFORM_REGISTER: GX2ShaderMode = 0;
pub const GX2ShaderMode_GX2_SHADER_MODE_UNIFORM_BLOCK: GX2ShaderMode = 1;
pub const GX2ShaderMode_GX2_SHADER_MODE_GEOMETRY_SHADER: GX2ShaderMode = 2;
pub const GX2ShaderMode_GX2_SHADER_MODE_COMPUTE_SHADER: GX2ShaderMode = 3;
pub type GX2ShaderMode = ::core::ffi::c_uint;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_VOID: GX2ShaderVarType = 0;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_BOOL: GX2ShaderVarType = 1;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_INT: GX2ShaderVarType = 2;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_UINT: GX2ShaderVarType = 3;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT: GX2ShaderVarType = 4;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE: GX2ShaderVarType = 5;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE2: GX2ShaderVarType = 6;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE3: GX2ShaderVarType = 7;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE4: GX2ShaderVarType = 8;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT2: GX2ShaderVarType = 9;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT3: GX2ShaderVarType = 10;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT4: GX2ShaderVarType = 11;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_BOOL2: GX2ShaderVarType = 12;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_BOOL3: GX2ShaderVarType = 13;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_BOOL4: GX2ShaderVarType = 14;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_INT2: GX2ShaderVarType = 15;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_INT3: GX2ShaderVarType = 16;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_INT4: GX2ShaderVarType = 17;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_UINT2: GX2ShaderVarType = 18;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_UINT3: GX2ShaderVarType = 19;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_UINT4: GX2ShaderVarType = 20;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT2X2: GX2ShaderVarType = 21;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT2X3: GX2ShaderVarType = 22;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT2X4: GX2ShaderVarType = 23;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT3X2: GX2ShaderVarType = 24;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT3X3: GX2ShaderVarType = 25;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT3X4: GX2ShaderVarType = 26;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT4X2: GX2ShaderVarType = 27;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT4X3: GX2ShaderVarType = 28;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_FLOAT4X4: GX2ShaderVarType = 29;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE2X2: GX2ShaderVarType = 30;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE2X3: GX2ShaderVarType = 31;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE2X4: GX2ShaderVarType = 32;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE3X2: GX2ShaderVarType = 33;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE3X3: GX2ShaderVarType = 34;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE3X4: GX2ShaderVarType = 35;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE4X2: GX2ShaderVarType = 36;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE4X3: GX2ShaderVarType = 37;
pub const GX2ShaderVarType_GX2_SHADER_VAR_TYPE_DOUBLE4X4: GX2ShaderVarType = 38;
pub type GX2ShaderVarType = ::core::ffi::c_uint;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_KEEP: GX2StencilFunction = 0;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_ZERO: GX2StencilFunction = 1;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_REPLACE: GX2StencilFunction = 2;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_INCR_CLAMP: GX2StencilFunction = 3;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_DECR_CLAMP: GX2StencilFunction = 4;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_INV: GX2StencilFunction = 5;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_INCR_WRAP: GX2StencilFunction = 6;
pub const GX2StencilFunction_GX2_STENCIL_FUNCTION_DECR_WRAP: GX2StencilFunction = 7;
pub type GX2StencilFunction = ::core::ffi::c_uint;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_1D: GX2SurfaceDim = 0;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_2D: GX2SurfaceDim = 1;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_3D: GX2SurfaceDim = 2;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_CUBE: GX2SurfaceDim = 3;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_1D_ARRAY: GX2SurfaceDim = 4;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_2D_ARRAY: GX2SurfaceDim = 5;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_2D_MSAA: GX2SurfaceDim = 6;
pub const GX2SurfaceDim_GX2_SURFACE_DIM_TEXTURE_2D_MSAA_ARRAY: GX2SurfaceDim = 7;
pub type GX2SurfaceDim = ::core::ffi::c_uint;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_INVALID: GX2SurfaceFormat = 0;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R4_G4: GX2SurfaceFormat = 2;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R4_G4_B4_A4: GX2SurfaceFormat = 11;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R8: GX2SurfaceFormat = 1;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R8_G8: GX2SurfaceFormat = 7;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R8_G8_B8_A8: GX2SurfaceFormat = 26;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R16: GX2SurfaceFormat = 5;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R16_G16: GX2SurfaceFormat = 15;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R16_G16_B16_A16: GX2SurfaceFormat = 31;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R5_G6_B5: GX2SurfaceFormat = 8;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R5_G5_B5_A1: GX2SurfaceFormat = 10;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_A1_B5_G5_R5: GX2SurfaceFormat = 12;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R24_X8: GX2SurfaceFormat = 17;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_A2_B10_G10_R10: GX2SurfaceFormat = 27;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_R10_G10_B10_A2: GX2SurfaceFormat = 25;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_BC1: GX2SurfaceFormat = 49;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_BC2: GX2SurfaceFormat = 50;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_BC3: GX2SurfaceFormat = 51;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_BC4: GX2SurfaceFormat = 52;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_BC5: GX2SurfaceFormat = 53;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UNORM_NV12: GX2SurfaceFormat = 129;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R8: GX2SurfaceFormat = 257;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R8_G8: GX2SurfaceFormat = 263;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R8_G8_B8_A8: GX2SurfaceFormat = 282;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R16: GX2SurfaceFormat = 261;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R16_G16: GX2SurfaceFormat = 271;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R16_G16_B16_A16: GX2SurfaceFormat = 287;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R32: GX2SurfaceFormat = 269;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R32_G32: GX2SurfaceFormat = 285;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R32_G32_B32_A32: GX2SurfaceFormat = 290;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_A2_B10_G10_R10: GX2SurfaceFormat = 283;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_R10_G10_B10_A2: GX2SurfaceFormat = 281;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_X24_G8: GX2SurfaceFormat = 273;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_UINT_G8_X24: GX2SurfaceFormat = 284;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_R8: GX2SurfaceFormat = 513;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_R8_G8: GX2SurfaceFormat = 519;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_R8_G8_B8_A8: GX2SurfaceFormat = 538;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_R16: GX2SurfaceFormat = 517;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_R16_G16: GX2SurfaceFormat = 527;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_R16_G16_B16_A16: GX2SurfaceFormat = 543;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_R10_G10_B10_A2: GX2SurfaceFormat = 537;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_BC4: GX2SurfaceFormat = 564;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SNORM_BC5: GX2SurfaceFormat = 565;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R8: GX2SurfaceFormat = 769;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R8_G8: GX2SurfaceFormat = 775;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R8_G8_B8_A8: GX2SurfaceFormat = 794;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R16: GX2SurfaceFormat = 773;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R16_G16: GX2SurfaceFormat = 783;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R16_G16_B16_A16: GX2SurfaceFormat = 799;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R32: GX2SurfaceFormat = 781;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R32_G32: GX2SurfaceFormat = 797;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R32_G32_B32_A32: GX2SurfaceFormat = 802;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SINT_R10_G10_B10_A2: GX2SurfaceFormat = 793;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SRGB_R8_G8_B8_A8: GX2SurfaceFormat = 1050;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SRGB_BC1: GX2SurfaceFormat = 1073;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SRGB_BC2: GX2SurfaceFormat = 1074;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_SRGB_BC3: GX2SurfaceFormat = 1075;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_R32: GX2SurfaceFormat = 2062;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_R32_G32: GX2SurfaceFormat = 2078;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_R32_G32_B32_A32: GX2SurfaceFormat = 2083;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_R16: GX2SurfaceFormat = 2054;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_R16_G16: GX2SurfaceFormat = 2064;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_R16_G16_B16_A16: GX2SurfaceFormat = 2080;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_R11_G11_B10: GX2SurfaceFormat = 2070;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_D24_S8: GX2SurfaceFormat = 2065;
pub const GX2SurfaceFormat_GX2_SURFACE_FORMAT_FLOAT_X8_X24: GX2SurfaceFormat = 2076;
pub type GX2SurfaceFormat = ::core::ffi::c_uint;
pub const GX2SurfaceUse_GX2_SURFACE_USE_NONE: GX2SurfaceUse = 0;
pub const GX2SurfaceUse_GX2_SURFACE_USE_TEXTURE: GX2SurfaceUse = 1;
pub const GX2SurfaceUse_GX2_SURFACE_USE_COLOR_BUFFER: GX2SurfaceUse = 2;
pub const GX2SurfaceUse_GX2_SURFACE_USE_DEPTH_BUFFER: GX2SurfaceUse = 4;
pub const GX2SurfaceUse_GX2_SURFACE_USE_SCAN_BUFFER: GX2SurfaceUse = 8;
pub const GX2SurfaceUse_GX2_SURFACE_USE_TV: GX2SurfaceUse = -2147483648;
pub const GX2SurfaceUse_GX2_SURFACE_USE_TEXTURE_COLOR_BUFFER_TV: GX2SurfaceUse = -2147483645;
pub type GX2SurfaceUse = ::core::ffi::c_int;
pub const GX2TessellationMode_GX2_TESSELLATION_MODE_DISCRETE: GX2TessellationMode = 0;
pub const GX2TessellationMode_GX2_TESSELLATION_MODE_CONTINUOUS: GX2TessellationMode = 1;
pub const GX2TessellationMode_GX2_TESSELLATION_MODE_ADAPTIVE: GX2TessellationMode = 2;
pub type GX2TessellationMode = ::core::ffi::c_uint;
pub const GX2TexBorderType_GX2_TEX_BORDER_TYPE_TRANSPARENT_BLACK: GX2TexBorderType = 0;
pub const GX2TexBorderType_GX2_TEX_BORDER_TYPE_BLACK: GX2TexBorderType = 1;
pub const GX2TexBorderType_GX2_TEX_BORDER_TYPE_WHITE: GX2TexBorderType = 2;
pub const GX2TexBorderType_GX2_TEX_BORDER_TYPE_VARIABLE: GX2TexBorderType = 3;
pub type GX2TexBorderType = ::core::ffi::c_uint;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_WRAP: GX2TexClampMode = 0;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_MIRROR: GX2TexClampMode = 1;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_CLAMP: GX2TexClampMode = 2;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_MIRROR_ONCE: GX2TexClampMode = 3;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_CLAMP_HALF_BORDER: GX2TexClampMode = 4;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_MIRROR_ONCE_HALF_BORDER: GX2TexClampMode = 5;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_CLAMP_BORDER: GX2TexClampMode = 6;
pub const GX2TexClampMode_GX2_TEX_CLAMP_MODE_MIRROR_ONCE_BORDER: GX2TexClampMode = 7;
pub type GX2TexClampMode = ::core::ffi::c_uint;
pub const GX2TexMipFilterMode_GX2_TEX_MIP_FILTER_MODE_NONE: GX2TexMipFilterMode = 0;
pub const GX2TexMipFilterMode_GX2_TEX_MIP_FILTER_MODE_POINT: GX2TexMipFilterMode = 1;
pub const GX2TexMipFilterMode_GX2_TEX_MIP_FILTER_MODE_LINEAR: GX2TexMipFilterMode = 2;
pub type GX2TexMipFilterMode = ::core::ffi::c_uint;
pub const GX2TexMipPerfMode_GX2_TEX_MIP_PERF_MODE_DISABLE: GX2TexMipPerfMode = 0;
pub type GX2TexMipPerfMode = ::core::ffi::c_uint;
pub const GX2TexXYFilterMode_GX2_TEX_XY_FILTER_MODE_POINT: GX2TexXYFilterMode = 0;
pub const GX2TexXYFilterMode_GX2_TEX_XY_FILTER_MODE_LINEAR: GX2TexXYFilterMode = 1;
pub const GX2TexXYFilterMode_GX2_TEX_XY_FILTER_MODE_BICUBIC: GX2TexXYFilterMode = 2;
pub type GX2TexXYFilterMode = ::core::ffi::c_uint;
pub const GX2TexAnisoRatio_GX2_TEX_ANISO_RATIO_NONE: GX2TexAnisoRatio = 0;
pub const GX2TexAnisoRatio_GX2_TEX_ANISO_RATIO_2_TO_1: GX2TexAnisoRatio = 1;
pub const GX2TexAnisoRatio_GX2_TEX_ANISO_RATIO_4_TO_1: GX2TexAnisoRatio = 2;
pub const GX2TexAnisoRatio_GX2_TEX_ANISO_RATIO_8_TO_1: GX2TexAnisoRatio = 3;
pub const GX2TexAnisoRatio_GX2_TEX_ANISO_RATIO_16_TO_1: GX2TexAnisoRatio = 4;
pub type GX2TexAnisoRatio = ::core::ffi::c_uint;
pub const GX2TexZFilterMode_GX2_TEX_Z_FILTER_MODE_NONE: GX2TexZFilterMode = 0;
pub const GX2TexZFilterMode_GX2_TEX_Z_FILTER_MODE_POINT: GX2TexZFilterMode = 1;
pub const GX2TexZFilterMode_GX2_TEX_Z_FILTER_MODE_LINEAR: GX2TexZFilterMode = 2;
pub type GX2TexZFilterMode = ::core::ffi::c_uint;
pub const GX2TexZPerfMode_GX2_TEX_Z_PERF_MODE_DISABLED: GX2TexZPerfMode = 0;
pub type GX2TexZPerfMode = ::core::ffi::c_uint;
pub const GX2TileMode_GX2_TILE_MODE_DEFAULT: GX2TileMode = 0;
pub const GX2TileMode_GX2_TILE_MODE_LINEAR_ALIGNED: GX2TileMode = 1;
pub const GX2TileMode_GX2_TILE_MODE_TILED_1D_THIN1: GX2TileMode = 2;
pub const GX2TileMode_GX2_TILE_MODE_TILED_1D_THICK: GX2TileMode = 3;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2D_THIN1: GX2TileMode = 4;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2D_THIN2: GX2TileMode = 5;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2D_THIN4: GX2TileMode = 6;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2D_THICK: GX2TileMode = 7;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2B_THIN1: GX2TileMode = 8;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2B_THIN2: GX2TileMode = 9;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2B_THIN4: GX2TileMode = 10;
pub const GX2TileMode_GX2_TILE_MODE_TILED_2B_THICK: GX2TileMode = 11;
pub const GX2TileMode_GX2_TILE_MODE_TILED_3D_THIN1: GX2TileMode = 12;
pub const GX2TileMode_GX2_TILE_MODE_TILED_3D_THICK: GX2TileMode = 13;
pub const GX2TileMode_GX2_TILE_MODE_TILED_3B_THIN1: GX2TileMode = 14;
pub const GX2TileMode_GX2_TILE_MODE_TILED_3B_THICK: GX2TileMode = 15;
pub const GX2TileMode_GX2_TILE_MODE_LINEAR_SPECIAL: GX2TileMode = 16;
pub type GX2TileMode = ::core::ffi::c_uint;
pub const GX2TVRenderMode_GX2_TV_RENDER_MODE_DISABLED: GX2TVRenderMode = 0;
pub const GX2TVRenderMode_GX2_TV_RENDER_MODE_STANDARD_480P: GX2TVRenderMode = 1;
pub const GX2TVRenderMode_GX2_TV_RENDER_MODE_WIDE_480P: GX2TVRenderMode = 2;
pub const GX2TVRenderMode_GX2_TV_RENDER_MODE_WIDE_720P: GX2TVRenderMode = 3;
pub const GX2TVRenderMode_GX2_TV_RENDER_MODE_WIDE_1080P: GX2TVRenderMode = 5;
pub type GX2TVRenderMode = ::core::ffi::c_uint;
pub const GX2TVScanMode_GX2_TV_SCAN_MODE_NONE: GX2TVScanMode = 0;
pub const GX2TVScanMode_GX2_TV_SCAN_MODE_576I: GX2TVScanMode = 1;
pub const GX2TVScanMode_GX2_TV_SCAN_MODE_480I: GX2TVScanMode = 2;
pub const GX2TVScanMode_GX2_TV_SCAN_MODE_480P: GX2TVScanMode = 3;
pub const GX2TVScanMode_GX2_TV_SCAN_MODE_720P: GX2TVScanMode = 4;
pub const GX2TVScanMode_GX2_TV_SCAN_MODE_1080I: GX2TVScanMode = 6;
pub const GX2TVScanMode_GX2_TV_SCAN_MODE_1080P: GX2TVScanMode = 7;
...
#[doc = "! No resource flags specified"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_NONE: GX2RResourceFlags = 0;
#[doc = "! This resource is to be used as a texture"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_TEXTURE: GX2RResourceFlags = 1;
#[doc = "! This resource is to be used as a colour buffer"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_COLOR_BUFFER: GX2RResourceFlags = 2;
#[doc = "! This resource is to be used as a depth buffer"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_DEPTH_BUFFER: GX2RResourceFlags = 4;
#[doc = "! This resource is to be used as a scan buffer"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_SCAN_BUFFER: GX2RResourceFlags = 8;
#[doc = "! This resource is to be used as a vertex buffer"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_VERTEX_BUFFER: GX2RResourceFlags = 16;
#[doc = "! This resource is to be used as a index buffer"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_INDEX_BUFFER: GX2RResourceFlags = 32;
#[doc = "! This resource is to be used as a uniform block"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_UNIFORM_BLOCK: GX2RResourceFlags = 64;
#[doc = "! This resource is to be used as a shader program"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_SHADER_PROGRAM: GX2RResourceFlags = 128;
#[doc = "! This resource is to be used as a stream output"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_STREAM_OUTPUT: GX2RResourceFlags = 256;
#[doc = "! This resource is to be used as a display list"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_DISPLAY_LIST: GX2RResourceFlags = 512;
#[doc = "! This resource is to be used as a geometry shader ring buffer"]
pub const GX2RResourceFlags_GX2R_RESOURCE_BIND_GS_RING_BUFFER: GX2RResourceFlags = 1024;
#[doc = "! Invalidate resource for a CPU read"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_CPU_READ: GX2RResourceFlags = 2048;
#[doc = "! Invalidate resource for a CPU write"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_CPU_WRITE: GX2RResourceFlags = 4096;
#[doc = "! Invalidate resource for a GPU read"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_GPU_READ: GX2RResourceFlags = 8192;
#[doc = "! Invalidate resource for a GPU write"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_GPU_WRITE: GX2RResourceFlags = 16384;
#[doc = "! Invalidate resource for a DMA read"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_DMA_READ: GX2RResourceFlags = 32768;
#[doc = "! Invalidate resource for a DMA write"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_DMA_WRITE: GX2RResourceFlags = 65536;
#[doc = "! Force resource allocation to be in MEM1"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_FORCE_MEM1: GX2RResourceFlags = 131072;
#[doc = "! Force resource allocation to be in MEM2"]
pub const GX2RResourceFlags_GX2R_RESOURCE_USAGE_FORCE_MEM2: GX2RResourceFlags = 262144;
#[doc = "! Disable CPU invalidation"]
pub const GX2RResourceFlags_GX2R_RESOURCE_DISABLE_CPU_INVALIDATE: GX2RResourceFlags = 1048576;
#[doc = "! Disable GPU invalidation"]
pub const GX2RResourceFlags_GX2R_RESOURCE_DISABLE_GPU_INVALIDATE: GX2RResourceFlags = 2097152;
#[doc = "! Resource is locked for read-only access"]
pub const GX2RResourceFlags_GX2R_RESOURCE_LOCKED_READ_ONLY: GX2RResourceFlags = 4194304;
#[doc = "! Resource was allocated by GX2R."]
pub const GX2RResourceFlags_GX2R_RESOURCE_GX2R_ALLOCATED: GX2RResourceFlags = 536870912;
#[doc = "! Resource is locked for all access"]
pub const GX2RResourceFlags_GX2R_RESOURCE_LOCKED: GX2RResourceFlags = 1073741824;
...
pub const GFDBlockType_GFD_BLOCK_END_OF_FILE: GFDBlockType = 1;
pub const GFDBlockType_GFD_BLOCK_PADDING: GFDBlockType = 2;
pub const GFDBlockType_GFD_BLOCK_VERTEX_SHADER_HEADER: GFDBlockType = 3;
pub const GFDBlockType_GFD_BLOCK_VERTEX_SHADER_PROGRAM: GFDBlockType = 5;
pub const GFDBlockType_GFD_BLOCK_PIXEL_SHADER_HEADER: GFDBlockType = 6;
pub const GFDBlockType_GFD_BLOCK_PIXEL_SHADER_PROGRAM: GFDBlockType = 7;
pub const GFDBlockType_GFD_BLOCK_GEOMETRY_SHADER_HEADER: GFDBlockType = 8;
pub const GFDBlockType_GFD_BLOCK_GEOMETRY_SHADER_PROGRAM: GFDBlockType = 9;
pub const GFDBlockType_GFD_BLOCK_GEOMETRY_SHADER_COPY_PROGRAM: GFDBlockType = 10;
pub const GFDBlockType_GFD_BLOCK_TEXTURE_HEADER: GFDBlockType = 11;
pub const GFDBlockType_GFD_BLOCK_TEXTURE_IMAGE: GFDBlockType = 12;
pub const GFDBlockType_GFD_BLOCK_TEXTURE_MIPMAP: GFDBlockType = 13;
pub const GFDBlockType_GFD_BLOCK_COMPUTE_SHADER_HEADER: GFDBlockType = 14;
pub const GFDBlockType_GFD_BLOCK_COMPUTE_SHADER_PROGRAM: GFDBlockType = 15;
...
extern "C" {
    #[doc = " @return -1 if GX2 is not running, on success the core where GX2Init has been called is returned."]
    pub fn GX2GetMainCoreId() -> ::core::ffi::c_int;
}
extern "C" {
    pub fn GX2TempGetGPUVersion() -> u32;
}
pub const GX2DebugCaptureInterfaceVersion_GX2_DEBUG_CAPTURE_INTERFACE_VERSION:
    GX2DebugCaptureInterfaceVersion = 1;
pub type GX2DebugCaptureInterfaceVersion = ::core::ffi::c_uint;
#[doc = "! When set \\link GX2DebugCaptureStart \\endlink will call \\link GX2DrawDone \\endlink before the capture is started."]
pub const GX2DebugCaptureStartFlags_GX2_DEBUG_CAPTURE_START_FLAGS_NONE: GX2DebugCaptureStartFlags =
    0;
#[doc = "! When set \\link GX2DebugCaptureStart \\endlink will NOT call \\link GX2DrawDone \\endlink."]
pub const GX2DebugCaptureStartFlags_GX2_DEBUG_CAPTURE_START_FLAGS_DISABLE_GX2DRAWDONE:
    GX2DebugCaptureStartFlags = 1;
#[doc = "! Options for \\link GX2DebugCaptureStart \\endlink."]
pub type GX2DebugCaptureStartFlags = ::core::ffi::c_uint;
#[doc = "! When set \\link GX2DebugCaptureEnd \\endlink will call \\link GX2Flush \\endlink before the capture is completed."]
pub const GX2DebugCaptureEndFlags_GX2_DEBUG_CAPTURE_END_FLAGS_NONE: GX2DebugCaptureEndFlags = 0;
#[doc = "! When set \\link GX2DebugCaptureEnd \\endlink will NOT call \\link GX2Flush \\endlink."]
pub const GX2DebugCaptureEndFlags_GX2_DEBUG_CAPTURE_END_FLAGS_DISABLE_GX2FLUSH:
    GX2DebugCaptureEndFlags = 1;
#[doc = "! Options for \\link GX2DebugCaptureEnd \\endlink."]
...
pub const GX2_SQ_SEL_GX2_SQ_SEL_X: GX2_SQ_SEL = 0;
pub const GX2_SQ_SEL_GX2_SQ_SEL_Y: GX2_SQ_SEL = 1;
pub const GX2_SQ_SEL_GX2_SQ_SEL_Z: GX2_SQ_SEL = 2;
pub const GX2_SQ_SEL_GX2_SQ_SEL_W: GX2_SQ_SEL = 3;
pub const GX2_SQ_SEL_GX2_SQ_SEL_R: GX2_SQ_SEL = 0;
pub const GX2_SQ_SEL_GX2_SQ_SEL_G: GX2_SQ_SEL = 1;
pub const GX2_SQ_SEL_GX2_SQ_SEL_B: GX2_SQ_SEL = 2;
pub const GX2_SQ_SEL_GX2_SQ_SEL_A: GX2_SQ_SEL = 3;
pub const GX2_SQ_SEL_GX2_SQ_SEL_0: GX2_SQ_SEL = 4;
pub const GX2_SQ_SEL_GX2_SQ_SEL_1: GX2_SQ_SEL = 5;
pub const GX2_SQ_SEL_GX2_SQ_SEL_MASK: GX2_SQ_SEL = 7;
...
#[doc = "! No errors."]
pub const H264Error_H264_ERROR_OK: H264Error = 0;
#[doc = "! Invalid picture parameter set."]
pub const H264Error_H264_ERROR_INVALID_PPS: H264Error = 24;
#[doc = "! Invalid sequence parameter set."]
pub const H264Error_H264_ERROR_INVALID_SPS: H264Error = 26;
#[doc = "! Invalid slice header."]
pub const H264Error_H264_ERROR_INVALID_SLICEHEADER: H264Error = 61;
#[doc = "! Generic h264 error."]
pub const H264Error_H264_ERROR_GENERIC: H264Error = 16777216;
#[doc = "! Invalid parameters passed."]
pub const H264Error_H264_ERROR_INVALID_PARAMETER: H264Error = 16842752;
#[doc = "! The amount of memory provided to the h264 library\n! is insufficient."]
pub const H264Error_H264_ERROR_OUT_OF_MEMORY: H264Error = 16908288;
#[doc = "! Invalid h264 stream profile. Only the baseline (66),\n! main (77) and high (100) profiles are allowed."]
pub const H264Error_H264_ERROR_INVALID_PROFILE: H264Error = 17301504;
...
pub const H264Parameter_H264_PARAMETER_FRAME_POINTER_OUTPUT: H264Parameter = 1;
...
pub const H264Parameter_H264_PARAMETER_OUTPUT_PER_FRAME: H264Parameter = 536870914;
#[doc = "! Set whether the decoder should internally buffer frames or call the callback\n! immediately as soon as a frame is emitted."]
pub const H264Parameter_H264_PARAMETER_UNKNOWN_20000010: H264Parameter = 536870928;
#[doc = "! Set whether the decoder should internally buffer frames or call the callback\n! immediately as soon as a frame is emitted."]
pub const H264Parameter_H264_PARAMETER_UNKNOWN_20000030: H264Parameter = 536870960;
#[doc = "! Set whether the decoder should internally buffer frames or call the callback\n! immediately as soon as a frame is emitted."]
pub const H264Parameter_H264_PARAMETER_UNKNOWN_20000040: H264Parameter = 536870976;
#[doc = "! Set a user memory pointer which is passed to the frame output callback."]
pub const H264Parameter_H264_PARAMETER_USER_MEMORY: H264Parameter = 1879048193;
...
pub const HIDAttachEvent_HID_DEVICE_DETACH: HIDAttachEvent = 0;
pub const HIDAttachEvent_HID_DEVICE_ATTACH: HIDAttachEvent = 1;
...
pub const OSExceptionMode_OS_EXCEPTION_MODE_SYSTEM: OSExceptionMode = 0;
pub const OSExceptionMode_OS_EXCEPTION_MODE_THREAD: OSExceptionMode = 1;
pub const OSExceptionMode_OS_EXCEPTION_MODE_GLOBAL: OSExceptionMode = 2;
pub const OSExceptionMode_OS_EXCEPTION_MODE_THREAD_ALL_CORES: OSExceptionMode = 3;
pub const OSExceptionMode_OS_EXCEPTION_MODE_GLOBAL_ALL_CORES: OSExceptionMode = 4;
pub type OSExceptionMode = ::core::ffi::c_uint;
pub const OSExceptionType_OS_EXCEPTION_TYPE_SYSTEM_RESET: OSExceptionType = 0;
pub const OSExceptionType_OS_EXCEPTION_TYPE_MACHINE_CHECK: OSExceptionType = 1;
pub const OSExceptionType_OS_EXCEPTION_TYPE_DSI: OSExceptionType = 2;
pub const OSExceptionType_OS_EXCEPTION_TYPE_ISI: OSExceptionType = 3;
pub const OSExceptionType_OS_EXCEPTION_TYPE_EXTERNAL_INTERRUPT: OSExceptionType = 4;
pub const OSExceptionType_OS_EXCEPTION_TYPE_ALIGNMENT: OSExceptionType = 5;
pub const OSExceptionType_OS_EXCEPTION_TYPE_PROGRAM: OSExceptionType = 6;
pub const OSExceptionType_OS_EXCEPTION_TYPE_FLOATING_POINT: OSExceptionType = 7;
pub const OSExceptionType_OS_EXCEPTION_TYPE_DECREMENTER: OSExceptionType = 8;
pub const OSExceptionType_OS_EXCEPTION_TYPE_SYSTEM_CALL: OSExceptionType = 9;
pub const OSExceptionType_OS_EXCEPTION_TYPE_TRACE: OSExceptionType = 10;
pub const OSExceptionType_OS_EXCEPTION_TYPE_PERFORMANCE_MONITOR: OSExceptionType = 11;
pub const OSExceptionType_OS_EXCEPTION_TYPE_BREAKPOINT: OSExceptionType = 12;
pub const OSExceptionType_OS_EXCEPTION_TYPE_SYSTEM_INTERRUPT: OSExceptionType = 13;
pub const OSExceptionType_OS_EXCEPTION_TYPE_ICI: OSExceptionType = 14;
...
#[doc = "! A bitfield of enum OS_THREAD_TYPE."]
...
pub type OSThreadDeallocatorFn = ::core::option::Option<
    unsafe extern "C" fn(thread: *mut OSThread, stack: *mut ::core::ffi::c_void),
>;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_0: OSThreadSpecificID = 0;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_1: OSThreadSpecificID = 1;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_2: OSThreadSpecificID = 2;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_3: OSThreadSpecificID = 3;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_4: OSThreadSpecificID = 4;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_5: OSThreadSpecificID = 5;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_6: OSThreadSpecificID = 6;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_7: OSThreadSpecificID = 7;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_8: OSThreadSpecificID = 8;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_9: OSThreadSpecificID = 9;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_10: OSThreadSpecificID = 10;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_11: OSThreadSpecificID = 11;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_12: OSThreadSpecificID = 12;
#[doc = "! These can be used by applications"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_13: OSThreadSpecificID = 13;
#[doc = "! These are reserved to wut for internal use"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_WUT_RESERVED_0: OSThreadSpecificID = 14;
#[doc = "! These are reserved to wut for internal use"]
pub const OSThreadSpecificID_OS_THREAD_SPECIFIC_WUT_RESERVED_1: OSThreadSpecificID = 15;
pub type OSThreadSpecificID = ::core::ffi::c_uint;
pub const OS_THREAD_STATE_OS_THREAD_STATE_NONE: OS_THREAD_STATE = 0;
...
pub const OS_THREAD_REQUEST_OS_THREAD_REQUEST_NONE: OS_THREAD_REQUEST = 0;
pub const OS_THREAD_REQUEST_OS_THREAD_REQUEST_SUSPEND: OS_THREAD_REQUEST = 1;
pub const OS_THREAD_REQUEST_OS_THREAD_REQUEST_CANCEL: OS_THREAD_REQUEST = 2;
pub type OS_THREAD_REQUEST = ::core::ffi::c_uint;
#[doc = "! Allow the thread to run on CPU0."]
pub const OS_THREAD_ATTRIB_OS_THREAD_ATTRIB_AFFINITY_CPU0: OS_THREAD_ATTRIB = 1;
#[doc = "! Allow the thread to run on CPU1."]
pub const OS_THREAD_ATTRIB_OS_THREAD_ATTRIB_AFFINITY_CPU1: OS_THREAD_ATTRIB = 2;
#[doc = "! Allow the thread to run on CPU2."]
pub const OS_THREAD_ATTRIB_OS_THREAD_ATTRIB_AFFINITY_CPU2: OS_THREAD_ATTRIB = 4;
#[doc = "! Allow the thread to run any CPU."]
pub const OS_THREAD_ATTRIB_OS_THREAD_ATTRIB_AFFINITY_ANY: OS_THREAD_ATTRIB = 7;
#[doc = "! Start the thread detached."]
pub const OS_THREAD_ATTRIB_OS_THREAD_ATTRIB_DETACHED: OS_THREAD_ATTRIB = 8;
#[doc = "! Enables tracking of stack usage."]
pub const OS_THREAD_ATTRIB_OS_THREAD_ATTRIB_STACK_USAGE: OS_THREAD_ATTRIB = 32;
#[doc = "! Enables tracking of stack usage."]
pub const OS_THREAD_ATTRIB_OS_THREAD_ATTRIB_UNKNOWN: OS_THREAD_ATTRIB = 128;
pub type OS_THREAD_ATTRIB = ::core::ffi::c_uint;
pub const OS_THREAD_TYPE_OS_THREAD_TYPE_DRIVER: OS_THREAD_TYPE = 0;
pub const OS_THREAD_TYPE_OS_THREAD_TYPE_IO: OS_THREAD_TYPE = 1;
pub const OS_THREAD_TYPE_OS_THREAD_TYPE_APP: OS_THREAD_TYPE = 2;
...
pub struct OSThread {
    ...
    #[doc = "! GHS Exception handling thread-specifics"]
    ...
    #[doc = "! How many ticks the thread should run for before suspension."]
    pub runQuantumTicks: i64,
    #[doc = "! The total amount of core time consumed by this thread (Does not include time while Running)"]
    pub coreTimeConsumedNs: u64,
    #[doc = "! The number of times this thread has been awoken."]
    pub wakeCount: u64,
    pub unk0x610: OSTime,
    pub unk0x618: OSTime,
    pub unk0x620: OSTime,
    pub unk0x628: OSTime,
    #[doc = "! Callback for DSI exception"]
    pub dsiCallback: [OSExceptionCallbackFn; 3usize],
    #[doc = "! Callback for ISI exception"]
    pub isiCallback: [OSExceptionCallbackFn; 3usize],
    #[doc = "! Callback for Program exception"]
    pub programCallback: [OSExceptionCallbackFn; 3usize],
    #[doc = "! Callback for PerfMon exception"]
    pub perfMonCallback: [OSExceptionCallbackFn; 3usize],
    #[doc = "! Checks for synchronization objects placed on stack in debug mode when set to true."]
    pub stackSyncObjAllowed: BOOL,
    #[doc = "! Number of TLS sections"]
    pub tlsSectionCount: u16,
    pub __unk54: [::core::ffi::c_char; 2usize],
    #[doc = "! TLS Sections"]
    pub tlsSections: *mut OSTLSSection,
    #[doc = "! The fast mutex we are currently waiting for"]
    pub fastMutex: *mut OSFastMutex,
    #[doc = "! The fast mutexes we are currently contended on"]
    pub contendedFastMutexes: OSFastMutexQueue,
    #[doc = "! The fast mutexes we currently own locks on"]
    pub fastMutexQueue: OSFastMutexQueue,
    #[doc = "! Callback for Alignment exception"]
    pub alignCallback: [OSExceptionCallbackFn; 3usize],
    #[doc = "! Cleared on thread creation but never used"]
...
pub const CamError_CAMERA_ERROR_OK: CamError = 0;
pub const CamError_CAMERA_ERROR_INVALID_ARG: CamError = -1;
pub const CamError_CAMERA_ERROR_INVALID_HANDLE: CamError = -2;
pub const CamError_CAMERA_ERROR_TOO_MANY_SURFACES: CamError = -4;
pub const CamError_CAMERA_ERROR_INSUFFICIENT_MEMORY: CamError = -5;
pub const CamError_CAMERA_ERROR_NOT_READY: CamError = -6;
pub const CamError_CAMERA_ERROR_UNINITIALIZED: CamError = -8;
pub const CamError_CAMERA_ERROR_UVC: CamError = -9;
pub const CamError_CAMERA_ERROR_UVD_CONTEXT: CamError = -10;
pub const CamError_CAMERA_ERROR_DEVICE_IN_USE: CamError = -12;
pub const CamError_CAMERA_ERROR_UVD_SESSION: CamError = -13;
pub const CamError_CAMERA_ERROR_SEGMENT_VIOLATION: CamError = -15;
pub type CamError = ::core::ffi::c_int;
pub const CamFps_CAMERA_FPS_15: CamFps = 0;
pub const CamFps_CAMERA_FPS_30: CamFps = 1;
pub type CamFps = ::core::ffi::c_uint;
pub const CamStreamType_CAMERA_STREAM_TYPE_1: CamStreamType = 0;
pub type CamStreamType = ::core::ffi::c_uint;
pub const CamEventType_CAMERA_DECODE_DONE: CamEventType = 0;
pub const CamEventType_CAMERA_DRC_DETACH: CamEventType = 1;
...
pub struct CAMEventData__bindgen_ty_1__bindgen_ty_1 {
    #[doc = "! Pointer to the buffer of the decoded image"]
    pub surfaceBuffer: *mut ::core::ffi::c_void,
    #[doc = "! Handle of instance"]
    pub handle: CAMHandle,
    #[doc = "! TRUE if decode failed"]
    pub failed: BOOL,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[derive(Debug, Copy, Clone)]
pub struct CAMMode {
    #[doc = "! If TRUE, the GamePad will display the camera output regardless of what is being rendered"]
    pub forceDrc: BOOL,
    #[doc = "! Framerate setting"]
    pub fps: CamFps,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CAMWorkMem {
    #[doc = "! Size of the work memory"]
    pub size: u32,
    #[doc = "! Pointer to the work memory"]
    pub pMem: *mut ::core::ffi::c_void,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CAMStreamInfo {
    #[doc = "! Stream type, only CAMERA_STREAM_TYPE_1 is valid"]
...
pub struct CAMSetupInfo {
    ...
    #[doc = "! Memory used by library to record and decode frames"]
    pub workMem: CAMWorkMem,
    #[doc = "! Event handler"]
    pub eventHandler: CAMEventHandler,
    #[doc = "! Camera mode"]
    pub mode: CAMMode,
    #[doc = "! See \\link OS_THREAD_ATTRIB \\endlink"]
...
pub struct CAMSurface {
    #[doc = "! Number of bytes allocated to surface buffer"]
    pub surfaceSize: i32,
    #[doc = "! Surface buffer data"]
    pub surfaceBuffer: *mut ::core::ffi::c_void,
    #[doc = "! Surface height"]
    pub height: i32,
    #[doc = "! Surface width"]
    ...
    pub alignment: i32,
    #[doc = "! Tile mode, should be zero"]
    pub tileMode: i32,
    #[doc = "! Pixel format, Should be zero"]
    pub pixelFormat: i32,
}
extern "C" {
...
pub const ProcUICallbackType_PROCUI_CALLBACK_ACQUIRE: ProcUICallbackType = 0;
#[doc = "! Application must release the foreground"]
pub const ProcUICallbackType_PROCUI_CALLBACK_RELEASE: ProcUICallbackType = 1;
#[doc = "! Application must exit"]
pub const ProcUICallbackType_PROCUI_CALLBACK_EXIT: ProcUICallbackType = 2;
#[doc = "! Application may start using networking"]
pub const ProcUICallbackType_PROCUI_CALLBACK_NET_IO_START: ProcUICallbackType = 3;
#[doc = "! Application must stop using networking"]
pub const ProcUICallbackType_PROCUI_CALLBACK_NET_IO_STOP: ProcUICallbackType = 4;
#[doc = "! The user attempted to press the HOME button but was denied"]
pub const ProcUICallbackType_PROCUI_CALLBACK_HOME_BUTTON_DENIED: ProcUICallbackType = 5;
pub type ProcUICallbackType = ::core::ffi::c_uint;
#[doc = "! The application is in the foreground. All resources may be used."]
pub const ProcUIStatus_PROCUI_STATUS_IN_FOREGROUND: ProcUIStatus = 0;
#[doc = "! The application is in the background, only limited resources are usable."]
pub const ProcUIStatus_PROCUI_STATUS_IN_BACKGROUND: ProcUIStatus = 1;
#[doc = "! The application must release the foregound - see ProcUIDrawDoneRelease()"]
pub const ProcUIStatus_PROCUI_STATUS_RELEASE_FOREGROUND: ProcUIStatus = 2;
#[doc = "! The application must release all resources (including ProcUI) and quit"]
pub const ProcUIStatus_PROCUI_STATUS_EXITING: ProcUIStatus = 3;
...
extern "C" {
    #[doc = " Determines whether the ProcUI library is running/initialised.\n\n \\returns\n \\c true if the ProcUI library is initialised.\n\n \\sa\n - ProcUIInit()\n - ProcUIInitEx()\n - ProcUIShutdown()"]
...
extern "C" {
    #[doc = " Register a callback which will be called periodically while in background.\n\n \\param callback\n Function pointer for the callback.\n\n \\param param\n Argument for the callback.\n\n \\param interval\n The interval between callbacks."]
...
>;
pub const CCRCDCDestinationEnum_CCR_CDC_DESTINATION_DRH: CCRCDCDestinationEnum = 1;
pub const CCRCDCDestinationEnum_CCR_CDC_DESTINATION_DRC0: CCRCDCDestinationEnum = 2;
pub const CCRCDCDestinationEnum_CCR_CDC_DESTINATION_DRC1: CCRCDCDestinationEnum = 3;
pub type CCRCDCDestinationEnum = ::core::ffi::c_uint;
pub const CCRCDCWpsStatusEnum_CCR_CDC_WPS_STATUS_PAIRED: CCRCDCWpsStatusEnum = 0;
pub const CCRCDCWpsStatusEnum_CCR_CDC_WPS_STATUS_SEARCHING: CCRCDCWpsStatusEnum = 1;
pub const CCRCDCWpsStatusEnum_CCR_CDC_WPS_STATUS_PAIRING: CCRCDCWpsStatusEnum = 2;
pub type CCRCDCWpsStatusEnum = ::core::ffi::c_uint;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_ACTIVE: CCRCDCDrcStateEnum = 0;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_PAIRING: CCRCDCDrcStateEnum = 1;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_FWUPDATE: CCRCDCDrcStateEnum = 2;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_STANDALONE: CCRCDCDrcStateEnum = 3;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_BACKGROUND: CCRCDCDrcStateEnum = 4;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_SLEEP: CCRCDCDrcStateEnum = 5;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_STANDBY: CCRCDCDrcStateEnum = 6;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_WOWLSETTING: CCRCDCDrcStateEnum = 7;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_DKSETTING: CCRCDCDrcStateEnum = 8;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_UNKNOWN9: CCRCDCDrcStateEnum = 9;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_WIIACTIVE: CCRCDCDrcStateEnum = 10;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_LOW_BATTERY: CCRCDCDrcStateEnum = 11;
pub const CCRCDCDrcStateEnum_CCR_CDC_DRC_STATE_SUBACTIVE: CCRCDCDrcStateEnum = 12;
pub type CCRCDCDrcStateEnum = ::core::ffi::c_uint;
#[doc = "! Power on normally."]
pub const CCRCDCWakeStateEnum_CCR_CDC_WAKE_STATE_ACTIVE: CCRCDCWakeStateEnum = 1;
#[doc = "! Connect in \\c CCR_CDC_DRC_STATE_BACKGROUND state."]
pub const CCRCDCWakeStateEnum_CCR_CDC_WAKE_STATE_BACKGROUND: CCRCDCWakeStateEnum = 2;
pub type CCRCDCWakeStateEnum = ::core::ffi::c_uint;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DK1: CCRCDCBoardVersion = 0;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DK1_EP_DK2: CCRCDCBoardVersion = 1;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DP1: CCRCDCBoardVersion = 2;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DP2: CCRCDCBoardVersion = 3;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DK3: CCRCDCBoardVersion = 4;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DK4: CCRCDCBoardVersion = 5;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_PREDP3_DP3: CCRCDCBoardVersion = 6;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DK5: CCRCDCBoardVersion = 7;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DP4: CCRCDCBoardVersion = 8;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DKMP: CCRCDCBoardVersion = 9;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DP5: CCRCDCBoardVersion = 10;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_MASS: CCRCDCBoardVersion = 11;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DKMP2: CCRCDCBoardVersion = 12;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DRC_I: CCRCDCBoardVersion = 13;
pub const CCRCDCBoardVersion_CCR_CDC_BOARD_VERSION_DKTVMP: CCRCDCBoardVersion = 14;
pub type CCRCDCBoardVersion = ::core::ffi::c_uint;
pub const CCRCDCChipVersion_CCR_CDC_CHIP_VERSION_TS: CCRCDCChipVersion = 16;
pub const CCRCDCChipVersion_CCR_CDC_CHIP_VERSION_ES1: CCRCDCChipVersion = 32;
pub const CCRCDCChipVersion_CCR_CDC_CHIP_VERSION_ES2: CCRCDCChipVersion = 48;
pub const CCRCDCChipVersion_CCR_CDC_CHIP_VERSION_ES3: CCRCDCChipVersion = 64;
pub const CCRCDCChipVersion_CCR_CDC_CHIP_VERSION_MS01: CCRCDCChipVersion = 65;
pub type CCRCDCChipVersion = ::core::ffi::c_uint;
#[doc = "! EEPROM offset 0x200, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_LANGUAGE_BANK: CCRCDCUicConfigIdEnum = 0;
#[doc = "! EEPROM offset 0x20D, Size 0x6"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_MIC_CONFIG: CCRCDCUicConfigIdEnum = 2;
#[doc = "! EEPROM offset 0x213, Size 0xE"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_ACC_CALIBRATION_VALUE: CCRCDCUicConfigIdEnum =
    3;
#[doc = "! EEPROM offset 0x244, Size 0x12"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_TP_CALIBRATION_VALUE: CCRCDCUicConfigIdEnum =
    5;
#[doc = "! EEPROM offset 0x203, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_UNK7: CCRCDCUicConfigIdEnum = 7;
#[doc = "! EEPROM offset 0x206, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_UNK8: CCRCDCUicConfigIdEnum = 8;
#[doc = "! EEPROM offset 0x256, Size 0x6"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_LANGUAGE_EXT_ID: CCRCDCUicConfigIdEnum = 9;
#[doc = "! EEPROM offset 0x289, Size 0xC"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_TV_CONTROL_ID: CCRCDCUicConfigIdEnum = 10;
#[doc = "! EEPROM offset 0x262, Size 0x6"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_EXT_ID_2: CCRCDCUicConfigIdEnum = 11;
#[doc = "! EEPROM offset 0x268, Size 0x6"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_EXT_ID_3: CCRCDCUicConfigIdEnum = 12;
#[doc = "! EEPROM offset 0x26E, Size 0x6"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_EXT_ID_4: CCRCDCUicConfigIdEnum = 13;
#[doc = "! EEPROM offset 0x274, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_INIT_BOOT_FLAG: CCRCDCUicConfigIdEnum = 14;
#[doc = "! EEPROM offset 0x277, Size 0xF"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_UNK15: CCRCDCUicConfigIdEnum = 15;
#[doc = "! EEPROM offset 0x286, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_LCD_MODE: CCRCDCUicConfigIdEnum = 16;
#[doc = "! EEPROM offset 0x25C, Size 0x6"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_RC_DATABASE_EXT_ID: CCRCDCUicConfigIdEnum =
    17;
#[doc = "! EEPROM offset 0x295, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_UNK18: CCRCDCUicConfigIdEnum = 18;
#[doc = "! EEPROM offset 0x298, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_CAFFEINE_ENABLE_FLAG: CCRCDCUicConfigIdEnum =
    19;
#[doc = "! EEPROM offset 0x29B, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_CAFFEINE_INITIAL_BOOT_FLAG:
    CCRCDCUicConfigIdEnum = 20;
#[doc = "! EEPROM offset 0x29E, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_CAFFEINE_CAFFEINE_SLOT:
    CCRCDCUicConfigIdEnum = 21;
#[doc = "! EEPROM offset 0x2A1, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_CAFFEINE_NOTIFICATION_SOUND_MODE:
    CCRCDCUicConfigIdEnum = 22;
#[doc = "! EEPROM offset 0x2A4, Size 0x3"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_CAFFEINE_NOTIFICATION_INFO:
    CCRCDCUicConfigIdEnum = 23;
#[doc = "! EEPROM offset 0x2A7, Size 0x4"]
pub const CCRCDCUicConfigIdEnum_CCR_CDC_UIC_CONFIG_ID_CAFFEINE_NOTIFICATION_READ_COUNT:
    CCRCDCUicConfigIdEnum = 24;
pub type CCRCDCUicConfigIdEnum = ::core::ffi::c_uint;
#[doc = "! Language data"]
pub const CCRCDCExt_CCR_CDC_EXT_LANGUAGE: CCRCDCExt = 0;
#[doc = "! Remote Control Database"]
pub const CCRCDCExt_CCR_CDC_EXT_RC_DATABASE: CCRCDCExt = 1;
#[doc = "! Remote Control Database"]
pub const CCRCDCExt_CCR_CDC_EXT_UNK2: CCRCDCExt = 2;
#[doc = "! Remote Control Database"]
pub const CCRCDCExt_CCR_CDC_EXT_UNK3: CCRCDCExt = 3;
#[doc = "! Remote Control Database"]
pub const CCRCDCExt_CCR_CDC_EXT_UNK4: CCRCDCExt = 4;
pub type CCRCDCExt = ::core::ffi::c_uint;
pub const CCRCDCDrhStateEnum_CCR_CDC_SYS_DRH_STATE_NORADIO: CCRCDCDrhStateEnum = 0;
pub const CCRCDCDrhStateEnum_CCR_CDC_SYS_DRH_STATE_WII: CCRCDCDrhStateEnum = 1;
pub const CCRCDCDrhStateEnum_CCR_CDC_SYS_DRH_STATE_UNK2: CCRCDCDrhStateEnum = 2;
pub const CCRCDCDrhStateEnum_CCR_CDC_SYS_DRH_STATE_NODRC: CCRCDCDrhStateEnum = 3;
pub const CCRCDCDrhStateEnum_CCR_CDC_SYS_DRH_STATE_ECO: CCRCDCDrhStateEnum = 4;
pub const CCRCDCDrhStateEnum_CCR_CDC_SYS_DRH_STATE_UNK7F: CCRCDCDrhStateEnum = 127;
pub const CCRCDCDrhStateEnum_CCR_CDC_SYS_DRH_STATE_CAFE: CCRCDCDrhStateEnum = 255;
pub type CCRCDCDrhStateEnum = ::core::ffi::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct CCRCDCMacAddress {
    #[doc = "! The device this mac address belongs to"]
...
pub struct CCRCDCWpsArgs {
    #[doc = "! Should be set to 1"]
    pub hasArgs: u8,
    #[doc = "! The pin code used for WPS"]
...
pub struct CCRCDCWowlWakeDrcArg {
    ...
    #[doc = "! Must be one of \\link CCRCDCWakeStateEnum \\endlink"]
    pub state: CCRCDCWakeState,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CCRCDCUicConfig {
    #[doc = "! Configuration ID (see \\link CCRCDCUicConfigIdEnum \\endlink)"]
    pub configId: CCRCDCUicConfigId,
    #[doc = "! Size of the configuration data (must match the size described in \\link CCRCDCUicConfigIdEnum \\endlink)"]
    pub size: u8,
...
pub struct CCRCDCDrcState {
    #[doc = "! Must be one of \\link CCRCDCDrcStateEnum \\endlink"]
    pub state: u8,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CCRCDCDrhState {
    #[doc = "! Must be one of \\link CCRCDCDrhStateEnum \\endlink"]
    pub state: u8,
}
extern "C" {
    #[doc = " Send a command directly to the specified destination.\n\n \\param dest\n The device to send the command to.\n See \\link CCRCDCDestinationEnum \\endlink.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Send a ping to the specified destination.\n\n \\param dest\n The device to ping.\n See \\link CCRCDCDestinationEnum \\endlink.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Display a message on the specified DRC.\n\n \\param dest\n The device to display the message on.\n See \\link CCRCDCDestinationEnum \\endlink.\n\n \\param message\n The message struct.\n\n \\return\n 0 on success."]
...
#[doc = "! Initiate a new connection"]
pub const CCRCDCIrdaCommandEnum_CCR_IRDA_COMMAND_CONNECT: CCRCDCIrdaCommandEnum = 0;
#[doc = "! Send data"]
pub const CCRCDCIrdaCommandEnum_CCR_IRDA_COMMAND_SEND: CCRCDCIrdaCommandEnum = 1;
#[doc = "! Receive data"]
pub const CCRCDCIrdaCommandEnum_CCR_IRDA_COMMAND_RECEIVE: CCRCDCIrdaCommandEnum = 2;
#[doc = "! Disconnect"]
pub const CCRCDCIrdaCommandEnum_CCR_IRDA_COMMAND_DISCONNECT: CCRCDCIrdaCommandEnum = 3;
pub type CCRCDCIrdaCommandEnum = ::core::ffi::c_uint;
#[doc = "! 115200 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_115200: CCRCDCIrdaBitrateEnum = 0;
#[doc = "! 96000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_96000: CCRCDCIrdaBitrateEnum = 1;
#[doc = "! 72000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_72000: CCRCDCIrdaBitrateEnum = 2;
#[doc = "! 57600 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_57600: CCRCDCIrdaBitrateEnum = 3;
#[doc = "! 48000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_48000: CCRCDCIrdaBitrateEnum = 4;
#[doc = "! 38400 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_38400: CCRCDCIrdaBitrateEnum = 5;
#[doc = "! 36000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_36000: CCRCDCIrdaBitrateEnum = 6;
#[doc = "! 24000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_24000: CCRCDCIrdaBitrateEnum = 7;
#[doc = "! 19200 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_19200: CCRCDCIrdaBitrateEnum = 8;
#[doc = "! 18000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_18000: CCRCDCIrdaBitrateEnum = 9;
#[doc = "! 12000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_12000: CCRCDCIrdaBitrateEnum = 10;
#[doc = "! 9600 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_9600: CCRCDCIrdaBitrateEnum = 11;
#[doc = "! 7200 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_7200: CCRCDCIrdaBitrateEnum = 13;
#[doc = "! 6000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_6000: CCRCDCIrdaBitrateEnum = 13;
#[doc = "! 4800 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_4800: CCRCDCIrdaBitrateEnum = 14;
#[doc = "! 3000 bits-per-second"]
pub const CCRCDCIrdaBitrateEnum_CCR_IRDA_BITRATE_3000: CCRCDCIrdaBitrateEnum = 15;
pub type CCRCDCIrdaBitrateEnum = ::core::ffi::c_uint;
#[doc = "! Wait for another device to start a connection"]
pub const CCRCDCIrdaConnectionTypeEnum_CCR_IRDA_CONNECTION_WAIT: CCRCDCIrdaConnectionTypeEnum = 0;
#[doc = "! Initiate a new connection"]
pub const CCRCDCIrdaConnectionTypeEnum_CCR_IRDA_CONNECTION_REQUIRE: CCRCDCIrdaConnectionTypeEnum =
    1;
#[doc = "! Don't require a connection"]
pub const CCRCDCIrdaConnectionTypeEnum_CCR_IRDA_CONNECTION_ANY: CCRCDCIrdaConnectionTypeEnum = 2;
pub type CCRCDCIrdaConnectionTypeEnum = ::core::ffi::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct CCRCDCIrdaConnectRequest {
    #[doc = "! CCR_IRDA_COMMAND_CONNECT"]
    pub command: CCRCDCIrdaCommand,
    #[doc = "! Timeout of the connection in ms"]
    pub timeout: u16,
    #[doc = "! Bitrate of the connection"]
    pub bitrate: CCRCDCIrdaBitrate,
    #[doc = "! Amount of data which should be received from the other device"]
    pub receiveSize: u16,
    #[doc = "! The ID of the target device"]
    pub targetId: u8,
    #[doc = "! The type of the connect request"]
...
pub struct CCRCDCIrdaSendRequest {
    #[doc = "! CCR_IRDA_COMMAND_SEND"]
    pub command: CCRCDCIrdaCommand,
    #[doc = "! The size of this request"]
    pub size: u16,
    #[doc = "! Packet data starts here"]
...
pub struct CCRCDCIrdaDisconnectRequest {
    #[doc = "! CCR_IRDA_COMMAND_DISCONNECT"]
    pub command: CCRCDCIrdaCommand,
}
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub struct CCRCDCIrdaSmallPacketHeader {
    #[doc = "! Magic value (needs to be set to 0xa5)"]
    pub magic: u8,
    #[doc = "! ID of the session (gets filled out by the DRC before transmitting the packet)"]
    pub sessionId: u8,
...
#[doc = "! No error"]
pub const IRCResult_IRC_RESULT_SUCCESS: IRCResult = 0;
#[doc = "! The amount of data received from the other device does not match the requested size"]
pub const IRCResult_IRC_RESULT_INVALID_RECEIVE_SIZE: IRCResult = 3;
#[doc = "! The received packet is invalid"]
pub const IRCResult_IRC_RESULT_INVALID_PACKET: IRCResult = 5;
#[doc = "! No data was available to receive"]
pub const IRCResult_IRC_RESULT_NO_DATA: IRCResult = 6;
#[doc = "! Tried to connect while a connection was already established"]
pub const IRCResult_IRC_RESULT_ALREADY_CONNECTED: IRCResult = 11;
#[doc = "! IR is not available (Is the DRC TV menu open?)"]
pub const IRCResult_IRC_IR_UNAVAILABLE: IRCResult = 12;
#[doc = "! IRC is not initialized"]
pub const IRCResult_IRC_RESULT_UNINITIALIZED: IRCResult = 13;
#[doc = "! No connection"]
pub const IRCResult_IRC_RESULT_NOT_CONNECTED: IRCResult = 13;
#[doc = "! __CCRCDCIRCConnect failed"]
pub const IRCResult_IRC_RESULT_CONNECT_FAILED: IRCResult = 15;
#[doc = "! __CCRCDCIRCReceive failed"]
pub const IRCResult_IRC_RESULT_RECEIVE_FAILED: IRCResult = 16;
#[doc = "! __CCRCDCIRCSend failed"]
pub const IRCResult_IRC_RESULT_SEND_FAILED: IRCResult = 17;
#[doc = "! __CCRCDCIRCDisconnect failed"]
pub const IRCResult_IRC_RESULT_DISCONNECT_FAILED: IRCResult = 18;
...
extern "C" {
    #[doc = " Checks if a connection is established.\n\n \\param channel\n The device to use for IR.\n\n \\return\n \\c TRUE if connected."]
...
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_0: KDBCountry = 0;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_1: KDBCountry = 1;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_2: KDBCountry = 2;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_3: KDBCountry = 3;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_4: KDBCountry = 4;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_5: KDBCountry = 5;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_6: KDBCountry = 6;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_7: KDBCountry = 7;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_8: KDBCountry = 8;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_9: KDBCountry = 9;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_10: KDBCountry = 10;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_11: KDBCountry = 11;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_12: KDBCountry = 12;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_13: KDBCountry = 13;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_14: KDBCountry = 14;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_15: KDBCountry = 15;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_16: KDBCountry = 16;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_17: KDBCountry = 17;
pub const KDBCountry_KDB_COUNTRY_UNKNOWN_18: KDBCountry = 18;
pub type KDBCountry = ::core::ffi::c_uint;
pub const KDBError_KDB_ERROR_NONE: KDBError = 0;
pub const KDBError_KDB_ERROR_NOT_INITIALIZED: KDBError = 2;
pub const KDBError_KDB_ERROR_ALREADY_INITIALIZED: KDBError = 3;
pub const KDBError_KDB_ERROR_INVALID_COUNTRY: KDBError = 4;
...
pub const DMAESwapMode_DMAE_SWAP_NONE: DMAESwapMode = 0;
#[doc = "! 16 bit memory swapping."]
pub const DMAESwapMode_DMAE_SWAP_16: DMAESwapMode = 1;
#[doc = "! 32 bit memory swapping."]
pub const DMAESwapMode_DMAE_SWAP_32: DMAESwapMode = 2;
#[doc = "! 64 bit memory swapping."]
pub const DMAESwapMode_DMAE_SWAP_64: DMAESwapMode = 3;
...
#[doc = "! Initialize buffer managment from user-provided buffer.\n! This is a blocking request, which only returns once nsysnet is shut down/the application quits."]
pub const SOMemOptRequest_SOMEMOPT_REQUEST_INIT: SOMemOptRequest = 1;
#[doc = "! Return the amount of bytes used for buffer management."]
pub const SOMemOptRequest_SOMEMOPT_REQUEST_GET_BYTES_USED: SOMemOptRequest = 2;
#[doc = "! Wait for buffer management initialization to be done."]
pub const SOMemOptRequest_SOMEMOPT_REQUEST_WAIT_FOR_INIT: SOMemOptRequest = 3;
#[doc = "! Cancel pending wait for init."]
pub const SOMemOptRequest_SOMEMOPT_REQUEST_CANCEL_WAIT: SOMemOptRequest = 4;
pub type SOMemOptRequest = ::core::ffi::c_uint;
pub const SOMemOptFlags_SOMEMOPT_FLAGS_NONE: SOMemOptFlags = 0;
#[doc = "! Changes the distribution between small and big buffers to 50-50 instead of 80-20."]
pub const SOMemOptFlags_SOMEMOPT_FLAGS_BIG_BUFFERS: SOMemOptFlags = 1;
pub type SOMemOptFlags = ::core::ffi::c_uint;
extern "C" {
    #[doc = " Perform a somemopt request.\n\n \\param request\n The request to perform.\n\n \\param buffer\n A 0x40 aligned buffer for \\link SOMEMOPT_REQUEST_INIT \\endlink.\n\n \\param size\n The size of the buffer for \\link SOMEMOPT_REQUEST_INIT \\endlink.\n Minimum size is \\c 0x20000 bytes, maximum size is \\c 0x300000.\n\n \\param flags\n A combination of flags.\n\n \\return\n -1 on error."]
    pub fn somemopt(
...
pub const FFLCreateIDFlags_FFL_CREATE_ID_FLAG_WII_U: FFLCreateIDFlags = 5;
pub const FFLCreateIDFlags_FFL_CREATE_ID_FLAG_TEMPORARY: FFLCreateIDFlags = 2;
pub const FFLCreateIDFlags_FFL_CREATE_ID_FLAG_NORMAL: FFLCreateIDFlags = 8;
...
pub const OSEventMode_OS_EVENT_MODE_MANUAL: OSEventMode = 0;
#[doc = "! An auto event will reset everytime a thread is woken."]
pub const OSEventMode_OS_EVENT_MODE_AUTO: OSEventMode = 1;
...
>;
pub const SYSArgIDEnum_SYS_ARG_ID_END: SYSArgIDEnum = 0;
pub const SYSArgIDEnum_SYS_ARG_ID_ANCHOR: SYSArgIDEnum = 100;
pub const SYSArgIDEnum_SYS_ARG_ID_RESULT: SYSArgIDEnum = 101;
pub const SYSArgIDEnum_SYS_ARG_ID_URL: SYSArgIDEnum = 200;
pub const SYSArgIDEnum_SYS_ARG_ID_MIV_DATA: SYSArgIDEnum = 300;
pub const SYSArgIDEnum_SYS_ARG_ID_JOIN_PID: SYSArgIDEnum = 400;
pub type SYSArgIDEnum = ::core::ffi::c_uint;
pub const SYSArgTypeEnum_SYS_ARG_TYPE_UINT32: SYSArgTypeEnum = 1;
pub const SYSArgTypeEnum_SYS_ARG_TYPE_UINT64: SYSArgTypeEnum = 2;
pub const SYSArgTypeEnum_SYS_ARG_TYPE_DATA: SYSArgTypeEnum = 3;
pub const SYSArgTypeEnum_SYS_ARG_TYPE_STRING: SYSArgTypeEnum = 4;
...
pub const ACPResult_ACP_RESULT_SUCCESS: ACPResult = 0;
pub const ACPResult_ACP_RESULT_INVALID: ACPResult = -200;
pub const ACPResult_ACP_RESULT_INVALID_PARAMETER: ACPResult = -201;
pub const ACPResult_ACP_RESULT_INVALID_FILE: ACPResult = -202;
pub const ACPResult_ACP_RESULT_INVALID_XML_FILE: ACPResult = -203;
pub const ACPResult_ACP_RESULT_FILE_ACCESS_MODE: ACPResult = -204;
pub const ACPResult_ACP_RESULT_INVALID_NETWORK_TIME: ACPResult = -205;
pub const ACPResult_ACP_RESULT_NOT_FOUND: ACPResult = -500;
pub const ACPResult_ACP_RESULT_FILE_NOT_FOUND: ACPResult = -501;
pub const ACPResult_ACP_RESULT_DIR_NOT_FOUND: ACPResult = -502;
pub const ACPResult_ACP_RESULT_DEVICE_NOT_FOUND: ACPResult = -503;
pub const ACPResult_ACP_RESULT_TITLE_NOT_FOUND: ACPResult = -504;
pub const ACPResult_ACP_RESULT_APPLICATION_NOT_FOUND: ACPResult = -505;
pub const ACPResult_ACP_RESULT_SYSTEM_CONFIG_NOT_FOUND: ACPResult = -506;
pub const ACPResult_ACP_RESULT_XML_ITEM_NOT_FOUND: ACPResult = -507;
pub const ACPResult_ACP_RESULT_ALREADY_EXISTS: ACPResult = -600;
pub const ACPResult_ACP_RESULT_FILE_ALREADY_EXISTS: ACPResult = -601;
pub const ACPResult_ACP_RESULT_DIR_ALREADY_EXISTS: ACPResult = -602;
pub const ACPResult_ACP_RESULT_ALREADY_DONE: ACPResult = -700;
pub const ACPResult_ACP_RESULT_AUTHENTICATION: ACPResult = -1000;
pub const ACPResult_ACP_RESULT_INVALID_REGION: ACPResult = -1001;
pub const ACPResult_ACP_RESULT_RESTRICTED_RATING: ACPResult = -1002;
pub const ACPResult_ACP_RESULT_NOT_PRESENT_RATING: ACPResult = -1003;
pub const ACPResult_ACP_RESULT_PENDING_RATING: ACPResult = -1004;
pub const ACPResult_ACP_RESULT_NET_SETTING_REQUIRED: ACPResult = -1005;
pub const ACPResult_ACP_RESULT_NET_ACCOUNT_REQUIRED: ACPResult = -1006;
pub const ACPResult_ACP_RESULT_NET_ACCOUNT_ERROR: ACPResult = -1007;
pub const ACPResult_ACP_RESULT_BROWSER_REQUIRED: ACPResult = -1008;
pub const ACPResult_ACP_RESULT_OLV_REQUIRED: ACPResult = -1009;
pub const ACPResult_ACP_RESULT_PINCODE_REQUIRED: ACPResult = -1010;
pub const ACPResult_ACP_RESULT_INCORRECT_PINCODE: ACPResult = -1011;
pub const ACPResult_ACP_RESULT_INVALID_LOGO: ACPResult = -1012;
pub const ACPResult_ACP_RESULT_DEMO_EXPIRED_NUMBER: ACPResult = -1013;
pub const ACPResult_ACP_RESULT_DRC_REQUIRED: ACPResult = -1014;
pub const ACPResult_ACP_RESULT_NO_PERMISSION: ACPResult = -1100;
pub const ACPResult_ACP_RESULT_NO_FILE_PERMISSION: ACPResult = -1101;
pub const ACPResult_ACP_RESULT_NO_DIR_PERMISSION: ACPResult = -1102;
pub const ACPResult_ACP_RESULT_BUSY: ACPResult = -1300;
pub const ACPResult_ACP_RESULT_USB_STORAGE_NOT_READY: ACPResult = -1301;
pub const ACPResult_ACP_RESULT_CANCELLED: ACPResult = -1400;
pub const ACPResult_ACP_RESULT_RESOURCE: ACPResult = -1500;
pub const ACPResult_ACP_RESULT_DEVICE_FULL: ACPResult = -1501;
pub const ACPResult_ACP_RESULT_JOURNAL_FULL: ACPResult = -1502;
pub const ACPResult_ACP_RESULT_SYSTEM_MEMORY: ACPResult = -1503;
pub const ACPResult_ACP_RESULT_FS_RESOURCE: ACPResult = -1504;
pub const ACPResult_ACP_RESULT_IPC_RESOURCE: ACPResult = -1505;
pub const ACPResult_ACP_RESULT_NOT_INITIALISED: ACPResult = -1600;
pub const ACPResult_ACP_RESULT_ACCOUNT_ERROR: ACPResult = -1700;
pub const ACPResult_ACP_RESULT_UNSUPPORTED: ACPResult = -1800;
pub const ACPResult_ACP_RESULT_DATA_CORRUPTED: ACPResult = -2000;
pub const ACPResult_ACP_RESULT_DEVICE: ACPResult = -2001;
pub const ACPResult_ACP_RESULT_SLC_DATA_CORRUPTED: ACPResult = -2002;
pub const ACPResult_ACP_RESULT_MLC_DATA_CORRUPTED: ACPResult = -2003;
pub const ACPResult_ACP_RESULT_USB_DATA_CORRUPTED: ACPResult = -2004;
pub const ACPResult_ACP_RESULT_MEDIA: ACPResult = -2100;
pub const ACPResult_ACP_RESULT_MEDIA_NOT_READY: ACPResult = -2101;
pub const ACPResult_ACP_RESULT_MEDIA_BROKEN: ACPResult = -2102;
pub const ACPResult_ACP_RESULT_ODD_MEDIA_NOT_READY: ACPResult = -2103;
pub const ACPResult_ACP_RESULT_ODD_MEDIA_BROKEN: ACPResult = -2104;
pub const ACPResult_ACP_RESULT_USB_MEDIA_NOT_READY: ACPResult = -2105;
pub const ACPResult_ACP_RESULT_USB_MEDIA_BROKEN: ACPResult = -2106;
pub const ACPResult_ACP_RESULT_MEDIA_WRITE_PROTECTED: ACPResult = -2107;
pub const ACPResult_ACP_RESULT_USB_WRITE_PROTECTED: ACPResult = -2108;
pub const ACPResult_ACP_RESULT_MII: ACPResult = -2200;
pub const ACPResult_ACP_RESULT_ENCRYPTION_ERROR: ACPResult = -2201;
pub const ACPResult_ACP_RESULT_GENERIC_ERROR: ACPResult = -4096;
#[doc = " \\defgroup nn_acp_result Result\n \\ingroup nn_acp\n Result codes used by nn_acp\n @{"]
pub type ACPResult = ::core::ffi::c_int;
pub const ACPDeviceType_ACP_DEVICE_TYPE_AUTO: ACPDeviceType = 1;
pub const ACPDeviceType_ACP_DEVICE_TYPE_ODD: ACPDeviceType = 2;
pub const ACPDeviceType_ACP_DEVICE_TYPE_HFIODISC: ACPDeviceType = 2;
pub const ACPDeviceType_ACP_DEVICE_TYPE_MLC: ACPDeviceType = 3;
pub const ACPDeviceType_ACP_DEVICE_TYPE_HFIOMLC: ACPDeviceType = 3;
pub const ACPDeviceType_ACP_DEVICE_TYPE_USB: ACPDeviceType = 4;
...
pub const MCPAppType_MCP_APP_TYPE_GAME_UPDATE: MCPAppType = 134217755;
pub const MCPAppType_MCP_APP_TYPE_GAME_DLC: MCPAppType = 134217742;
pub const MCPAppType_MCP_APP_TYPE_BOOT1: MCPAppType = 268435465;
pub const MCPAppType_MCP_APP_TYPE_SYSTEM_LIBRARIES: MCPAppType = 268435466;
pub const MCPAppType_MCP_APP_TYPE_BLUETOOTH_FIRMWARE: MCPAppType = 268435474;
pub const MCPAppType_MCP_APP_TYPE_DRC_FIRMWARE: MCPAppType = 268435475;
pub const MCPAppType_MCP_APP_TYPE_DRH_FIRMWARE: MCPAppType = 268435476;
pub const MCPAppType_MCP_APP_TYPE_SYSTEM_VERSION: MCPAppType = 268435477;
pub const MCPAppType_MCP_APP_TYPE_DRC_LANGUAGE: MCPAppType = 268435482;
pub const MCPAppType_MCP_APP_TYPE_EXCEPTIONS_DATA: MCPAppType = 402653200;
pub const MCPAppType_MCP_APP_TYPE_SHARED_DATA: MCPAppType = 402653212;
pub const MCPAppType_MCP_APP_TYPE_CERT_STORE: MCPAppType = 402653214;
pub const MCPAppType_MCP_APP_TYPE_PATCH_MAP_DATA: MCPAppType = 402653219;
pub const MCPAppType_MCP_APP_TYPE_WAGONU_MIGRATION_LIST: MCPAppType = 402653225;
pub const MCPAppType_MCP_APP_TYPE_CAFFEINE_TITLE_LIST: MCPAppType = 402653232;
pub const MCPAppType_MCP_APP_TYPE_MCP_TITLE_LIST: MCPAppType = 402653233;
pub const MCPAppType_MCP_APP_TYPE_GAME: MCPAppType = 2147483648;
pub const MCPAppType_MCP_APP_TYPE_GAME_WII: MCPAppType = 2147483694;
pub const MCPAppType_MCP_APP_TYPE_SYSTEM_MENU: MCPAppType = 2415919105;
pub const MCPAppType_MCP_APP_TYPE_SYSTEM_UPDATER: MCPAppType = 2415919115;
pub const MCPAppType_MCP_APP_TYPE_SYSTEM_APPS: MCPAppType = 2415919136;
pub const MCPAppType_MCP_APP_TYPE_ACCOUNT_APPS: MCPAppType = 2415919137;
pub const MCPAppType_MCP_APP_TYPE_SYSTEM_SETTINGS: MCPAppType = 2415919138;
pub const MCPAppType_MCP_APP_TYPE_ECO_PROCESS: MCPAppType = 2415919151;
pub const MCPAppType_MCP_APP_TYPE_EMANUAL: MCPAppType = 3489660931;
pub const MCPAppType_MCP_APP_TYPE_HOME_MENU: MCPAppType = 3489660932;
pub const MCPAppType_MCP_APP_TYPE_ERROR_DISPLAY: MCPAppType = 3489660933;
pub const MCPAppType_MCP_APP_TYPE_BROWSER: MCPAppType = 3489660934;
pub const MCPAppType_MCP_APP_TYPE_MIIVERSE_POST: MCPAppType = 3489660941;
pub const MCPAppType_MCP_APP_TYPE_MIIVERSE: MCPAppType = 3489660950;
pub const MCPAppType_MCP_APP_TYPE_ESHOP: MCPAppType = 3489660951;
pub const MCPAppType_MCP_APP_TYPE_FRIEND_LIST: MCPAppType = 3489660952;
pub const MCPAppType_MCP_APP_TYPE_DOWNLOAD_MANAGEMENT: MCPAppType = 3489660953;
pub const MCPAppType_MCP_APP_TYPE_AOC_OVERLAY: MCPAppType = 3489660972;
pub const MCPAppType_MCP_APP_TYPE_AMIIBO_SETTINGS: MCPAppType = 3489660979;
pub type MCPAppType = ::core::ffi::c_uint;
pub const MCPDeviceType_MCP_DEVICE_TYPE_AUTO: MCPDeviceType = 1;
pub const MCPDeviceType_MCP_DEVICE_TYPE_ODD: MCPDeviceType = 2;
pub const MCPDeviceType_MCP_DEVICE_TYPE_MLC: MCPDeviceType = 3;
pub const MCPDeviceType_MCP_DEVICE_TYPE_USB: MCPDeviceType = 4;
pub type MCPDeviceType = ::core::ffi::c_uint;
pub const MCPDeviceFlags_MCP_DEVICE_FLAG_UNK_1: MCPDeviceFlags = 1;
pub const MCPDeviceFlags_MCP_DEVICE_FLAG_UNK_2: MCPDeviceFlags = 2;
pub const MCPDeviceFlags_MCP_DEVICE_FLAG_UNK_4: MCPDeviceFlags = 4;
pub const MCPDeviceFlags_MCP_DEVICE_FLAG_UNK_8: MCPDeviceFlags = 8;
pub type MCPDeviceFlags = ::core::ffi::c_uint;
pub const MCPInstallTarget_MCP_INSTALL_TARGET_MLC: MCPInstallTarget = 0;
pub const MCPInstallTarget_MCP_INSTALL_TARGET_USB: MCPInstallTarget = 1;
pub type MCPInstallTarget = ::core::ffi::c_uint;
pub const MCPRegion_MCP_REGION_JAPAN: MCPRegion = 1;
pub const MCPRegion_MCP_REGION_USA: MCPRegion = 2;
pub const MCPRegion_MCP_REGION_EUROPE: MCPRegion = 4;
pub const MCPRegion_MCP_REGION_CHINA: MCPRegion = 16;
pub const MCPRegion_MCP_REGION_KOREA: MCPRegion = 32;
pub const MCPRegion_MCP_REGION_TAIWAN: MCPRegion = 64;
pub type MCPRegion = ::core::ffi::c_uint;
#[doc = "! DMCU firmware"]
pub const MCPCompatAVFile_MCP_COMPAT_AV_FILE_DMCU: MCPCompatAVFile = 0;
#[doc = "! Deinterlacer parameters"]
pub const MCPCompatAVFile_MCP_COMPAT_AV_FILE_DEINT: MCPCompatAVFile = 1;
...
extern "C" {
    #[doc = " Saves the current Cafe log to the SLC logs directory.\n Internally calls IOS_Ioctl() with request \\c 0xCD .\n\n \\return\n \\c 0 on success."]
    pub fn MCP_TriggerCrashLogCollection(handle: i32) -> MCPError;
}
extern "C" {
    #[doc = " Sets values to /storage_slc/sys/config/eco.xml\n\n \\return\n \\c 0 on success."]
...
pub const HPADChan_HPAD_CHAN_0: HPADChan = 0;
pub const HPADChan_HPAD_CHAN_1: HPADChan = 1;
pub const HPADChan_HPAD_CHAN_2: HPADChan = 2;
pub const HPADChan_HPAD_CHAN_3: HPADChan = 3;
pub const HPADChan_HPAD_CHAN_4: HPADChan = 4;
pub const HPADChan_HPAD_CHAN_5: HPADChan = 5;
pub const HPADChan_HPAD_CHAN_6: HPADChan = 6;
pub const HPADChan_HPAD_CHAN_7: HPADChan = 7;
pub type HPADChan = ::core::ffi::c_uint;
#[doc = "! Adapter Channel 0"]
pub const HPADGGGGChan_HPAD_GGGG_CHAN_0: HPADGGGGChan = 0;
#[doc = "! Adapter Channel 1"]
pub const HPADGGGGChan_HPAD_GGGG_CHAN_1: HPADGGGGChan = 1;
pub type HPADGGGGChan = ::core::ffi::c_uint;
pub const HPADButtons_HPAD_BUTTON_A: HPADButtons = 1;
pub const HPADButtons_HPAD_BUTTON_B: HPADButtons = 2;
pub const HPADButtons_HPAD_BUTTON_X: HPADButtons = 4;
pub const HPADButtons_HPAD_BUTTON_Y: HPADButtons = 8;
pub const HPADButtons_HPAD_BUTTON_LEFT: HPADButtons = 16;
pub const HPADButtons_HPAD_BUTTON_RIGHT: HPADButtons = 32;
pub const HPADButtons_HPAD_BUTTON_DOWN: HPADButtons = 64;
pub const HPADButtons_HPAD_BUTTON_UP: HPADButtons = 128;
pub const HPADButtons_HPAD_BUTTON_START: HPADButtons = 256;
pub const HPADButtons_HPAD_TRIGGER_Z: HPADButtons = 512;
pub const HPADButtons_HPAD_TRIGGER_R: HPADButtons = 1024;
pub const HPADButtons_HPAD_TRIGGER_L: HPADButtons = 2048;
pub const HPADButtons_HPAD_STICK_EMULATION_LEFT: HPADButtons = 4096;
pub const HPADButtons_HPAD_STICK_EMULATION_RIGHT: HPADButtons = 8192;
pub const HPADButtons_HPAD_STICK_EMULATION_DOWN: HPADButtons = 16384;
pub const HPADButtons_HPAD_STICK_EMULATION_UP: HPADButtons = 32768;
pub const HPADButtons_HPAD_SUBSTICK_EMULATION_LEFT: HPADButtons = 65536;
pub const HPADButtons_HPAD_SUBSTICK_EMULATION_RIGHT: HPADButtons = 131072;
pub const HPADButtons_HPAD_SUBSTICK_EMULATION_DOWN: HPADButtons = 262144;
pub const HPADButtons_HPAD_SUBSTICK_EMULATION_UP: HPADButtons = 524288;
pub type HPADButtons = ::core::ffi::c_uint;
pub const HPADMotorCommand_HPAD_MOTOR_COMMAND_STOP: HPADMotorCommand = 0;
pub const HPADMotorCommand_HPAD_MOTOR_COMMAND_RUMBLE: HPADMotorCommand = 1;
pub const HPADMotorCommand_HPAD_MOTOR_COMMAND_STOP_HARD: HPADMotorCommand = 2;
pub type HPADMotorCommand = ::core::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct HPADStatus {
    #[doc = "! Indicates what HPADButtons are held down."]
    pub hold: i32,
    #[doc = "! Indicates what HPADButtons have been pressed since last sample."]
    pub trigger: i32,
    #[doc = "! Indicates what HPADButtons have been released since last sample."]
    pub release: i32,
    #[doc = "! X-Position of the analog stick"]
    pub stickX: i8,
    #[doc = "! Y-Position of the analog stick"]
    pub stickY: i8,
    #[doc = "! X-Position of the analog substick/C-Stick"]
    pub substickX: i8,
    #[doc = "! Y-Position of the analog substick/C-Stick"]
    pub substickY: i8,
    #[doc = "! Position of the left analog trigger"]
    pub triggerL: u8,
    #[doc = "! Position of the right analog trigger"]
    pub triggerR: u8,
    #[doc = "! Status of the controller"]
    pub status: u8,
    pub __unk73: [::core::ffi::c_char; 1usize],
    #[doc = "! Read error, 0 for success"]
    pub error: i32,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct HPADGGGGStatus {
    #[doc = "! \\c TRUE if the adapeter is connected"]
    pub connected: BOOL,
    #[doc = "! \\c TRUE if the power supply is connected"]
    pub powerSupplyConnected: BOOL,
    #[doc = "! \\c TRUE if the adapter is active/is sending samples"]
    pub active: BOOL,
}
...
extern "C" {
    #[doc = " Get the status of the specified GGGG channel (GC Adapter).\n\n \\param chan\n The channel to get the status from.\n\n \\param status\n A pointer to write the status to.\n\n \\return\n 0 on success."]
    pub fn HPADGetGGGGStatus(chan: HPADGGGGChan, status: *mut HPADGGGGStatus) -> i32;
}
extern "C" {
    #[doc = " Sets a callback for once the specified GGGG Adapter is connected.\n\n \\param chan\n The channel to set the callback.\n\n \\param callback\n A pointer to the callback function.\n\n \\return\n A pointer to the previous callback or \\c NULL."]
...
extern "C" {
    #[doc = " Sets a callback for once the power supply of the specified GGGG Adapter is connected.\n\n \\param chan\n The channel to set the callback.\n\n \\param callback\n A pointer to the callback function.\n\n \\return\n A pointer to the previous callback or \\c NULL."]
...
extern "C" {
    #[doc = " Sets a callback for once a sample is received from the specified GGGG Adapter.\n\n \\param chan\n The channel to set the callback.\n\n \\param callback\n A pointer to the callback function.\n\n \\return\n A pointer to the previous callback or \\c NULL."]
...
pub const MEMBaseHeapType_MEM_BASE_HEAP_MEM1: MEMBaseHeapType = 0;
pub const MEMBaseHeapType_MEM_BASE_HEAP_MEM2: MEMBaseHeapType = 1;
pub const MEMBaseHeapType_MEM_BASE_HEAP_FG: MEMBaseHeapType = 8;
pub type MEMBaseHeapType = ::core::ffi::c_uint;
pub const MEMHeapFillType_MEM_HEAP_FILL_TYPE_UNUSED: MEMHeapFillType = 0;
pub const MEMHeapFillType_MEM_HEAP_FILL_TYPE_ALLOCATED: MEMHeapFillType = 1;
pub const MEMHeapFillType_MEM_HEAP_FILL_TYPE_FREED: MEMHeapFillType = 2;
pub type MEMHeapFillType = ::core::ffi::c_uint;
pub const MEMHeapTag_MEM_BLOCK_HEAP_TAG: MEMHeapTag = 1112296264;
pub const MEMHeapTag_MEM_EXPANDED_HEAP_TAG: MEMHeapTag = 1163415624;
pub const MEMHeapTag_MEM_FRAME_HEAP_TAG: MEMHeapTag = 1179798856;
pub const MEMHeapTag_MEM_UNIT_HEAP_TAG: MEMHeapTag = 1431196744;
pub const MEMHeapTag_MEM_USER_HEAP_TAG: MEMHeapTag = 1431523912;
pub type MEMHeapTag = ::core::ffi::c_uint;
pub const MEMHeapFlags_MEM_HEAP_FLAG_ZERO_ALLOCATED: MEMHeapFlags = 1;
pub const MEMHeapFlags_MEM_HEAP_FLAG_DEBUG_MODE: MEMHeapFlags = 2;
pub const MEMHeapFlags_MEM_HEAP_FLAG_USE_LOCK: MEMHeapFlags = 4;
...
extern "C" {
    #[doc = " Checks the heap for corruption"]
...
extern "C" {
    #[doc = " Connects synchronically to a network, using the default configuration\n May be blocking until the console successfully connects or has an timeout.\n\n \\return\n A \\link nn_result Result\\endlink - see \\link NNResult_IsSuccess \\endlink\n and \\link NNResult_IsFailure \\endlink."]
    pub fn ACConnect() -> NNResult;
}
extern "C" {
    #[doc = " Connects asynchronically to a network, using the default configuration\n\n \\return\n A \\link nn_result Result\\endlink - see \\link NNResult_IsSuccess \\endlink\n and \\link NNResult_IsFailure \\endlink."]
    pub fn ACConnectAsync() -> NNResult;
}
extern "C" {
    #[doc = " Closes connections made with ACConnect. Use GetCloseStatus to get the status.\n\n \\return\n A \\link nn_result Result\\endlink - see \\link NNResult_IsSuccess \\endlink\n and \\link NNResult_IsFailure \\endlink."]
...
extern "C" {
    #[doc = " Checks whether the console is currently connected to a network.\n\n \\return\n A \\link nn_result Result\\endlink - see \\link NNResult_IsSuccess \\endlink\n and \\link NNResult_IsFailure \\endlink."]
...
#[doc = "! Pairing is complete / hasn't started yet"]
pub const CCRSysPairingState_CCR_SYS_PAIRING_FINISHED: CCRSysPairingState = 0;
#[doc = "! Pairing is in progress"]
pub const CCRSysPairingState_CCR_SYS_PAIRING_IN_PROGRESS: CCRSysPairingState = 1;
#[doc = "! Pairing timed out"]
pub const CCRSysPairingState_CCR_SYS_PAIRING_TIMED_OUT: CCRSysPairingState = 2;
pub type CCRSysPairingState = ::core::ffi::c_uint;
pub const CCRSysInitBootFlag_CCR_SYS_BOOT_FLAG_NONE: CCRSysInitBootFlag = 0;
#[doc = "! Shows \"Turn on the TV and Wii U Console..\" text on next DRC boot"]
pub const CCRSysInitBootFlag_CCR_SYS_BOOT_FLAG_FIRST_BOOT: CCRSysInitBootFlag = 1;
pub type CCRSysInitBootFlag = ::core::ffi::c_uint;
pub const CCRSysLCDMode_CCR_SYS_LCD_MODE_BRIGHTNESS_1: CCRSysLCDMode = 1;
pub const CCRSysLCDMode_CCR_SYS_LCD_MODE_BRIGHTNESS_2: CCRSysLCDMode = 2;
pub const CCRSysLCDMode_CCR_SYS_LCD_MODE_BRIGHTNESS_3: CCRSysLCDMode = 3;
pub const CCRSysLCDMode_CCR_SYS_LCD_MODE_BRIGHTNESS_4: CCRSysLCDMode = 4;
pub const CCRSysLCDMode_CCR_SYS_LCD_MODE_BRIGHTNESS_5: CCRSysLCDMode = 5;
...
extern "C" {
    #[doc = " Resets the DRC (It'll show \"Turn on the TV and Wii U console\" until paired)\n @return 0 on success, -1 on error."]
    pub fn CCRSysInitializeSettings() -> i32;
}
extern "C" {
    #[doc = " Sets the brightness of the DRC.\n @return 0 on success, -1 on error."]
    pub fn CCRSysSetCurrentLCDMode(mode: CCRSysLCDMode) -> i32;
}
extern "C" {
    #[doc = " Gets the brightness of the DRC.\n @return 0 on success, -1 on error."]
...
#[doc = "! Use whichever target has more available space"]
pub const TEMPTargetPreference_TEMP_PREF_DEFAULT: TEMPTargetPreference = 0;
#[doc = "! Always prefer USB"]
pub const TEMPTargetPreference_TEMP_PREF_USB: TEMPTargetPreference = 1;
...
extern "C" {
    #[doc = " Always returns FS_STATUS_UNSUPPORTED_CMD"]
...
pub const SAVEStatus_SAVE_STATUS_OK: SAVEStatus = 0;
pub const SAVEStatus_SAVE_STATUS_NOT_FOUND: SAVEStatus = -6;
pub const SAVEStatus_SAVE_STATUS_STORAGE_FULL: SAVEStatus = -12;
...
extern "C" {
    #[doc = " Only FS_MODE_READ_GROUP, FS_MODE_WRITE_GROUP, FS_MODE_READ_OTHER and FS_MODE_WRITE_OTHER can be changed."]
...
extern "C" {
    #[doc = " Only FS_MODE_READ_GROUP, FS_MODE_WRITE_GROUP can be changed."]
...
pub const CmptScreenType_CMPT_SCREEN_TYPE_TV: CmptScreenType = 1;
pub const CmptScreenType_CMPT_SCREEN_TYPE_DRC: CmptScreenType = 2;
pub const CmptScreenType_CMPT_SCREEN_TYPE_BOTH: CmptScreenType = 3;
pub type CmptScreenType = ::core::ffi::c_uint;
extern "C" {
    #[doc = " Gets the required size which needs to be allocated for the \"dataBuffer\".\n The allocated buffer needs to be aligned by 0x40.\n\n \\return\n 0 on success."]
    pub fn CMPTGetDataSize(outSize: *mut u32) -> i32;
}
extern "C" {
    #[doc = " Launches the specified vWii title.\n\n \\return\n 0 on success."]
...
pub const SysAppPFID_SYSAPP_PFID_WII_U_MENU: SysAppPFID = 2;
pub const SysAppPFID_SYSAPP_PFID_TVII: SysAppPFID = 3;
pub const SysAppPFID_SYSAPP_PFID_EMANUAL: SysAppPFID = 4;
pub const SysAppPFID_SYSAPP_PFID_HOME_MENU: SysAppPFID = 5;
pub const SysAppPFID_SYSAPP_PFID_MINI_MIIVERSE: SysAppPFID = 7;
pub const SysAppPFID_SYSAPP_PFID_BROWSER: SysAppPFID = 8;
pub const SysAppPFID_SYSAPP_PFID_MIIVERSE: SysAppPFID = 9;
pub const SysAppPFID_SYSAPP_PFID_ESHOP: SysAppPFID = 10;
pub const SysAppPFID_SYSAPP_PFID_FRIENDLIST: SysAppPFID = 11;
pub const SysAppPFID_SYSAPP_PFID_DOWNLOAD_MANAGEMENT: SysAppPFID = 12;
pub const SysAppPFID_SYSAPP_PFID_DOWNLOAD_GAME: SysAppPFID = 15;
pub const SysAppPFID_SYSAPP_PFID_MINTU: SysAppPFID = 16;
pub const SysAppPFID_SYSAPP_PFID_CABINETU: SysAppPFID = 17;
pub const SysAppPFID_SYSAPP_PFID_TEST_OVERLAY: SysAppPFID = 31;
...
extern "C" {
    #[doc = " Calls __OSClearCopyData then _SYSSwitchTo"]
...
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_NONE: SYSSettingsJumpToTarget = 0;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_INTERNET: SYSSettingsJumpToTarget = 1;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_DATA_MANAGEMENT: SYSSettingsJumpToTarget = 2;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_TV_REMOTE: SYSSettingsJumpToTarget = 3;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_DATE_TIME: SYSSettingsJumpToTarget = 4;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_COUNTRY: SYSSettingsJumpToTarget = 5;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_SYSTEM_UPDATE: SYSSettingsJumpToTarget = 6;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_INITIAL_SETTINGS: SYSSettingsJumpToTarget =
    100;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_UNKNOWN: SYSSettingsJumpToTarget = 101;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_WIPE_CONSOLE: SYSSettingsJumpToTarget = 102;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_QUICK_START_SETTINGS:
    SYSSettingsJumpToTarget = 103;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_TV_CONNECTION_TYPE: SYSSettingsJumpToTarget =
    104;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_DATA_MANAGEMENT_2: SYSSettingsJumpToTarget =
    105;
pub const SYSSettingsJumpToTarget_SYS_SETTINGS_JUMP_TO_SOFTWARE_TRANSFER: SYSSettingsJumpToTarget =
    255;
...
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_WII_U_MENU: SYSTEM_APP_ID = 0;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_SYSTEM_SETTINGS: SYSTEM_APP_ID = 1;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_PARENTAL_CONTROLS: SYSTEM_APP_ID = 2;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_USER_SETTINGS: SYSTEM_APP_ID = 3;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_MII_MAKER: SYSTEM_APP_ID = 4;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_ACCOUNT_SETTINGS: SYSTEM_APP_ID = 5;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_DAILY_LOG: SYSTEM_APP_ID = 6;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_NOTIFICATIONS: SYSTEM_APP_ID = 7;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_HEALTH_AND_SAFETY: SYSTEM_APP_ID = 8;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_ELECTRONIC_MANUAL: SYSTEM_APP_ID = 9;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_WIIU_CHAT: SYSTEM_APP_ID = 10;
pub const SYSTEM_APP_ID_SYSTEM_APP_ID_SOFTWARE_DATA_TRANSFER: SYSTEM_APP_ID = 11;
...
pub const WHBFileError_WHB_FILE_OK: WHBFileError = 0;
pub const WHBFileError_WHB_FILE_FATAL_ERROR: WHBFileError = -1;
...
extern "C" {
    #[doc = " Socket Library (nsysnet.rpl)"]
...
pub const TVEPort_TVE_PORT_HDMI: TVEPort = 0;
pub const TVEPort_TVE_PORT_COMPONENT: TVEPort = 1;
pub const TVEPort_TVE_PORT_COMPOSITE: TVEPort = 2;
pub const TVEPort_TVE_PORT_SCART: TVEPort = 3;
pub type TVEPort = ::core::ffi::c_uint;
pub const TVEHdmiState_TVE_HDMI_STATE_NONE: TVEHdmiState = 0;
pub const TVEHdmiState_TVE_HDMI_STATE_HTPG_OFF: TVEHdmiState = 1;
pub const TVEHdmiState_TVE_HDMI_STATE_RXWAIT: TVEHdmiState = 2;
pub const TVEHdmiState_TVE_HDMI_STATE_EDID_COMP: TVEHdmiState = 3;
pub const TVEHdmiState_TVE_HDMI_STATE_DUMMY_TMDS: TVEHdmiState = 4;
pub const TVEHdmiState_TVE_HDMI_STATE_W4WK: TVEHdmiState = 5;
pub const TVEHdmiState_TVE_HDMI_STATE_1STA: TVEHdmiState = 6;
pub const TVEHdmiState_TVE_HDMI_STATE_2NDA: TVEHdmiState = 7;
pub const TVEHdmiState_TVE_HDMI_STATE_3RDA: TVEHdmiState = 8;
pub const TVEHdmiState_TVE_HDMI_STATE_STAV_OFF: TVEHdmiState = 9;
pub const TVEHdmiState_TVE_HDMI_STATE_DONE: TVEHdmiState = 10;
pub const TVEHdmiState_TVE_HDMI_STATE_OTHER: TVEHdmiState = 11;
pub const TVEHdmiState_TVE_HDMI_STATE_TMDSDOWN: TVEHdmiState = 12;
pub const TVEHdmiState_TVE_HDMI_STATE_SHUTDOWN: TVEHdmiState = 13;
pub const TVEHdmiState_TVE_HDMI_STATE_WII: TVEHdmiState = 14;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_NRESET: TVEHdmiState = 15;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_INT_LINE: TVEHdmiState = 16;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_KEY_LOAD: TVEHdmiState = 17;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_EDID_READ: TVEHdmiState = 18;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_HOTPLUG: TVEHdmiState = 19;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_VSYNC: TVEHdmiState = 20;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_HDCP: TVEHdmiState = 21;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_SYS: TVEHdmiState = 22;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_CEC: TVEHdmiState = 23;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_W41A: TVEHdmiState = 24;
pub const TVEHdmiState_TVE_HDMI_STATE_ERR_W4ED: TVEHdmiState = 25;
pub const TVEHdmiState_TVE_HDMI_STATE_UNKNOWN_1A: TVEHdmiState = 26;
pub type TVEHdmiState = ::core::ffi::c_uint;
extern "C" {
    #[doc = " Gets the analog state.\n\n \\param outState\n Pointer to write the state to."]
    pub fn TVEGetAnalogStat(outState: *mut u32);
}
extern "C" {
    #[doc = " Gets the TV port.\n\n \\return\n One of #TVEPort."]
    pub fn TVEGetCurrentPort() -> TVEPort;
}
extern "C" {
    #[doc = " Gets the HDMI state.\n\n \\param outState\n Pointer to write the state to."]
    pub fn TVEGetHDMIErrorStat(outState: *mut TVEHdmiState);
}
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_TV: TVECECLogicalAddress = 0;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_RECORDING_DEVICE_1: TVECECLogicalAddress = 1;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_RECORDING_DEVICE_2: TVECECLogicalAddress = 2;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_TUNER_1: TVECECLogicalAddress = 3;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_PLAYBACK_DEVICE_1: TVECECLogicalAddress = 4;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_AUDIO_SYSTEM: TVECECLogicalAddress = 5;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_TUNER_2: TVECECLogicalAddress = 6;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_TUNER_3: TVECECLogicalAddress = 7;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_PLAYBACK_DEVICE_2: TVECECLogicalAddress = 8;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_RECORDING_DEVICE_3: TVECECLogicalAddress = 9;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_TUNER_4: TVECECLogicalAddress = 10;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_PLAYBACK_DEVICE_3: TVECECLogicalAddress = 11;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_RESERVED_1: TVECECLogicalAddress = 12;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_RESERVED_2: TVECECLogicalAddress = 13;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_FREE_USE: TVECECLogicalAddress = 14;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_UNREGISTERED: TVECECLogicalAddress = 15;
pub const TVECECLogicalAddress_TVE_CEC_DEVICE_BROADCAST: TVECECLogicalAddress = 15;
pub type TVECECLogicalAddress = ::core::ffi::c_uint;
pub const TVECECOpCode_TVE_CEC_OPCODE_FEATURE_ABORT: TVECECOpCode = 0;
pub const TVECECOpCode_TVE_CEC_OPCODE_IMAGE_VIEW_ON: TVECECOpCode = 4;
pub const TVECECOpCode_TVE_CEC_OPCODE_TUNER_STEP_INCREMENT: TVECECOpCode = 5;
pub const TVECECOpCode_TVE_CEC_OPCODE_TUNER_STEP_DECREMENT: TVECECOpCode = 6;
pub const TVECECOpCode_TVE_CEC_OPCODE_TUNER_DEVICE_STATUS: TVECECOpCode = 7;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_TUNER_DEVICE_STATUS: TVECECOpCode = 8;
pub const TVECECOpCode_TVE_CEC_OPCODE_RECORD_ON: TVECECOpCode = 9;
pub const TVECECOpCode_TVE_CEC_OPCODE_RECORD_STATUS: TVECECOpCode = 10;
pub const TVECECOpCode_TVE_CEC_OPCODE_RECORD_OFF: TVECECOpCode = 11;
pub const TVECECOpCode_TVE_CEC_OPCODE_TEXT_VIEW_ON: TVECECOpCode = 13;
pub const TVECECOpCode_TVE_CEC_OPCODE_RECORD_TV_SCREEN: TVECECOpCode = 15;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_DECK_STATUS: TVECECOpCode = 26;
pub const TVECECOpCode_TVE_CEC_OPCODE_DECK_STATUS: TVECECOpCode = 27;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_MENU_LANGUAGE: TVECECOpCode = 50;
pub const TVECECOpCode_TVE_CEC_OPCODE_CLEAR_ANALOGUE_TIMER: TVECECOpCode = 51;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_ANALOGUE_TIMER: TVECECOpCode = 52;
pub const TVECECOpCode_TVE_CEC_OPCODE_TIMER_STATUS: TVECECOpCode = 53;
pub const TVECECOpCode_TVE_CEC_OPCODE_STANDBY: TVECECOpCode = 54;
pub const TVECECOpCode_TVE_CEC_OPCODE_PLAY: TVECECOpCode = 65;
pub const TVECECOpCode_TVE_CEC_OPCODE_DECK_CONTROL: TVECECOpCode = 66;
pub const TVECECOpCode_TVE_CEC_OPCODE_TIMER_CLEARED_STATUS: TVECECOpCode = 67;
pub const TVECECOpCode_TVE_CEC_OPCODE_USER_CONTROL_PRESSED: TVECECOpCode = 68;
pub const TVECECOpCode_TVE_CEC_OPCODE_USER_CONTROL_RELEASE: TVECECOpCode = 69;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_OSD_NAME: TVECECOpCode = 70;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_OSD_NAME: TVECECOpCode = 71;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_OSD_STRING: TVECECOpCode = 100;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_TIMER_PROGRAM_TITLE: TVECECOpCode = 103;
pub const TVECECOpCode_TVE_CEC_OPCODE_SYSTEM_AUDIO_MODE_REQUEST: TVECECOpCode = 112;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_AUDIO_STATUS: TVECECOpCode = 113;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_SYSTEM_AUDIO_MODE: TVECECOpCode = 114;
pub const TVECECOpCode_TVE_CEC_OPCODE_REPORT_AUDIO_STATUS: TVECECOpCode = 122;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_SYSTEM_AUDIO_MODE_STATUS: TVECECOpCode = 125;
pub const TVECECOpCode_TVE_CEC_OPCODE_SYSTEM_AUDIO_MODE_STATUS: TVECECOpCode = 126;
pub const TVECECOpCode_TVE_CEC_OPCODE_ROUTING_CHANGE: TVECECOpCode = 128;
pub const TVECECOpCode_TVE_CEC_OPCODE_ROUTING_INFORMATION: TVECECOpCode = 129;
pub const TVECECOpCode_TVE_CEC_OPCODE_ACTIVE_SOURCE: TVECECOpCode = 130;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_PHYSICAL_ADDRESS: TVECECOpCode = 131;
pub const TVECECOpCode_TVE_CEC_OPCODE_REPORT_PHYSICAL_ADDRESS: TVECECOpCode = 132;
pub const TVECECOpCode_TVE_CEC_OPCODE_REQUEST_ACTIVE_SOURCE: TVECECOpCode = 133;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_STREAM_PATH: TVECECOpCode = 134;
pub const TVECECOpCode_TVE_CEC_OPCODE_DEVICE_VENDOR_ID: TVECECOpCode = 135;
pub const TVECECOpCode_TVE_CEC_OPCODE_VENDOR_COMMAND: TVECECOpCode = 137;
pub const TVECECOpCode_TVE_CEC_OPCODE_VENDOR_REMOTE_BUTTON_DOWN: TVECECOpCode = 138;
pub const TVECECOpCode_TVE_CEC_OPCODE_VENDOR_REMOTE_BUTTON_UP: TVECECOpCode = 139;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_DEVICE_VENDOR_ID: TVECECOpCode = 140;
pub const TVECECOpCode_TVE_CEC_OPCODE_MENU_REQUEST: TVECECOpCode = 141;
pub const TVECECOpCode_TVE_CEC_OPCODE_MENU_STATUS: TVECECOpCode = 142;
pub const TVECECOpCode_TVE_CEC_OPCODE_GIVE_DEVICE_POWER_STATUS: TVECECOpCode = 143;
pub const TVECECOpCode_TVE_CEC_OPCODE_REPORT_POWER_STATUS: TVECECOpCode = 144;
pub const TVECECOpCode_TVE_CEC_OPCODE_GET_MENU_LANGUAGE: TVECECOpCode = 145;
pub const TVECECOpCode_TVE_CEC_OPCODE_SELECT_ANALOGUE_SERVICE: TVECECOpCode = 146;
pub const TVECECOpCode_TVE_CEC_OPCODE_SELECT_DIGITAL_SERVICE: TVECECOpCode = 147;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_DIGITAL_TIMER: TVECECOpCode = 151;
pub const TVECECOpCode_TVE_CEC_OPCODE_CLEAR_DIGITAL_TIMER: TVECECOpCode = 153;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_AUDIO_RATE: TVECECOpCode = 154;
pub const TVECECOpCode_TVE_CEC_OPCODE_INACTIVE_SOURCE: TVECECOpCode = 157;
pub const TVECECOpCode_TVE_CEC_OPCODE_CEC_VERSION: TVECECOpCode = 158;
pub const TVECECOpCode_TVE_CEC_OPCODE_GET_CEC_VERSION: TVECECOpCode = 159;
pub const TVECECOpCode_TVE_CEC_OPCODE_VENDOR_COMMAND_WITH_ID: TVECECOpCode = 160;
pub const TVECECOpCode_TVE_CEC_OPCODE_CLEAR_EXTERNAL_TIMER: TVECECOpCode = 161;
pub const TVECECOpCode_TVE_CEC_OPCODE_SET_EXTERNAL_TIMER: TVECECOpCode = 162;
pub const TVECECOpCode_TVE_CEC_OPCODE_ABORT: TVECECOpCode = 255;
...
pub const AX_RESULT_AX_RESULT_SUCCESS: AX_RESULT = 0;
pub const AX_RESULT_AX_RESULT_INVALID_DEVICE_TYPE: AX_RESULT = -1;
pub const AX_RESULT_AX_RESULT_INVALID_DRC_VS_MODE: AX_RESULT = -13;
pub const AX_RESULT_AX_RESULT_VOICE_IS_RUNNING: AX_RESULT = -18;
pub const AX_RESULT_AX_RESULT_DELAY_TOO_BIG: AX_RESULT = -19;
...
pub const AX_DRC_VS_MODE_AX_DRC_VS_MODE_UNKNOWN: AX_DRC_VS_MODE = 0;
pub type AX_DRC_VS_MODE = ::core::ffi::c_uint;
pub const AX_DRC_VS_OUTPUT_AX_DRC_VS_OUTPUT_UNKNOWN: AX_DRC_VS_OUTPUT = 0;
pub type AX_DRC_VS_OUTPUT = ::core::ffi::c_uint;
pub const AX_DRC_VS_LC_AX_DRC_VS_LC_UNKNOWN: AX_DRC_VS_LC = 0;
pub type AX_DRC_VS_LC = ::core::ffi::c_uint;
pub const AX_DRC_VS_SPEAKER_POS_AX_DRC_VS_SPEAKER_POS_UNKNOWN: AX_DRC_VS_SPEAKER_POS = 0;
pub type AX_DRC_VS_SPEAKER_POS = ::core::ffi::c_uint;
pub const AX_DRC_VS_SURROUND_GAIN_AX_DRC_VS_SURROUND_GAIN_UNKNOWN: AX_DRC_VS_SURROUND_GAIN = 0;
...
pub const AX_DEVICE_MODE_AX_DEVICE_MODE_UNKNOWN: AX_DEVICE_MODE = 0;
pub type AX_DEVICE_MODE = ::core::ffi::c_uint;
pub const AX_DEVICE_TYPE_AX_DEVICE_TYPE_TV: AX_DEVICE_TYPE = 0;
pub const AX_DEVICE_TYPE_AX_DEVICE_TYPE_DRC: AX_DEVICE_TYPE = 1;
pub const AX_DEVICE_TYPE_AX_DEVICE_TYPE_CONTROLLER: AX_DEVICE_TYPE = 2;
...
pub const AX_INIT_RENDERER_AX_INIT_RENDERER_32KHZ: AX_INIT_RENDERER = 0;
pub const AX_INIT_RENDERER_AX_INIT_RENDERER_48KHZ: AX_INIT_RENDERER = 1;
pub type AX_INIT_RENDERER = ::core::ffi::c_uint;
pub const AX_INIT_PIPELINE_AX_INIT_PIPELINE_SINGLE: AX_INIT_PIPELINE = 0;
pub const AX_INIT_PIPELINE_AX_INIT_PIPELINE_FOUR_STAGE: AX_INIT_PIPELINE = 1;
...
>;
pub const AX_VOICE_FORMAT_AX_VOICE_FORMAT_ADPCM: AX_VOICE_FORMAT = 0;
pub const AX_VOICE_FORMAT_AX_VOICE_FORMAT_LPCM16: AX_VOICE_FORMAT = 10;
pub const AX_VOICE_FORMAT_AX_VOICE_FORMAT_LPCM8: AX_VOICE_FORMAT = 25;
pub type AX_VOICE_FORMAT = ::core::ffi::c_uint;
pub const AX_VOICE_LOOP_AX_VOICE_LOOP_DISABLED: AX_VOICE_LOOP = 0;
pub const AX_VOICE_LOOP_AX_VOICE_LOOP_ENABLED: AX_VOICE_LOOP = 1;
pub type AX_VOICE_LOOP = ::core::ffi::c_uint;
pub const AX_VOICE_RENDERER_AX_VOICE_RENDERER_DSP: AX_VOICE_RENDERER = 0;
pub const AX_VOICE_RENDERER_AX_VOICE_RENDERER_CPU: AX_VOICE_RENDERER = 1;
pub const AX_VOICE_RENDERER_AX_VOICE_RENDERER_AUTO: AX_VOICE_RENDERER = 2;
pub type AX_VOICE_RENDERER = ::core::ffi::c_uint;
pub const AX_VOICE_RATIO_RESULT_AX_VOICE_RATIO_RESULT_SUCCESS: AX_VOICE_RATIO_RESULT = 0;
pub const AX_VOICE_RATIO_RESULT_AX_VOICE_RATIO_RESULT_LESS_THAN_ZERO: AX_VOICE_RATIO_RESULT = -1;
pub const AX_VOICE_RATIO_RESULT_AX_VOICE_RATIO_RESULT_GREATER_THAN_SOMETHING:
    AX_VOICE_RATIO_RESULT = -2;
pub type AX_VOICE_RATIO_RESULT = ::core::ffi::c_int;
pub const AX_VOICE_SRC_TYPE_AX_VOICE_SRC_TYPE_NONE: AX_VOICE_SRC_TYPE = 0;
pub const AX_VOICE_SRC_TYPE_AX_VOICE_SRC_TYPE_LINEAR: AX_VOICE_SRC_TYPE = 1;
pub const AX_VOICE_SRC_TYPE_AX_VOICE_SRC_TYPE_UNK0: AX_VOICE_SRC_TYPE = 2;
pub const AX_VOICE_SRC_TYPE_AX_VOICE_SRC_TYPE_UNK1: AX_VOICE_SRC_TYPE = 3;
pub const AX_VOICE_SRC_TYPE_AX_VOICE_SRC_TYPE_UNK2: AX_VOICE_SRC_TYPE = 4;
pub type AX_VOICE_SRC_TYPE = ::core::ffi::c_uint;
pub const AX_VOICE_STATE_AX_VOICE_STATE_STOPPED: AX_VOICE_STATE = 0;
pub const AX_VOICE_STATE_AX_VOICE_STATE_PLAYING: AX_VOICE_STATE = 1;
pub type AX_VOICE_STATE = ::core::ffi::c_uint;
pub const AX_VOICE_TYPE_AX_VOICE_TYPE_UNKNOWN: AX_VOICE_TYPE = 0;
...
extern "C" {
    #[doc = " Stop HID report transmission.\n\n \\param drcSlot\n The DRC to read the HID reports from (0 or 1).\n\n \\return\n 0 on success."]
    pub fn CCRHIDStop(
        drcSlot: u32,
        callback: IOSAsyncCallbackFn,
        arg: *mut ::core::ffi::c_void,
...
extern "C" {
    #[doc = " Write to the cached Eeprom of the specified device.\n\n \\param drcSlot\n The DRC to read the eeprom from (0 or 1).\n\n \\param offset\n Offset of the Eeprom data.\n\n \\return\n 0 on success."]
...
pub struct NTAGInfoT2T {
    ...
    pub accessID: u32,
    pub titleID: u64,
    #[doc = "! First 0x22 bytes contain NX specific extensions"]
...
>;
#[doc = " Callback function for \\link NTAGRead \\endlink.\n\n \\param chan\n The channel this callback is coming from.\n\n \\param error\n 0 on success.\n\n \\param data\n The result of the data read.\n\n \\param userContext\n User provided value."]
...
>;
#[doc = " Callback function for \\link NTAGReadT2T \\endlink.\n\n \\param chan\n The channel this callback is coming from.\n\n \\param error\n 0 on success.\n\n \\param data\n The result of the data read.\n\n \\param userContext\n User provided value."]
...
>;
#[doc = " Callback function for \\link NTAGReadT2TRawData \\endlink.\n\n \\param chan\n The channel this callback is coming from.\n\n \\param error\n 0 on success.\n\n \\param tagInfo\n The tag info of the read tag.\n\n \\param data\n The result of the data read.\n\n \\param userContext\n User provided value."]
...
>;
extern "C" {
    #[doc = " Initializes the NTAG library.\n\n \\param chan\n The DRC channel to use.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Check if NTAG is initialized.\n\n \\param chan\n The DRC channel to use.\n\n \\return\n \\c TRUE if initialized, \\c FALSE otherwise."]
...
extern "C" {
    #[doc = " Shutdown the NTAG library.\n\n \\param chan\n The DRC channel to use.\n\n \\return\n 0 on success."]
    pub fn NTAGShutdown(chan: VPADChan) -> NTAGError;
}
extern "C" {
    #[doc = " Abort pending NTAG operations.\n\n \\param chan\n The DRC channel to use.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
    pub fn NTAGAbort(
        chan: VPADChan,
...
extern "C" {
    #[doc = " Set the format settings which should be checked against while reading from Type 1 tags.\n\n \\param settings\n A pointer from which the settings should be copied from."]
    pub fn NTAGSetFormatSettings(settings: *mut NTAGFormatSettings);
}
extern "C" {
    #[doc = " Read from a Type 1 Tag.\n\n \\param chan\n The DRC channel to use.\n\n \\param timeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param uid\n The UID of the expected tag (can be \\c NULL).\n\n \\param uidMask\n The UID of the tag will be masked with this mask before compared to the expected UID (can be \\c NULL).\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
    pub fn NTAGRead(
        chan: VPADChan,
        timeout: u32,
        uid: *mut NFCUid,
...
extern "C" {
    #[doc = " Read from a Type 2 Tag and decrypt & convert the data.\n\n \\param chan\n The DRC channel to use.\n\n \\param timeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param uid\n The UID of the expected tag (can be \\c NULL).\n\n \\param uidMask\n The UID of the tag will be masked with this mask before compared to the expected UID (can be \\c NULL).\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
    pub fn NTAGReadT2T(
        chan: VPADChan,
        timeout: u32,
        uid: *mut NFCUid,
...
extern "C" {
    #[doc = " Read raw data from a Type 2 Tag.\n\n \\param chan\n The DRC channel to use.\n\n \\param timeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param uid\n The UID of the expected tag (can be \\c NULL).\n\n \\param uidMask\n The UID of the tag will be masked with this mask before compared to the expected UID (can be \\c NULL).\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
...
extern "C" {
    #[doc = " Convert & encrypt data and write it to a Type 2 Tag.\n\n \\param chan\n The DRC channel to use.\n\n \\param timeout\n Timeout in ms until tag discovery is cancelled.\n\n \\param uid\n The UID of the expected tag.\n\n \\param data\n A pointer to the data which should be written to the tag.\n\n \\param callback\n A pointer to the callback function.\n\n \\param userContext\n User provided value which will be passed to the callback.\n\n \\return\n 0 on success."]
...
pub const NetConfInterfaceTypeEnum_NET_CONF_INTERFACE_TYPE_WIFI: NetConfInterfaceTypeEnum = 0;
pub const NetConfInterfaceTypeEnum_NET_CONF_INTERFACE_TYPE_ETHERNET: NetConfInterfaceTypeEnum = 1;
pub type NetConfInterfaceTypeEnum = ::core::ffi::c_uint;
pub const NetConfEthCfgSpeedEnum_NET_CONF_ETH_CFG_SPEED_10M: NetConfEthCfgSpeedEnum = 10;
pub const NetConfEthCfgSpeedEnum_NET_CONF_ETH_CFG_SPEED_100M: NetConfEthCfgSpeedEnum = 100;
pub type NetConfEthCfgSpeedEnum = ::core::ffi::c_uint;
pub const NetConfEthCfgDuplexEnum_NET_CONF_ETH_CFG_DUPLEX_HALF: NetConfEthCfgDuplexEnum = 1;
pub const NetConfEthCfgDuplexEnum_NET_CONF_ETH_CFG_DUPLEX_FULL: NetConfEthCfgDuplexEnum = 2;
pub type NetConfEthCfgDuplexEnum = ::core::ffi::c_uint;
pub const NetConfEthCfgNegotiationEnum_NET_CONF_ETH_CFG_NEGOTIATION_MANUAL:
    NetConfEthCfgNegotiationEnum = 1;
pub const NetConfEthCfgNegotiationEnum_NET_CONF_ETH_CFG_NEGOTIATION_AUTO:
    NetConfEthCfgNegotiationEnum = 2;
pub type NetConfEthCfgNegotiationEnum = ::core::ffi::c_uint;
pub const NetConfIPv4Mode_NET_CONF_IPV4_MODE_DHCP: NetConfIPv4Mode = 0;
pub const NetConfIPv4Mode_NET_CONF_IPV4_MODE_MANUAL: NetConfIPv4Mode = 2;
pub type NetConfIPv4Mode = ::core::ffi::c_uint;
pub const NetConfWifiPrivacyModeEnum_NET_CONF_WIFI_PRIVACY_MODE_NONE: NetConfWifiPrivacyModeEnum =
    0;
pub const NetConfWifiPrivacyModeEnum_NET_CONF_WIFI_PRIVACY_MODE_WEP: NetConfWifiPrivacyModeEnum = 1;
pub const NetConfWifiPrivacyModeEnum_NET_CONF_WIFI_PRIVACY_MODE_WPA2_PSK_TKIP:
    NetConfWifiPrivacyModeEnum = 3;
pub const NetConfWifiPrivacyModeEnum_NET_CONF_WIFI_PRIVACY_MODE_WPA_PSK_TKIP:
    NetConfWifiPrivacyModeEnum = 4;
pub const NetConfWifiPrivacyModeEnum_NET_CONF_WIFI_PRIVACY_MODE_WPA2_PSK_AES:
    NetConfWifiPrivacyModeEnum = 5;
pub const NetConfWifiPrivacyModeEnum_NET_CONF_WIFI_PRIVACY_MODE_WPA_PSK_AES:
    NetConfWifiPrivacyModeEnum = 6;
pub type NetConfWifiPrivacyModeEnum = ::core::ffi::c_uint;
pub const NetConfProxyAuthTypeEnum_NET_CONF_PROXY_AUTH_TYPE_NONE: NetConfProxyAuthTypeEnum = 0;
pub const NetConfProxyAuthTypeEnum_NET_CONF_PROXY_AUTH_TYPE_BASIC_AUTHENTICATION:
    NetConfProxyAuthTypeEnum = 1;
pub type NetConfProxyAuthTypeEnum = ::core::ffi::c_uint;
pub const NetConfProxyStatusEnum_NET_CONF_PROXY_DISABLED: NetConfProxyStatusEnum = 0;
pub const NetConfProxyStatusEnum_NET_CONF_PROXY_ENABLED: NetConfProxyStatusEnum = 1;
pub type NetConfProxyStatusEnum = ::core::ffi::c_uint;
pub const NetConfLinkStateEnum_NET_CONF_LINK_STATE_UP: NetConfLinkStateEnum = 1;
pub const NetConfLinkStateEnum_NET_CONF_LINK_STATE_DOWN: NetConfLinkStateEnum = 2;
pub const NetConfLinkStateEnum_NET_CONF_LINK_STATE_NEGOTIATE: NetConfLinkStateEnum = 3;
pub type NetConfLinkStateEnum = ::core::ffi::c_uint;
pub const NetConfOperStateEnum_NET_CONF_OPER_STATE_UP: NetConfOperStateEnum = 1;
pub const NetConfOperStateEnum_NET_CONF_OPER_STATE_DOWN: NetConfOperStateEnum = 2;
pub type NetConfOperStateEnum = ::core::ffi::c_uint;
pub const NetConfAdminStateEnum_NET_CONF_ADMIN_STATE_UP: NetConfAdminStateEnum = 1;
pub const NetConfAdminStateEnum_NET_CONF_ADMIN_STATE_DOWN: NetConfAdminStateEnum = 2;
pub type NetConfAdminStateEnum = ::core::ffi::c_uint;
pub const NetConfProfile_NET_CONF_PROFILE_0: NetConfProfile = 0;
pub const NetConfProfile_NET_CONF_PROFILE_1: NetConfProfile = 1;
pub const NetConfProfile_NET_CONF_PROFILE_2: NetConfProfile = 2;
pub const NetConfProfile_NET_CONF_PROFILE_3: NetConfProfile = 3;
pub const NetConfProfile_NET_CONF_PROFILE_4: NetConfProfile = 4;
pub const NetConfProfile_NET_CONF_PROFILE_5: NetConfProfile = 5;
...
extern "C" {
    #[doc = " Returns the currently used IP address of the console if the given interface matches\n the used interface."]
...
extern "C" {
    #[doc = " Returns the currently used DNS of the console if the given interface matches\n the used interface."]
...
extern "C" {
    #[doc = " Returns the currently used gateway of the console if the given interface matches\n the used interface."]
...
extern "C" {
    #[doc = " Returns the currently used subnet of the console if the given interface matches\n the used interface."]
...
extern "C" {
    #[doc = " Returns the manually set DNS servers of the loaded config if the given\n interface matches the used interface."]
...
extern "C" {
    #[doc = " Returns the WIFI IPv4 Info of the loaded config"]
    pub fn netconf_get_if_ipv4_info(info: *mut NetConfIPv4Info) -> ::core::ffi::c_int;
}
extern "C" {
    #[doc = " Returns the IPv4 Info of the loaded config for the given interface"]
...
extern "C" {
    #[doc = " Not implemented on IOSU side"]
...
extern "C" {
    #[doc = " Sets the default profileId"]
...
#[doc = "! An NSSL library return code."]
...
pub const NSSLErrors_NSSL_ERROR_OK: NSSLErrors = 0;
pub const NSSLErrors_NSSL_ERROR_GENERIC: NSSLErrors = -1;
pub const NSSLErrors_NSSL_ERROR_INVALID_NSSL_CONTEXT: NSSLErrors = -2621441;
pub const NSSLErrors_NSSL_ERROR_INVALID_CERT_ID: NSSLErrors = -2621442;
pub const NSSLErrors_NSSL_ERROR_CERT_LIMIT: NSSLErrors = -2621443;
pub const NSSLErrors_NSSL_ERROR_INVALID_NSSL_CONNECTION: NSSLErrors = -2621444;
pub const NSSLErrors_NSSL_ERROR_INVALID_CERT: NSSLErrors = -2621445;
pub const NSSLErrors_NSSL_ERROR_ZERO_RETURN: NSSLErrors = -2621446;
pub const NSSLErrors_NSSL_ERROR_WANT_READ: NSSLErrors = -2621447;
pub const NSSLErrors_NSSL_ERROR_WANT_WRITE: NSSLErrors = -2621448;
pub const NSSLErrors_NSSL_ERROR_IO_ERROR: NSSLErrors = -2621449;
pub const NSSLErrors_NSSL_ERROR_NSSL_LIB_ERROR: NSSLErrors = -2621450;
pub const NSSLErrors_NSSL_ERROR_UNKNOWN: NSSLErrors = -2621451;
pub const NSSLErrors_NSSL_ERROR_OUT_OF_MEMORY: NSSLErrors = -2621452;
pub const NSSLErrors_NSSL_ERROR_INVALID_STATE: NSSLErrors = -2621453;
pub const NSSLErrors_NSSL_ERROR_HANDSHAKE_ERROR: NSSLErrors = -2621454;
pub const NSSLErrors_NSSL_ERROR_NO_CERT: NSSLErrors = -2621455;
pub const NSSLErrors_NSSL_ERROR_INVALID_FD: NSSLErrors = -2621456;
pub const NSSLErrors_NSSL_ERROR_LIB_NOT_READY: NSSLErrors = -2621457;
pub const NSSLErrors_NSSL_ERROR_IPC_ERROR: NSSLErrors = -2621458;
pub const NSSLErrors_NSSL_ERROR_RESOURCE_LIMIT: NSSLErrors = -2621459;
pub const NSSLErrors_NSSL_ERROR_INVALID_HANDLE: NSSLErrors = -2621460;
pub const NSSLErrors_NSSL_ERROR_INVALID_CERT_TYPE: NSSLErrors = -2621461;
pub const NSSLErrors_NSSL_ERROR_INVALID_KEY_TYPE: NSSLErrors = -2621462;
pub const NSSLErrors_NSSL_ERROR_INVALID_SIZE: NSSLErrors = -2621463;
pub const NSSLErrors_NSSL_ERROR_NO_PEER_CERT: NSSLErrors = -2621464;
pub const NSSLErrors_NSSL_ERROR_INSUFFICIENT_SIZE: NSSLErrors = -2621465;
pub const NSSLErrors_NSSL_ERROR_NO_CIPHER: NSSLErrors = -2621466;
pub const NSSLErrors_NSSL_ERROR_INVALID_ARG: NSSLErrors = -2621467;
pub const NSSLErrors_NSSL_ERROR_INVALID_NSSL_SESSION: NSSLErrors = -2621468;
pub const NSSLErrors_NSSL_ERROR_NO_SESSION: NSSLErrors = -2621469;
pub const NSSLErrors_NSSL_ERROR_SSL_SHUTDOWN_ERROR: NSSLErrors = -2621470;
pub const NSSLErrors_NSSL_ERROR_CERT_SIZE_LIMIT: NSSLErrors = -2621471;
pub const NSSLErrors_NSSL_ERROR_CERT_NO_ACCESS: NSSLErrors = -2621472;
pub const NSSLErrors_NSSL_ERROR_INVALID_CERT_ID2: NSSLErrors = -2621473;
pub const NSSLErrors_NSSL_ERROR_CERT_READ_ERROR: NSSLErrors = -2621474;
pub const NSSLErrors_NSSL_ERROR_CERT_STORE_INIT_FAILURE: NSSLErrors = -2621475;
pub const NSSLErrors_NSSL_ERROR_INVALID_CERT_ENCODING: NSSLErrors = -2621476;
pub const NSSLErrors_NSSL_ERROR_CERT_STORE_ERROR: NSSLErrors = -2621477;
pub const NSSLErrors_NSSL_ERROR_PRIVATE_KEY_READ_ERROR: NSSLErrors = -2621478;
pub const NSSLErrors_NSSL_ERROR_INVALID_PRIVATE_KEY: NSSLErrors = -2621479;
pub const NSSLErrors_NSSL_ERROR_NOT_READY: NSSLErrors = -2621480;
pub const NSSLErrors_NSSL_ERROR_ENCRYPTION_ERROR: NSSLErrors = -2621481;
pub const NSSLErrors_NSSL_ERROR_NO_CERT_STORE: NSSLErrors = -2621482;
pub const NSSLErrors_NSSL_ERROR_PRIVATE_KEY_SIZE_LIMIT: NSSLErrors = -2621483;
pub const NSSLErrors_NSSL_ERROR_PROCESS_MAX_EXT_CERTS: NSSLErrors = -2621484;
pub const NSSLErrors_NSSL_ERROR_PROCESS_MAX_CONTEXTS: NSSLErrors = -2621485;
pub const NSSLErrors_NSSL_ERROR_PROCESS_MAX_CONNECTIONS: NSSLErrors = -2621486;
pub const NSSLErrors_NSSL_ERROR_CERT_NOT_EXPORTABLE: NSSLErrors = -2621487;
pub const NSSLErrors_NSSL_ERROR_INVALID_CERT_SIZE: NSSLErrors = -2621488;
pub const NSSLErrors_NSSL_ERROR_INVALID_KEY_SIZE: NSSLErrors = -2621489;
#[doc = " List of errors returned by the NSSL library."]
pub type NSSLErrors = ::core::ffi::c_int;
#[doc = "! Represents the first certificate in the Nintendo CA group."]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GROUP_NINTENDO_FIRST: NSSLServerCertId = 100;
#[doc = "! Nintendo CA\n! (SHA1: B5 22 94 55 DD 26 C1 F5 3C 73 06 0E 90 89 B3 91 38 9E 1F 75)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_NINTENDO_CA: NSSLServerCertId = 100;
#[doc = "! Nintendo CA - G2\n! (SHA1: C6 0B 2A 5C C9 0F 06 30 CC A3 30 40 DF 6B 33 78 23 9F 3B FA)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_NINTENDO_CA_G2: NSSLServerCertId = 101;
#[doc = "! Nintendo CA - G3\n! (SHA1: 68 A0 77 05 CC C7 A4 08 41 6E 0E D7 AD 65 F2 EC 3F EA 98 62)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_NINTENDO_CA_G3: NSSLServerCertId = 102;
#[doc = "! Nintendo Class 2 CA\n! (SHA1: AA 8E F6 6A E0 F8 07 ED B8 41 C8 89 EE 36 66 A2 59 A2 8C CC)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_NINTENDO_CLASS2_CA: NSSLServerCertId = 103;
#[doc = "! Nintendo Class 2 CA - G2\n! (SHA1: 03 9D E5 37 3A C6 5E 1A EE 89 8D 54 E7 56 35 76 EB BE 54 9B)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_NINTENDO_CLASS2_CA_G2: NSSLServerCertId = 104;
#[doc = "! Nintendo Class 2 CA - G3\n! (SHA1: FA B5 6C 4C C7 CF F5 07 1D 40 B6 B0 07 38 61 D2 90 CA 2A 1A)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_NINTENDO_CLASS2_CA_G3: NSSLServerCertId = 105;
#[doc = "! Represents the last certificate in the Nintendo CA group."]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GROUP_NINTENDO_LAST: NSSLServerCertId = 105;
#[doc = "! Represents the first certificate in the commercial CA group."]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GROUP_COMMERCIAL_FIRST: NSSLServerCertId = 1001;
#[doc = "! Baltimore CyberTrust Root\n! (SHA1: D4 DE 20 D0 5E 66 FC 53 FE 1A 50 88 2C 78 DB 28 52 CA E4 74)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_BALTIMORE_CYBERTRUST_ROOT_CA: NSSLServerCertId = 1001;
#[doc = "! Cybertrust Global Root\n! (SHA1: 5F 43 E5 B1 BF F8 78 8C AC 1C C7 CA 4A 9A C6 22 2B CC 34 C6)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_CYBERTRUST_GLOBAL_ROOT_CA: NSSLServerCertId = 1002;
#[doc = "! Verizon Global Root\n! (SHA1: 91 21 98 EE F2 3D CA C4 09 39 31 2F EE 97 DD 56 0B AE 49 B1)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_VERIZON_GLOBAL_ROOT_CA: NSSLServerCertId = 1003;
#[doc = "! GlobalSign Root CA\n! (SHA1: B1 BC 96 8B D4 F4 9D 62 2A A8 9A 81 F2 15 01 52 A4 1D 82 9C)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GLOBALSIGN_ROOT_CA: NSSLServerCertId = 1004;
#[doc = "! GlobalSign\n! (SHA1: 75 E0 AB B6 13 85 12 27 1C 04 F8 5F DD DE 38 E4 B7 24 2E FE)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GLOBALSIGN_ROOT_CA_R2: NSSLServerCertId = 1005;
#[doc = "! GlobalSign\n! (SHA1: D6 9B 56 11 48 F0 1C 77 C5 45 78 C1 09 26 DF 5B 85 69 76 AD)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GLOBALSIGN_ROOT_CA_R3: NSSLServerCertId = 1006;
...
pub const NSSLServerCertId_NSSL_SERVER_CERT_VERISIGN_CLASS3_PUBLIC_PRIMARY_CA_G3: NSSLServerCertId =
    1007;
#[doc = "! VeriSign Universal Root Certification Authority\n! (SHA1: 36 79 CA 35 66 87 72 30 4D 30 A5 FB 87 3B 0F A7 7B B7 0D 54)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_VERISIGN_UNIVERSAL_ROOT_CA: NSSLServerCertId = 1008;
...
pub const NSSLServerCertId_NSSL_SERVER_CERT_VERISIGN_CLASS3_PUBLIC_PRIMARY_CA_G5: NSSLServerCertId =
    1009;
#[doc = "! thawte Primary Root CA - G3\n! (SHA1: F1 8B 53 8D 1B E9 03 B6 A6 F0 56 43 5B 17 15 89 CA F3 6B F2)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_THAWTE_PRIMARY_ROOT_CA_G3: NSSLServerCertId = 1010;
#[doc = "! thawte Primary Root CA\n! (SHA1: 91 C6 D6 EE 3E 8A C8 63 84 E5 48 C2 99 29 5C 75 6C 81 7B 81)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_THAWTE_PRIMARY_ROOT_CA: NSSLServerCertId = 1011;
#[doc = "! GeoTrust Global CA\n! (SHA1: DE 28 F4 A4 FF E5 B9 2F A3 C5 03 D1 A3 49 A7 F9 96 2A 82 12)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GEOTRUST_GLOBAL_CA: NSSLServerCertId = 1012;
#[doc = "! GeoTrust Global CA 2\n! (SHA1: A9 E9 78 08 14 37 58 88 F2 05 19 B0 6D 2B 0D 2B 60 16 90 7D)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GEOTRUST_GLOBAL_CA2: NSSLServerCertId = 1013;
#[doc = "! GeoTrust Primary Certification Authority\n! (SHA1: 32 3C 11 8E 1B F7 B8 B6 52 54 E2 E2 10 0D D6 02 90 37 F0 96)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GEOTRUST_PRIMARY_CA: NSSLServerCertId = 1014;
#[doc = "! GeoTrust Primary Certification Authority - G3\n! (SHA1: 03 9E ED B8 0B E7 A0 3C 69 53 89 3B 20 D2 D9 32 3A 4C 2A FD)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GEOTRUST_PRIMARY_CA_G3: NSSLServerCertId = 1015;
#[doc = "! AddTrust External CA Root\n! (SHA1: 02 FA F3 E2 91 43 54 68 60 78 57 69 4D F5 E4 5B 68 85 18 68)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_ADDTRUST_EXT_CA_ROOT: NSSLServerCertId = 1016;
#[doc = "! COMODO Certification Authority\n! (SHA1: EE 86 93 87 FF FD 83 49 AB 5A D1 43 22 58 87 89 A4 57 B0 12)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_COMODO_CA: NSSLServerCertId = 1017;
#[doc = "! UTN - DATACorp SGC\n! (SHA1: 58 11 9F 0E 12 82 87 EA 50 FD D9 87 45 6F 4F 78 DC FA D6 D4)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_UTN_DATACORP_SGC_CA: NSSLServerCertId = 1018;
#[doc = "! UTN-USERFirst-Hardware\n! (SHA1: 04 83 ED 33 99 AC 36 08 05 87 22 ED BC 5E 46 00 E3 BE F9 D7)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_UTN_USERFIRST_HARDWARE_CA: NSSLServerCertId = 1019;
#[doc = "! DigiCert High Assurance EV Root CA\n! (SHA1: 5F B7 EE 06 33 E2 59 DB AD 0C 4C 9A E6 D3 8F 1A 61 C7 DC 25)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_DIGICERT_HIGH_ASSURANCE_EV_ROOT_CA: NSSLServerCertId =
    1020;
#[doc = "! DigiCert Assured ID Root CA\n! (SHA1: 05 63 B8 63 0D 62 D7 5A BB C8 AB 1E 4B DF B5 A8 99 B2 4D 43)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_DIGICERT_ASSURED_ID_ROOT_CA: NSSLServerCertId = 1021;
#[doc = "! DigiCert Global Root CA\n! (SHA1: A8 98 5D 3A 65 E5 E5 C4 B2 D7 D6 6D 40 C6 DD 2F B1 9C 54 36)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_DIGICERT_GLOBAL_ROOT_CA: NSSLServerCertId = 1022;
#[doc = "! GTE CyberTrust Global Root\n! (SHA1: 97 81 79 50 D8 1C 96 70 CC 34 D8 09 CF 79 44 31 36 7E F4 74)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GTE_CYBERTRUST_GLOBAL_ROOT: NSSLServerCertId = 1023;
#[doc = "! [No common name]\n! (SHA1: A1 DB 63 93 91 6F 17 E4 18 55 09 40 04 15 C7 02 40 B0 AE 6B)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_VERISIGN_CLASS3_PUBLIC_PRIMARY_CA: NSSLServerCertId =
    1024;
#[doc = "! Thawte Premium Server CA\n! (SHA1: 62 7F 8D 78 27 65 63 99 D2 7D 7F 90 44 C9 FE B3 F3 3E FA 9A)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_THAWTE_PREMIUM_SERVER_CA: NSSLServerCertId = 1025;
#[doc = "! [No common name]\n! (SHA1: D2 32 09 AD 23 D3 14 23 21 74 E4 0D 7F 9D 62 13 97 86 63 3A)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_EQUIFAX_SECURE_CA: NSSLServerCertId = 1026;
#[doc = "! Entrust.net Secure Server Certification Authority\n! (SHA1: 99 A6 9B E6 1A FE 88 6B 4D 2B 82 00 7C B8 54 FC 31 7E 15 39)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_ENTRUST_SECURE_SERVER_CA: NSSLServerCertId = 1027;
#[doc = "! [No common name]\n! (SHA1: 85 37 1C A6 E5 50 14 3D CE 28 03 47 1B DE 3A 09 E8 F8 77 0F)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_VERISIGN_CLASS3_PUBLIC_PRIMARY_CA_G2: NSSLServerCertId =
    1028;
#[doc = "! Entrust.net Certification Authority (2048)\n! (SHA1: 50 30 06 09 1D 97 D4 F5 AE 39 F7 CB E7 92 7D 7D 65 2D 34 31)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_ENTRUST_CA_2048: NSSLServerCertId = 1029;
#[doc = "! Entrust Root Certification Authority\n! (SHA1: B3 1E B1 B7 40 E3 6C 84 02 DA DC 37 D4 4D F5 D4 67 49 52 F9)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_ENTRUST_ROOT_CA: NSSLServerCertId = 1030;
#[doc = "! Entrust Root Certification Authority - G2\n! (SHA1: 8C F4 27 FD 79 0C 3A D1 66 06 8D E8 1E 57 EF BB 93 22 72 D4)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_ENTRUST_ROOT_CA_G2: NSSLServerCertId = 1031;
#[doc = "! DigiCert Assured ID Root G2\n! (SHA1: A1 4B 48 D9 43 EE 0A 0E 40 90 4F 3C E0 A4 C0 91 93 51 5D 3F)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_DIGICERT_ASSURED_ID_ROOT_CA_G2: NSSLServerCertId = 1032;
#[doc = "! DigiCert Global Root G2\n! (SHA1: DF 3C 24 F9 BF D6 66 76 1B 26 80 73 FE 06 D1 CC 8D 4F 82 A4)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_DIGICERT_GLOBAL_ROOT_CA_G2: NSSLServerCertId = 1033;
#[doc = "! Represents the last certificate in the commerical CA group."]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GROUP_COMMERCIAL_LAST: NSSLServerCertId = 1033;
#[doc = "! Represents the first certificate in the 4096-bit commercial CA group."]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GROUP_COMMERCIAL_4096_FIRST: NSSLServerCertId = 1900;
#[doc = "! COMODO RSA Certification Authority\n! (SHA1: AF E5 D2 44 A8 D1 19 42 30 FF 47 9F E2 F8 97 BB CD 7A 8C B4)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_COMODO_RSA_CA: NSSLServerCertId = 1900;
#[doc = "! USERTrust RSA Certification Authority\n! (SHA1: 2B 8F 1B 57 33 0D BB A2 D0 7A 6C 51 F7 0E E9 0D DA B9 AD 8E)"]
pub const NSSLServerCertId_NSSL_SERVER_CERT_USERTRUST_RSA_CA: NSSLServerCertId = 1901;
#[doc = "! Represents the last certificate in the 4096-bit commercial CA group."]
pub const NSSLServerCertId_NSSL_SERVER_CERT_GROUP_COMMERCIAL_4096_LAST: NSSLServerCertId = 1901;
...
pub const AVMDrcScanMode_AVM_DRC_SCAN_MODE_UNKNOWN_0: AVMDrcScanMode = 0;
pub const AVMDrcScanMode_AVM_DRC_SCAN_MODE_UNKNOWN_1: AVMDrcScanMode = 1;
pub const AVMDrcScanMode_AVM_DRC_SCAN_MODE_UNKNOWN_3: AVMDrcScanMode = 3;
pub const AVMDrcScanMode_AVM_DRC_SCAN_MODE_UNKNOWN_255: AVMDrcScanMode = 255;
pub type AVMDrcScanMode = ::core::ffi::c_uint;
pub const AVMDrcMode_AVM_DRC_MODE_NONE: AVMDrcMode = 0;
pub const AVMDrcMode_AVM_DRC_MODE_SINGLE: AVMDrcMode = 1;
pub const AVMDrcMode_AVM_DRC_MODE_DOUBLE: AVMDrcMode = 2;
pub type AVMDrcMode = ::core::ffi::c_uint;
pub const AVMDrcSystemAudioMode_AVM_DRC_SYSTEM_AUDIO_MODE_UNKNOWN_0: AVMDrcSystemAudioMode = 0;
pub const AVMDrcSystemAudioMode_AVM_DRC_SYSTEM_AUDIO_MODE_UNKNOWN_1: AVMDrcSystemAudioMode = 1;
pub const AVMDrcSystemAudioMode_AVM_DRC_SYSTEM_AUDIO_MODE_SURROUND: AVMDrcSystemAudioMode = 2;
pub type AVMDrcSystemAudioMode = ::core::ffi::c_uint;
extern "C" {
    #[doc = " Uses AVMGetDRCSystemAudioMode internally\n @param outAudioMode\n @return 0 on success, -2 on error"]
...
#[doc = "! 4:3"]
pub const AVMTvAspectRatio_AVM_TV_ASPECT_RATIO_4_3: AVMTvAspectRatio = 0;
#[doc = "! 16:9"]
pub const AVMTvAspectRatio_AVM_TV_ASPECT_RATIO_16_9: AVMTvAspectRatio = 1;
pub type AVMTvAspectRatio = ::core::ffi::c_uint;
pub const AVMTvResolution_AVM_TV_RESOLUTION_576I: AVMTvResolution = 1;
pub const AVMTvResolution_AVM_TV_RESOLUTION_480I: AVMTvResolution = 2;
pub const AVMTvResolution_AVM_TV_RESOLUTION_480P: AVMTvResolution = 3;
pub const AVMTvResolution_AVM_TV_RESOLUTION_720P: AVMTvResolution = 4;
pub const AVMTvResolution_AVM_TV_RESOLUTION_720P_3D: AVMTvResolution = 5;
pub const AVMTvResolution_AVM_TV_RESOLUTION_1080I: AVMTvResolution = 6;
pub const AVMTvResolution_AVM_TV_RESOLUTION_1080P: AVMTvResolution = 7;
pub const AVMTvResolution_AVM_TV_RESOLUTION_480I_PAL60: AVMTvResolution = 10;
pub const AVMTvResolution_AVM_TV_RESOLUTION_576P: AVMTvResolution = 11;
pub const AVMTvResolution_AVM_TV_RESOLUTION_720P_50HZ: AVMTvResolution = 12;
pub const AVMTvResolution_AVM_TV_RESOLUTION_1080I_50HZ: AVMTvResolution = 13;
pub const AVMTvResolution_AVM_TV_RESOLUTION_1080P_50HZ: AVMTvResolution = 14;
pub type AVMTvResolution = ::core::ffi::c_uint;
pub const AVMTvVideoRegion_AVM_TV_VIDEO_REGION_NTSC: AVMTvVideoRegion = 1;
pub const AVMTvVideoRegion_AVM_TV_VIDEO_REGION_PAL: AVMTvVideoRegion = 2;
pub type AVMTvVideoRegion = ::core::ffi::c_uint;
extern "C" {
    #[doc = " Gets the TV video region.\n\n \\return\n \\c TRUE if the region is set to \\link AVM_TV_VIDEO_REGION_NTSC NTSC \\endlink.\n \\c FALSE if the region is set to \\link AVM_TV_VIDEO_REGION_PAL PAL \\endlink."]
...
pub const UHSStatus_UHS_STATUS_OK: UHSStatus = 0;
pub const UHSStatus_UHS_STATUS_HANDLE_INVALID_ARGS: UHSStatus = 4292804605;
pub const UHSStatus_UHS_STATUS_HANDLE_INVALID_STATE: UHSStatus = 4292804604;
pub type UHSStatus = ::core::ffi::c_uint;
pub const UHSHandleState_UHS_HANDLE_STATE_INIT: UHSHandleState = 0;
pub const UHSHandleState_UHS_HANDLE_STATE_OPENING: UHSHandleState = 1;
pub const UHSHandleState_UHS_HANDLE_STATE_OPENED: UHSHandleState = 2;
pub const UHSHandleState_UHS_HANDLE_STATE_CLOSING: UHSHandleState = 3;
pub const UHSHandleState_UHS_HANDLE_STATE_CLOSED: UHSHandleState = 4;
pub const UHSHandleState_UHS_HANDLE_STATE_ERROR: UHSHandleState = 5;
...
pub const UHSAdminDevType_UHS_ADMIN_DEV_RESET: UHSAdminDevType = 1;
pub const UHSAdminDevType_UHS_ADMIN_DEV_FREEZE: UHSAdminDevType = 2;
pub const UHSAdminDevType_UHS_ADMIN_DEV_SUSPEND: UHSAdminDevType = 3;
pub const UHSAdminDevType_UHS_ADMIN_DEV_RESUME: UHSAdminDevType = 4;
pub const UHSAdminDevType_UHS_ADMIN_DEV_DESTROY: UHSAdminDevType = 5;
pub type UHSAdminDevType = ::core::ffi::c_uint;
pub const UHSAdminEpType_UHS_ADMIN_EP_ENABLE: UHSAdminEpType = 1;
pub const UHSAdminEpType_UHS_ADMIN_EP_DISABLE: UHSAdminEpType = 2;
pub const UHSAdminEpType_UHS_ADMIN_EP_CANCEL: UHSAdminEpType = 3;
pub const UHSAdminEpType_UHS_ADMIN_EP_CANCEL_RESET: UHSAdminEpType = 4;
...
pub const OSDynLoad_Error_OS_DYNLOAD_OK: OSDynLoad_Error = 0;
pub const OSDynLoad_Error_OS_DYNLOAD_OUT_OF_MEMORY: OSDynLoad_Error = 3134259202;
pub const OSDynLoad_Error_OS_DYNLOAD_INVALID_NOTIFY_PTR: OSDynLoad_Error = 3134259214;
pub const OSDynLoad_Error_OS_DYNLOAD_INVALID_MODULE_NAME_PTR: OSDynLoad_Error = 3134259215;
pub const OSDynLoad_Error_OS_DYNLOAD_INVALID_MODULE_NAME: OSDynLoad_Error = 3134259216;
pub const OSDynLoad_Error_OS_DYNLOAD_INVALID_ACQUIRE_PTR: OSDynLoad_Error = 3134259217;
pub const OSDynLoad_Error_OS_DYNLOAD_EMPTY_MODULE_NAME: OSDynLoad_Error = 3134259218;
pub const OSDynLoad_Error_OS_DYNLOAD_INVALID_ALLOCATOR_PTR: OSDynLoad_Error = 3134259223;
pub const OSDynLoad_Error_OS_DYNLOAD_OUT_OF_SYSTEM_MEMORY: OSDynLoad_Error = 3134259247;
pub const OSDynLoad_Error_OS_DYNLOAD_TLS_ALLOCATOR_LOCKED: OSDynLoad_Error = 3134259249;
pub const OSDynLoad_Error_OS_DYNLOAD_MODULE_NOT_FOUND: OSDynLoad_Error = 4294967290;
...
pub const OSDynLoad_ExportType_OS_DYNLOAD_EXPORT_FUNC: OSDynLoad_ExportType = 0;
pub const OSDynLoad_ExportType_OS_DYNLOAD_EXPORT_DATA: OSDynLoad_ExportType = 1;
pub type OSDynLoad_ExportType = ::core::ffi::c_uint;
pub const OSDynLoad_EntryReason_OS_DYNLOAD_LOADED: OSDynLoad_EntryReason = 1;
pub const OSDynLoad_EntryReason_OS_DYNLOAD_UNLOADED: OSDynLoad_EntryReason = 2;
...
pub union OSDynLoad_LoaderSectionInfo__bindgen_ty_1 {
    #[doc = "! Size of the section, set when type != SHT_RPL_IMPORTS"]
    pub size: u32,
    #[doc = "! Name offset of the section, set when type == SHT_RPL_IMPORTS"]
    pub name: u32,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const OSDynLoad_NotifyReason_OS_DYNLOAD_NOTIFY_UNLOADED: OSDynLoad_NotifyReason = 0;
pub const OSDynLoad_NotifyReason_OS_DYNLOAD_NOTIFY_LOADED: OSDynLoad_NotifyReason = 1;
...
extern "C" {
    #[doc = " Get loader heap statistics."]
...
extern "C" {
    #[doc = " Checks if a module is already loaded. Does not load any modules.\n\n Returns OS_DYNLOAD_OK on success."]
...
extern "C" {
    #[doc = " Registers a callback that's called whenever a new .rpl is loaded or unloaded"]
...
extern "C" {
    #[doc = " Removes a previously added a callback"]
...
#[doc = " FIFO queue for IPCBufPool.\n\n Functions similar to a ring buffer."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct IPCBufPoolFIFO {
    #[doc = "! The current message index to push to."]
    pub pushIndex: i32,
    #[doc = "! The current message index to pop from."]
    pub popIndex: i32,
    #[doc = "! The number of messages in the queue."]
    pub count: i32,
    #[doc = "! Tracks the total number of messages in the count."]
    pub maxCount: i32,
    #[doc = "! Messages in the queue."]
    pub messages: *mut *mut ::core::ffi::c_void,
}
#[doc = " Attributes returned by IPCBufPoolGetAttributes."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct IPCBufPoolAttributes {
    #[doc = "! Size of a message in the buffer pool."]
    pub messageSize: u32,
    #[doc = "! Size of the buffer pool."]
    pub poolSize: u32,
    #[doc = "! Number of pending messages in the pool fifo."]
    pub numMessages: u32,
}
#[doc = " A simple message buffer pool used for IPC communication."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct IPCBufPool {
    #[doc = "! Magic header always set to IPCBufPool::MagicHeader."]
    pub magic: u32,
    #[doc = "! Pointer to buffer used for this IPCBufPool."]
    pub buffer: *mut ::core::ffi::c_void,
    #[doc = "! Size of buffer."]
    pub size: u32,
    pub unk0x0C: u32,
    pub unk0x10: u32,
    #[doc = "! Message size from IPCBufPoolCreate."]
    pub messageSize0x14: u32,
    #[doc = "! Message size from IPCBufPoolCreate."]
    pub messageSize0x18: u32,
    #[doc = "! Number of messages in the IPCBufPoolFIFO."]
    pub messageCount: u32,
    #[doc = "! Pointer to start of messages."]
    pub messages: *mut ::core::ffi::c_void,
    #[doc = "! Number of bytes used for the message pointers in IPCBufPoolFIFO."]
    pub messageIndexSize: *mut u32,
    #[doc = "! FIFO queue of messages."]
    pub fifo: IPCBufPoolFIFO,
    #[doc = "! Mutex used to secure access to fifo."]
    pub mutex: OSMutex,
...
pub const OSICICommand_OS_ICI_COMMAND_INVALID_IC_RANGE: OSICICommand = 1;
pub const OSICICommand_OS_ICI_COMMAND_RESCHEDULE_CORE: OSICICommand = 2;
pub const OSICICommand_OS_ICI_COMMAND_HALT_CORE: OSICICommand = 3;
pub const OSICICommand_OS_ICI_COMMAND_PROC_EXIT: OSICICommand = 4;
pub const OSICICommand_OS_ICI_COMMAND_SET_DABR: OSICICommand = 5;
pub const OSICICommand_OS_ICI_COMMAND_PROC_SCHED: OSICICommand = 6;
pub const OSICICommand_OS_ICI_COMMAND_FAST_BG_EXIT: OSICICommand = 7;
pub const OSICICommand_OS_ICI_COMMAND_IOP_SHELL_CORE_TRACE: OSICICommand = 8;
pub const OSICICommand_OS_ICI_COMMAND_SYSTEM_FATAL: OSICICommand = 9;
pub const OSICICommand_OS_ICI_COMMAND_SET_IABR: OSICICommand = 10;
pub const OSICICommand_OS_ICI_COMMAND_PANIC_0X15: OSICICommand = 11;
pub const OSICICommand_OS_ICI_COMMAND_PROC_KILL: OSICICommand = 12;
pub const OSICICommand_OS_ICI_COMMAND_PROC_CRASH: OSICICommand = 13;
pub const OSICICommand_OS_ICI_COMMAND_UNKNOWN: OSICICommand = 14;
pub const OSICICommand_OS_ICI_COMMAND_OVERLAY_ARENA: OSICICommand = 15;
...
pub const IMPadType_IM_PAD_TYPE_NONE: IMPadType = 0;
pub const IMPadType_IM_PAD_TYPE_WII_REMOTE: IMPadType = 1;
pub const IMPadType_IM_PAD_TYPE_WIIU_PRO_CONTROLLER: IMPadType = 2;
pub const IMPadType_IM_PAD_TYPE_WII_REMOTE_EXTENSION: IMPadType = 3;
pub const IMPadType_IM_PAD_TYPE_WIIU_GAMEPAD: IMPadType = 4;
pub type IMPadType = ::core::ffi::c_uint;
pub const IMDeviceState_IM_DEVICE_STATE_CLEAR: IMDeviceState = 0;
pub const IMDeviceState_IM_DEVICE_STATE_INACTIVE: IMDeviceState = 1;
pub const IMDeviceState_IM_DEVICE_STATE_ACTIVE: IMDeviceState = 2;
pub const IMDeviceState_IM_DEVICE_STATE_HOME: IMDeviceState = 3;
pub const IMDeviceState_IM_DEVICE_STATE_POWER: IMDeviceState = 4;
pub const IMDeviceState_IM_DEVICE_STATE_SYNC: IMDeviceState = 5;
...
pub struct IMHomeButtonParams {
    #[doc = "! The controller type which pressed the home button"]
    pub type_: IMPadType,
    #[doc = "! The controller index which pressed the home button"]
    pub index: i32,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const IMParameter_IM_PARAMETER_INACTIVE_SECONDS: IMParameter = 0;
pub const IMParameter_IM_PARAMETER_DIM_ENABLED: IMParameter = 1;
pub const IMParameter_IM_PARAMETER_DIM_PERIOD: IMParameter = 2;
pub const IMParameter_IM_PARAMETER_APD_ENABLED: IMParameter = 3;
pub const IMParameter_IM_PARAMETER_APD_PERIOD: IMParameter = 4;
pub const IMParameter_IM_PARAMETER_RESET_ENABLE: IMParameter = 5;
pub const IMParameter_IM_PARAMETER_RESET_SECONDS: IMParameter = 6;
pub const IMParameter_IM_PARAMETER_POWER_OFF_ENABLE: IMParameter = 7;
pub const IMParameter_IM_PARAMETER_APD_OCCURED: IMParameter = 8;
pub const IMParameter_IM_PARAMETER_DIM_ENABLE_TV: IMParameter = 9;
pub const IMParameter_IM_PARAMETER_DIM_ENABLE_DRC: IMParameter = 10;
pub const IMParameter_IM_PARAMETER_MAX: IMParameter = 11;
pub type IMParameter = ::core::ffi::c_uint;
pub const IMTimer_IM_TIMER_DIM: IMTimer = 0;
pub const IMTimer_IM_TIMER_APD: IMTimer = 1;
pub type IMTimer = ::core::ffi::c_uint;
pub const IMEvent_IM_EVENT_ACTIVE: IMEvent = 1;
pub const IMEvent_IM_EVENT_INACTIVE: IMEvent = 2;
pub const IMEvent_IM_EVENT_DIM: IMEvent = 4;
pub const IMEvent_IM_EVENT_UNDIM: IMEvent = 8;
#[doc = "! Automatic power down"]
pub const IMEvent_IM_EVENT_APD: IMEvent = 16;
#[doc = "! Controller power button was pressed"]
pub const IMEvent_IM_EVENT_POWER: IMEvent = 32;
#[doc = "! Home button was pressed"]
pub const IMEvent_IM_EVENT_HOME: IMEvent = 64;
#[doc = "! Console sync button was pressed"]
pub const IMEvent_IM_EVENT_SYNC: IMEvent = 128;
#[doc = "! Console sync button was pressed"]
pub const IMEvent_IM_EVENT_RESET: IMEvent = 256;
#[doc = "! Event notify was cancelled"]
pub const IMEvent_IM_EVENT_CANCELLED: IMEvent = -2147483648;
...
pub struct MEMBlockHeapTracking {
    pub __unk113: [::core::ffi::c_char; 8usize],
...
pub const OSSavedFrameType_OS_SAVED_FRAME_A: OSSavedFrameType = 0;
pub const OSSavedFrameType_OS_SAVED_FRAME_B: OSSavedFrameType = 1;
pub type OSSavedFrameType = ::core::ffi::c_uint;
pub const OSSavedFrameScreen_OS_SAVED_FRAME_SCREEN_TV: OSSavedFrameScreen = 2;
pub const OSSavedFrameScreen_OS_SAVED_FRAME_SCREEN_DRC: OSSavedFrameScreen = 4;
...
extern "C" {
    #[doc = " Gets the GX2Texture saved via \\link __OSSetSavedFrame \\endlink\n @param ptr_size  must be <= 0x100"]
...
extern "C" {
    #[doc = " @param data expected to be a GX2Texture\n @param size must be <= 0x100\n @return 0 on succes, -1 on error"]
...
pub const OSInterruptType_OS_INTERRUPT_TYPE_ERROR: OSInterruptType = 0;
pub const OSInterruptType_OS_INTERRUPT_TYPE_DSP: OSInterruptType = 1;
pub const OSInterruptType_OS_INTERRUPT_TYPE_GPU7: OSInterruptType = 2;
pub const OSInterruptType_OS_INTERRUPT_TYPE_GPIPPC: OSInterruptType = 3;
pub const OSInterruptType_OS_INTERRUPT_TYPE_PRIMARYI2C: OSInterruptType = 4;
pub const OSInterruptType_OS_INTERRUPT_TYPE_DSPAI: OSInterruptType = 5;
pub const OSInterruptType_OS_INTERRUPT_TYPE_DSPAI2: OSInterruptType = 6;
pub const OSInterruptType_OS_INTERRUPT_TYPE_DSPACC: OSInterruptType = 7;
pub const OSInterruptType_OS_INTERRUPT_TYPE_DSPDSP: OSInterruptType = 8;
pub const OSInterruptType_OS_INTERRUPT_TYPE_IPCPPC0: OSInterruptType = 9;
pub const OSInterruptType_OS_INTERRUPT_TYPE_IPCPPC1: OSInterruptType = 10;
pub const OSInterruptType_OS_INTERRUPT_TYPE_IPCPPC2: OSInterruptType = 11;
pub const OSInterruptType_OS_INTERRUPT_TYPE_AHB: OSInterruptType = 12;
...
pub struct OSCondition {
    ...
    pub name: *const ::core::ffi::c_char,
    pub __unk114: [::core::ffi::c_char; 4usize],
...
pub const COSReportLevel_COS_REPORT_LEVEL_ERROR: COSReportLevel = 0;
pub const COSReportLevel_COS_REPORT_LEVEL_WARN: COSReportLevel = 1;
pub const COSReportLevel_COS_REPORT_LEVEL_INFO: COSReportLevel = 2;
pub const COSReportLevel_COS_REPORT_LEVEL_VERBOSE: COSReportLevel = 3;
pub type COSReportLevel = ::core::ffi::c_uint;
pub const COSReportModule_COS_REPORT_MODULE_UNKNOWN_0: COSReportModule = 0;
pub const COSReportModule_COS_REPORT_MODULE_UNKNOWN_1: COSReportModule = 1;
pub const COSReportModule_COS_REPORT_MODULE_UNKNOWN_2: COSReportModule = 2;
pub const COSReportModule_COS_REPORT_MODULE_UNKNOWN_5: COSReportModule = 5;
...
pub const UCCommand_UC_CMD_READ_SYS_CONFIG: UCCommand = 48;
pub const UCCommand_UC_CMD_WRITE_SYS_CONFIG: UCCommand = 49;
pub const UCCommand_UC_CMD_DELETE_SYS_CONFIG: UCCommand = 50;
pub const UCCommand_UC_CMD_QUERY_SYS_CONFIG: UCCommand = 51;
pub const UCCommand_UC_CMD_LIST_SYS_CONFIG: UCCommand = 52;
pub type UCCommand = ::core::ffi::c_uint;
pub const UCDataType_UC_DATATYPE_UNDEFINED: UCDataType = 0;
pub const UCDataType_UC_DATATYPE_UNSIGNED_BYTE: UCDataType = 1;
pub const UCDataType_UC_DATATYPE_UNSIGNED_SHORT: UCDataType = 2;
pub const UCDataType_UC_DATATYPE_UNSIGNED_INT: UCDataType = 3;
pub const UCDataType_UC_DATATYPE_SIGNED_INT: UCDataType = 4;
pub const UCDataType_UC_DATATYPE_FLOAT: UCDataType = 5;
pub const UCDataType_UC_DATATYPE_STRING: UCDataType = 6;
pub const UCDataType_UC_DATATYPE_HEXBINARY: UCDataType = 7;
pub const UCDataType_UC_DATATYPE_COMPLEX: UCDataType = 8;
pub const UCDataType_UC_DATATYPE_INVALID: UCDataType = 255;
pub type UCDataType = ::core::ffi::c_uint;
pub const UCErrors_UC_ERROR_OK: UCErrors = 0;
pub const UCErrors_UC_ERROR_ERROR: UCErrors = -1;
pub const UCErrors_UC_ERROR_OTHER: UCErrors = -2097153;
pub const UCErrors_UC_ERROR_SYSTEM: UCErrors = -2097154;
pub const UCErrors_UC_ERROR_ALLOC: UCErrors = -2097155;
pub const UCErrors_UC_ERROR_OPCODE: UCErrors = -2097156;
pub const UCErrors_UC_ERROR_INVALID_PARAM: UCErrors = -2097157;
pub const UCErrors_UC_ERROR_INVALID_TYPE: UCErrors = -2097158;
pub const UCErrors_UC_ERROR_UNSUPPORTED: UCErrors = -2097159;
pub const UCErrors_UC_ERROR_NON_LEAF_NODE: UCErrors = -2097160;
pub const UCErrors_UC_ERROR_KEY_NOT_FOUND: UCErrors = -2097161;
pub const UCErrors_UC_ERROR_MODIFY: UCErrors = -2097162;
pub const UCErrors_UC_ERROR_STRING_TOO_LONG: UCErrors = -2097163;
pub const UCErrors_UC_ERROR_ROOT_KEYS_DIFFER: UCErrors = -2097164;
pub const UCErrors_UC_ERROR_INVALID_LOCATION: UCErrors = -2097165;
pub const UCErrors_UC_ERROR_BAD_COMMENT: UCErrors = -2097166;
pub const UCErrors_UC_ERROR_READ_ACCESS: UCErrors = -2097167;
pub const UCErrors_UC_ERROR_WRITE_ACCESS: UCErrors = -2097168;
pub const UCErrors_UC_ERROR_CREATE_ACCESS: UCErrors = -2097169;
pub const UCErrors_UC_ERROR_FILE_SYS_NAME: UCErrors = -2097170;
pub const UCErrors_UC_ERROR_FILE_SYS_INIT: UCErrors = -2097171;
pub const UCErrors_UC_ERROR_FILE_SYS_MOUNT: UCErrors = -2097172;
pub const UCErrors_UC_ERROR_FILE_OPEN: UCErrors = -2097173;
pub const UCErrors_UC_ERROR_FILE_STAT: UCErrors = -2097174;
pub const UCErrors_UC_ERROR_FILE_READ: UCErrors = -2097175;
pub const UCErrors_UC_ERROR_FILE_WRITE: UCErrors = -2097176;
pub const UCErrors_UC_ERROR_FILE_TOO_BIG: UCErrors = -2097177;
pub const UCErrors_UC_ERROR_FILE_REMOVE: UCErrors = -2097178;
pub const UCErrors_UC_ERROR_FILE_RENAME: UCErrors = -2097179;
pub const UCErrors_UC_ERROR_FILE_CLOSE: UCErrors = -2097180;
pub const UCErrors_UC_ERROR_FILE_SEEK: UCErrors = -2097181;
pub const UCErrors_UC_ERROR_FILE_CONFIRM: UCErrors = -2097182;
pub const UCErrors_UC_ERROR_FILE_BACKUP: UCErrors = -2097183;
pub const UCErrors_UC_ERROR_MALFORMED_XML: UCErrors = -2097184;
pub const UCErrors_UC_ERROR_VERSION: UCErrors = -2097185;
pub const UCErrors_UC_ERROR_NO_IPC_BUFFERS: UCErrors = -2097186;
pub const UCErrors_UC_ERROR_FILE_LOCK_NEEDED: UCErrors = -2097188;
pub const UCErrors_UC_ERROR_SYS_PROT: UCErrors = -2097192;
pub type UCErrors = ::core::ffi::c_int;
pub const UCFileSys_UC_FILE_SYS_INVALID: UCFileSys = 0;
pub const UCFileSys_UC_FILE_SYS_SYS: UCFileSys = 1;
pub const UCFileSys_UC_FILE_SYS_SLC: UCFileSys = 2;
pub const UCFileSys_UC_FILE_SYS_RAM: UCFileSys = 3;
...
#[doc = "! Locking is done with a mutex"]
pub const SmdLockType_SMD_LOCK_TYPE_MUTEX: SmdLockType = 0;
#[doc = "! Locking is done by disabling interrupts"]
pub const SmdLockType_SMD_LOCK_TYPE_DISABLE_INTERRUPTS: SmdLockType = 1;
#[doc = "! No locking is done"]
pub const SmdLockType_SMD_LOCK_TYPE_NONE: SmdLockType = 2;
pub type SmdLockType = ::core::ffi::c_uint;
pub const SmdPpcState_SMD_PPC_STATE_INVALID: SmdPpcState = 0;
pub const SmdPpcState_SMD_PPC_STATE_INITIALIZED: SmdPpcState = 1;
pub const SmdPpcState_SMD_PPC_STATE_CLOSED: SmdPpcState = 2;
pub const SmdPpcState_SMD_PPC_STATE_OPENED: SmdPpcState = 3;
pub type SmdPpcState = ::core::ffi::c_uint;
pub const SmdInterfaceState_SMD_INTERFACE_STATE_OPENED: SmdInterfaceState = 8738;
pub const SmdInterfaceState_SMD_INTERFACE_STATE_CLOSED: SmdInterfaceState = 13107;
pub type SmdInterfaceState = ::core::ffi::c_uint;
pub const SmdElementType_SMD_ELEMENT_TYPE_MESSAGE: SmdElementType = 0;
pub const SmdElementType_SMD_ELEMENT_TYPE_VECTOR_SPEC: SmdElementType = 1;
pub const SmdElementType_SMD_ELEMENT_TYPE_VECTOR: SmdElementType = 2;
...
pub struct SmdInterface {
    ...
    pub bufPaddr: u32,
    pub __unk119: [::core::ffi::c_char; 124usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct SmdPpc {
    ...
    pub __unk123: [::core::ffi::c_char; 56usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct SmdSimpleBufPool {
    ...
    pub __unk124: [::core::ffi::c_char; 40usize],
}
extern "C" {
    pub fn smdPpcInit(
        buf: *mut ::core::ffi::c_void,
...
>;
pub const MEMExpHeapMode_MEM_EXP_HEAP_MODE_FIRST_FREE: MEMExpHeapMode = 0;
pub const MEMExpHeapMode_MEM_EXP_HEAP_MODE_NEAREST_SIZE: MEMExpHeapMode = 1;
pub type MEMExpHeapMode = ::core::ffi::c_uint;
pub const MEMExpHeapDirection_MEM_EXP_HEAP_DIR_FROM_TOP: MEMExpHeapDirection = 0;
pub const MEMExpHeapDirection_MEM_EXP_HEAP_DIR_FROM_BOTTOM: MEMExpHeapDirection = 1;
pub type MEMExpHeapDirection = ::core::ffi::c_uint;
pub const MEMExpHeapCheckFlags_MEM_EXP_HEAP_CHECK_FLAGS_NONE: MEMExpHeapCheckFlags = 0;
pub const MEMExpHeapCheckFlags_MEM_EXP_HEAP_CHECK_FLAGS_LOG_ERRORS: MEMExpHeapCheckFlags = 1;
pub type MEMExpHeapCheckFlags = ::core::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct MEMExpHeapBlock {
    ...
    pub tag: u16,
    pub __unk125: [::core::ffi::c_char; 2usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub fn MEMSetAllocModeForExpHeap(heap: MEMHeapHandle, mode: MEMExpHeapMode) -> MEMExpHeapMode;
}
extern "C" {
    pub fn MEMGetAllocModeForExpHeap(heap: MEMHeapHandle) -> MEMExpHeapMode;
}
extern "C" {
...
extern "C" {
    pub fn MEMGetAllocDirForMBlockExpHeap(block: *mut ::core::ffi::c_void) -> MEMExpHeapDirection;
}
extern "C" {
...
extern "C" {
    pub fn MEMCheckExpHeap(handle: MEMHeapHandle, mode: MEMExpHeapCheckFlags) -> BOOL;
}
pub type BSPError = i32;
pub type BSPHardwareVersion = u32;
pub type BSPConsoleTypeRaw = u32;
pub const BSPErrors_BSP_ERROR_OK: BSPErrors = 0;
pub const BSPErrors_BSP_ERROR_IOS_ERROR: BSPErrors = 64;
pub const BSPErrors_BSP_ERROR_RESPONSE_TOO_LARGE: BSPErrors = 128;
pub type BSPErrors = ::core::ffi::c_uint;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_UNKNOWN: BSPHardwareVersions = 0;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_HOLLYWOOD_ENG_SAMPLE_1: BSPHardwareVersions = 1;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_HOLLYWOOD_ENG_SAMPLE_2: BSPHardwareVersions =
    268435457;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_HOLLYWOOD_PROD_FOR_WII: BSPHardwareVersions =
    269484033;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_HOLLYWOOD_CORTADO: BSPHardwareVersions =
    269484040;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_HOLLYWOOD_CORTADO_ESPRESSO: BSPHardwareVersions =
    269484044;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_BOLLYWOOD: BSPHardwareVersions = 536870913;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_BOLLYWOOD_PROD_FOR_WII: BSPHardwareVersions =
    537919489;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A11_EV: BSPHardwareVersions = 554696720;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A11_CAT: BSPHardwareVersions = 554696736;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A12_EV: BSPHardwareVersions = 555745296;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A12_CAT: BSPHardwareVersions = 555745312;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A2X_EV: BSPHardwareVersions = 571473936;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A2X_CAT: BSPHardwareVersions = 571473952;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A3X_EV: BSPHardwareVersions = 588251152;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A3X_CAT: BSPHardwareVersions = 588251168;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A3X_CAFE: BSPHardwareVersions = 588251176;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A4X_EV: BSPHardwareVersions = 605028368;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A4X_CAT: BSPHardwareVersions = 605028384;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A4X_CAFE: BSPHardwareVersions = 605028392;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A5X_EV: BSPHardwareVersions = 621805584;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A5X_EV_Y: BSPHardwareVersions = 621805585;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A5X_CAT: BSPHardwareVersions = 621805600;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_A5X_CAFE: BSPHardwareVersions = 621805608;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_B1X_EV: BSPHardwareVersions = 638582800;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_B1X_EV_Y: BSPHardwareVersions = 638582801;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_B1X_CAT: BSPHardwareVersions = 638582816;
pub const BSPHardwareVersions_BSP_HARDWARE_VERSION_LATTE_B1X_CAFE: BSPHardwareVersions = 638582824;
...
pub const MPTaskState_MP_TASK_STATE_INITIALISED: MPTaskState = 1;
pub const MPTaskState_MP_TASK_STATE_READY: MPTaskState = 2;
pub const MPTaskState_MP_TASK_STATE_RUNNING: MPTaskState = 4;
pub const MPTaskState_MP_TASK_STATE_FINISHED: MPTaskState = 8;
pub type MPTaskState = ::core::ffi::c_uint;
pub const MPTaskQueueState_MP_TASK_QUEUE_STATE_INITIALISED: MPTaskQueueState = 1;
pub const MPTaskQueueState_MP_TASK_QUEUE_STATE_READY: MPTaskQueueState = 2;
pub const MPTaskQueueState_MP_TASK_QUEUE_STATE_STOPPING: MPTaskQueueState = 4;
pub const MPTaskQueueState_MP_TASK_QUEUE_STATE_STOPPED: MPTaskQueueState = 8;
pub const MPTaskQueueState_MP_TASK_QUEUE_STATE_FINISHED: MPTaskQueueState = 16;
...
pub struct MPTaskQueue {
    ...
    pub tasksFinished: u32,
    pub __unk127: [::core::ffi::c_char; 8usize],
    pub queueIndex: u32,
    pub __unk128: [::core::ffi::c_char; 8usize],
    pub queueSize: u32,
...
extern "C" {
    #[doc = " Launches a title by its title ID.\n\n \\param titleId\n The ID of the title to launch.\n\n \\param argc\n The amount of argument strings.\n\n \\param ...\n Argument strings passed to the title as \\c argv.\n\n \\note\n Prefer using sysapp to launch titles instead."]
...
pub const OSMemoryMapMode_OS_MAP_MEMORY_INVALID: OSMemoryMapMode = 0;
pub const OSMemoryMapMode_OS_MAP_MEMORY_READ_ONLY: OSMemoryMapMode = 1;
pub const OSMemoryMapMode_OS_MAP_MEMORY_READ_WRITE: OSMemoryMapMode = 2;
pub const OSMemoryMapMode_OS_MAP_MEMORY_FREE: OSMemoryMapMode = 3;
pub const OSMemoryMapMode_OS_MAP_MEMORY_ALLOCATED: OSMemoryMapMode = 4;
...
pub struct FSADeviceInfo {
    pub __unk131: [::core::ffi::c_char; 8usize],
    pub deviceSizeInSectors: u64,
    pub deviceSectorSize: u32,
    pub __unk132: [::core::ffi::c_char; 20usize],
}
#[doc = " File System information."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSAFileSystemInfo {
    pub __unk133: [::core::ffi::c_char; 30usize],
}
pub const FSAMountPriority_FSA_MOUNT_PRIORITY_BASE: FSAMountPriority = 1;
pub const FSAMountPriority_FSA_MOUNT_PRIORITY_RAM_DISK_CACHE: FSAMountPriority = 4;
pub const FSAMountPriority_FSA_MOUNT_PRIORITY_TITLE_UPDATE: FSAMountPriority = 9;
pub const FSAMountPriority_FSA_MOUNT_PRIORITY_UNMOUNT_ALL: FSAMountPriority = 2147483648;
pub type FSAMountPriority = ::core::ffi::c_uint;
pub const FSAQueryInfoType_FSA_QUERY_INFO_FREE_SPACE_SIZE: FSAQueryInfoType = 0;
pub const FSAQueryInfoType_FSA_QUERY_INFO_DIR_SIZE: FSAQueryInfoType = 1;
pub const FSAQueryInfoType_FSA_QUERY_INFO_ENTRY_NUM: FSAQueryInfoType = 2;
pub const FSAQueryInfoType_FSA_QUERY_INFO_FILE_SYSTEM_INFO: FSAQueryInfoType = 3;
pub const FSAQueryInfoType_FSA_QUERY_INFO_DEVICE_INFO: FSAQueryInfoType = 4;
pub const FSAQueryInfoType_FSA_QUERY_INFO_STAT: FSAQueryInfoType = 5;
pub const FSAQueryInfoType_FSA_QUERY_INFO_BAD_BLOCK_INFO: FSAQueryInfoType = 6;
pub const FSAQueryInfoType_FSA_QUERY_INFO_JOURNAL_FREE_SPACE_SIZE: FSAQueryInfoType = 7;
pub const FSAQueryInfoType_FSA_QUERY_INFO_FRAGMENT_BLOCK_INFO: FSAQueryInfoType = 8;
pub type FSAQueryInfoType = ::core::ffi::c_uint;
pub const FSAReadFlag_FSA_READ_FLAG_NONE: FSAReadFlag = 0;
pub const FSAReadFlag_FSA_READ_FLAG_READ_WITH_POS: FSAReadFlag = 1;
pub type FSAReadFlag = ::core::ffi::c_uint;
pub const FSAWriteFlag_FSA_WRITE_FLAG_NONE: FSAWriteFlag = 0;
pub const FSAWriteFlag_FSA_WRITE_FLAG_READ_WITH_POS: FSAWriteFlag = 1;
...
#[doc = " Request data for Command::AppendFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::ChangeDir"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestChangeDir {
    pub path: [::core::ffi::c_char; 640usize],
}
#[doc = " Request data for Command::ChangeMode"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::CloseDir"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestCloseDir {
    pub handle: FSADirectoryHandle,
}
#[doc = " Request data for Command::CloseFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestCloseFile {
    pub handle: FSAFileHandle,
}
#[doc = " Request data for Command::FlushFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestFlushFile {
    pub handle: FSAFileHandle,
}
#[doc = " Request data for Command::FlushQuota"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestFlushQuota {
    pub path: [::core::ffi::c_char; 640usize],
}
#[doc = " Request data for Command::GetInfoByQuery"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::GetPosFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestGetPosFile {
    pub handle: FSAFileHandle,
}
#[doc = " Request data for Command::IsEof"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestIsEof {
    pub handle: FSAFileHandle,
}
#[doc = " Request data for Command::MakeDir"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::MakeQuota"]
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::Mount"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::MountWithProcess"]
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::OpenDir"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestOpenDir {
    pub path: [::core::ffi::c_char; 640usize],
}
#[doc = " Request data for Command::OpenFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::ReadDir"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestReadDir {
    pub handle: FSADirectoryHandle,
}
#[doc = " Request data for Command::ReadFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestReadFile {
    #[doc = "! Virtual pointer used only by Cafe, for IOS we should use ioctlv.vecs[1]"]
    pub buffer: *mut u8,
    pub size: u32,
    pub count: u32,
...
#[doc = " Request data for Command::Remove"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestRemove {
    pub path: [::core::ffi::c_char; 640usize],
}
#[doc = " Request data for Command::Rename"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::RewindDir"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestRewindDir {
    pub handle: FSADirectoryHandle,
}
#[doc = " Request data for Command::SetPosFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::StatFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestStatFile {
    pub handle: FSAFileHandle,
}
#[doc = " Request data for Command::TruncateFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSARequestTruncateFile {
    pub handle: FSAFileHandle,
}
#[doc = " Request data for Command::Unmount"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::UnmountWithProcess"]
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " Request data for Command::WriteFile"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub union FSARequest__bindgen_ty_1 {
    ...
    pub __unk138: [::core::ffi::c_char; 1308usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub union FSAResponse__bindgen_ty_1 {
    ...
    pub __unk139: [::core::ffi::c_char; 655usize],
}
pub const FSACommandEnum_FSA_COMMAND_INVALID: FSACommandEnum = 0;
pub const FSACommandEnum_FSA_COMMAND_MOUNT: FSACommandEnum = 1;
pub const FSACommandEnum_FSA_COMMAND_UNMOUNT: FSACommandEnum = 2;
pub const FSACommandEnum_FSA_COMMAND_GET_VOLUME_INFO: FSACommandEnum = 3;
pub const FSACommandEnum_FSA_COMMAND_GET_ATTACH: FSACommandEnum = 4;
pub const FSACommandEnum_FSA_COMMAND_CHANGE_DIR: FSACommandEnum = 5;
pub const FSACommandEnum_FSA_COMMAND_GET_CWD: FSACommandEnum = 6;
pub const FSACommandEnum_FSA_COMMAND_MAKE_DIR: FSACommandEnum = 7;
pub const FSACommandEnum_FSA_COMMAND_REMOVE: FSACommandEnum = 8;
pub const FSACommandEnum_FSA_COMMAND_RENAME: FSACommandEnum = 9;
pub const FSACommandEnum_FSA_COMMAND_OPEN_DIR: FSACommandEnum = 10;
pub const FSACommandEnum_FSA_COMMAND_READ_DIR: FSACommandEnum = 11;
pub const FSACommandEnum_FSA_COMMAND_REWIND_DIR: FSACommandEnum = 12;
pub const FSACommandEnum_FSA_COMMAND_CLOSE_DIR: FSACommandEnum = 13;
pub const FSACommandEnum_FSA_COMMAND_OPEN_FILE: FSACommandEnum = 14;
pub const FSACommandEnum_FSA_COMMAND_READ_FILE: FSACommandEnum = 15;
pub const FSACommandEnum_FSA_COMMAND_WRITE_FILE: FSACommandEnum = 16;
pub const FSACommandEnum_FSA_COMMAND_GET_POS_FILE: FSACommandEnum = 17;
pub const FSACommandEnum_FSA_COMMAND_SET_POS_FILE: FSACommandEnum = 18;
pub const FSACommandEnum_FSA_COMMAND_IS_EOF: FSACommandEnum = 19;
pub const FSACommandEnum_FSA_COMMAND_STAT_FILE: FSACommandEnum = 20;
pub const FSACommandEnum_FSA_COMMAND_CLOSE_FILE: FSACommandEnum = 21;
pub const FSACommandEnum_FSA_COMMAND_GET_ERROR: FSACommandEnum = 22;
pub const FSACommandEnum_FSA_COMMAND_FLUSH_FILE: FSACommandEnum = 23;
pub const FSACommandEnum_FSA_COMMAND_GET_INFO_BY_QUERY: FSACommandEnum = 24;
pub const FSACommandEnum_FSA_COMMAND_APPEND_FILE: FSACommandEnum = 25;
pub const FSACommandEnum_FSA_COMMAND_TRUNCATE_FILE: FSACommandEnum = 26;
pub const FSACommandEnum_FSA_COMMAND_FLUSH_VOLUME: FSACommandEnum = 27;
pub const FSACommandEnum_FSA_COMMAND_ROLLBACK_VOLUME: FSACommandEnum = 28;
pub const FSACommandEnum_FSA_COMMAND_MAKE_QUOTA: FSACommandEnum = 29;
pub const FSACommandEnum_FSA_COMMAND_FLUSH_QUOTA: FSACommandEnum = 30;
pub const FSACommandEnum_FSA_COMMAND_ROLLBACK_QUOTA: FSACommandEnum = 31;
pub const FSACommandEnum_FSA_COMMAND_CHANGE_MODE: FSACommandEnum = 32;
pub const FSACommandEnum_FSA_COMMAND_OPEN_FILE_BY_STAT: FSACommandEnum = 33;
pub const FSACommandEnum_FSA_COMMAND_REGISTER_FLUSH_QUOTA: FSACommandEnum = 34;
pub const FSACommandEnum_FSA_COMMAND_FLUSH_MULTI_QUOTA: FSACommandEnum = 35;
pub const FSACommandEnum_FSA_COMMAND_GET_FILE_BLOCK_ADDRESS: FSACommandEnum = 37;
pub const FSACommandEnum_FSA_COMMAND_ADD_USER_PROCESS: FSACommandEnum = 101;
pub const FSACommandEnum_FSA_COMMAND_DEL_USER_PROCESS: FSACommandEnum = 102;
pub const FSACommandEnum_FSA_COMMAND_MOUNT_WITH_PROCESS: FSACommandEnum = 103;
pub const FSACommandEnum_FSA_COMMAND_UNMOUNT_WITH_PROCESS: FSACommandEnum = 104;
pub const FSACommandEnum_FSA_COMMAND_FORMAT: FSACommandEnum = 105;
pub const FSACommandEnum_FSA_COMMAND_RAW_OPEN: FSACommandEnum = 106;
pub const FSACommandEnum_FSA_COMMAND_RAW_READ: FSACommandEnum = 107;
pub const FSACommandEnum_FSA_COMMAND_RAW_WRITE: FSACommandEnum = 108;
pub const FSACommandEnum_FSA_COMMAND_RAW_CLOSE: FSACommandEnum = 109;
pub const FSACommandEnum_FSA_COMMAND_GET_LAST_FAILED_VOLUME: FSACommandEnum = 110;
pub const FSACommandEnum_FSA_COMMAND_GET_VOLUME_EXISTENCE: FSACommandEnum = 111;
pub const FSACommandEnum_FSA_COMMAND_CHANGE_OWNER: FSACommandEnum = 112;
pub const FSACommandEnum_FSA_COMMAND_CANCEL_GET_ATTACH: FSACommandEnum = 113;
pub const FSACommandEnum_FSA_COMMAND_REMOVE_QUOTA: FSACommandEnum = 114;
pub const FSACommandEnum_FSA_COMMAND_SET_CLIENT_PRIORITY: FSACommandEnum = 115;
pub const FSACommandEnum_FSA_COMMAND_APPLY_MEMORY_CACHE: FSACommandEnum = 116;
pub const FSACommandEnum_FSA_COMMAND_MAKE_LINK: FSACommandEnum = 117;
pub const FSACommandEnum_FSA_COMMAND_XFER_PARAMS: FSACommandEnum = 118;
pub const FSACommandEnum_FSA_COMMAND_EXEC_DEBUG_PROC: FSACommandEnum = 120;
pub const FSACommandEnum_FSA_COMMAND_DEBUG_SET_TITLE_ID: FSACommandEnum = 121;
pub const FSACommandEnum_FSA_COMMAND_DEBUG_SET_CAPABILITY: FSACommandEnum = 122;
pub const FSACommandEnum_FSA_COMMAND_SET_PROCESS_CONFIG: FSACommandEnum = 130;
pub const FSACommandEnum_FSA_COMMAND_CONFIG_SET_MEMORY_CACHE: FSACommandEnum = 131;
pub const FSACommandEnum_FSA_COMMAND_CONFIG_UNSET_MEMORY_CACHE: FSACommandEnum = 132;
pub const FSACommandEnum_FSA_COMMAND_CONFIG_SET_PRF2_CHAR_CODE: FSACommandEnum = 133;
pub const FSACommandEnum_FSA_COMMAND_GET_PROC_RESOURCE_USAGE: FSACommandEnum = 140;
pub const FSACommandEnum_FSA_COMMAND_GET_ALL_RESOURCE_USAGE: FSACommandEnum = 141;
pub const FSACommandEnum_FSA_COMMAND_SEND_PROFILE_CMD: FSACommandEnum = 142;
pub type FSACommandEnum = ::core::ffi::c_uint;
pub const FSAIpcRequestTypeEnum_FSA_IPC_REQUEST_IOCTL: FSAIpcRequestTypeEnum = 0;
pub const FSAIpcRequestTypeEnum_FSA_IPC_REQUEST_IOCTLV: FSAIpcRequestTypeEnum = 1;
pub type FSAIpcRequestTypeEnum = ::core::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FSAAsyncResult {
    #[doc = "! Queue to put a message on when command is complete."]
    pub ioMsgQueue: *mut OSMessageQueue,
    #[doc = "! Message used for ioMsgQueue."]
    pub msg: FSMessage,
    #[doc = "! Callback to call when the command is complete."]
    pub userCallback: FSAAsyncCallbackFn,
    #[doc = "! Result."]
    pub error: FSError,
    #[doc = "! FSA command."]
    pub command: FSACommand,
    #[doc = "! Pointer to allocated FSA IPC Request."]
    pub request: *mut FSARequest,
    #[doc = "! Pointer to allocated FSA IPC Response."]
...
pub struct FSAShimBuffer {
    #[doc = "! Buffer for FSA IPC request."]
    pub request: FSARequest,
    pub __unk140: [::core::ffi::c_char; 96usize],
    #[doc = "! Buffer for FSA IPC response."]
    pub response: FSAResponse,
    pub __unk141: [::core::ffi::c_char; 109usize],
    #[doc = "! Memory to use for ioctlv calls, unknown maximum count - but at least 3."]
    pub ioctlvVec: [IOSVec; 3usize],
    pub __unk142: [::core::ffi::c_char; 92usize],
    #[doc = "! Command for FSA."]
    pub command: FSACommand,
    #[doc = "! Handle to FSA device."]
    pub clientHandle: u32,
    #[doc = "! IOS IPC request type to use."]
    pub ipcReqType: FSAIpcRequestType,
    #[doc = "! Number of ioctlv input vectors."]
    pub ioctlvVecIn: u8,
    #[doc = "! Number of ioctlv output vectors."]
    pub ioctlvVecOut: u8,
    #[doc = "! FSAAsyncResult used for FSA* functions."]
...
pub struct FSAClientAttachAsyncData {
    #[doc = "! Callback to call when an attach has happened."]
...
pub const FSAMountFlags_FSA_MOUNT_FLAG_LOCAL_MOUNT: FSAMountFlags = 0;
pub const FSAMountFlags_FSA_MOUNT_FLAG_BIND_MOUNT: FSAMountFlags = 1;
pub const FSAMountFlags_FSA_MOUNT_FLAG_GLOBAL_MOUNT: FSAMountFlags = 2;
pub type FSAMountFlags = ::core::ffi::c_uint;
pub const FSAUnmountFlags_FSA_UNMOUNT_FLAG_NONE: FSAUnmountFlags = 0;
pub const FSAUnmountFlags_FSA_UNMOUNT_FLAG_FORCE: FSAUnmountFlags = 2;
pub const FSAUnmountFlags_FSA_UNMOUNT_FLAG_BIND_MOUNT: FSAUnmountFlags = 2147483648;
...
extern "C" {
    #[doc = " Frees the FSAShimBuffer where the given asyncResult is part of\n @param asyncResult"]
...
extern "C" {
    #[doc = " Get the current time on the stopwatch\n \\returns current time on stopwatch"]
    pub fn OSStopWatchLap(stopWatch: *mut OSStopWatchAtomic) -> OSTime;
}
extern "C" {
    #[doc = " Stops and resets the stop watch.\n Clears start and total time\n \\returns previous total time"]
    pub fn OSStopWatchReset(stopWatch: *mut OSStopWatchAtomic) -> OSTime;
}
pub const OSPerfMonArg_OS_PM_ARG_MMCR0: OSPerfMonArg = 1;
pub const OSPerfMonArg_OS_PM_ARG_MMCR1: OSPerfMonArg = 2;
pub const OSPerfMonArg_OS_PM_ARG_PMC1: OSPerfMonArg = 4;
pub const OSPerfMonArg_OS_PM_ARG_PMC2: OSPerfMonArg = 8;
pub const OSPerfMonArg_OS_PM_ARG_PMC3: OSPerfMonArg = 16;
pub const OSPerfMonArg_OS_PM_ARG_PMC4: OSPerfMonArg = 32;
#[doc = " Used to tell OSSetPerformanceMonitor() which arguments are valid."]
pub type OSPerfMonArg = ::core::ffi::c_uint;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_CURRENT: OSPerfMonMMCR0Flags = 0;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_CPU_CYCLES: OSPerfMonMMCR0Flags = 64;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_INSTRUCTIONS_COMPLETED: OSPerfMonMMCR0Flags = 128;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_TBL_RISING_TRANSITIONS: OSPerfMonMMCR0Flags = 192;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_INSTRUCTIONS_DISPATCHED: OSPerfMonMMCR0Flags = 256;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_EIEIO_INSTRUCTIONS_COMPLETED: OSPerfMonMMCR0Flags =
    320;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_ITLB_SEARCH_CYCLES: OSPerfMonMMCR0Flags = 384;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_L2_HITS: OSPerfMonMMCR0Flags = 448;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_INSTRUCTIONS_EA_DELIVERED: OSPerfMonMMCR0Flags = 512;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_INSTRUCTIONS_COMPLETED_MATCHES_IABR:
    OSPerfMonMMCR0Flags = 576;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_SLOW_L1_MISSES: OSPerfMonMMCR0Flags = 640;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_UNRESOLVED_BRANCHES: OSPerfMonMMCR0Flags = 704;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_UNRESOLVED_STALL_CYCLES: OSPerfMonMMCR0Flags = 768;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_L1_SHARED_STORES: OSPerfMonMMCR0Flags = 896;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_L2_SHARED_INTERVENTIONS: OSPerfMonMMCR0Flags = 960;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_CACHE_PARADOXES: OSPerfMonMMCR0Flags = 1024;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_CIU_LOAD_REQUESTS: OSPerfMonMMCR0Flags = 1280;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_BIU_ADDRESS_ONLY_REQUESTS: OSPerfMonMMCR0Flags =
    1344;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_CIU_PARADOXES: OSPerfMonMMCR0Flags = 1408;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC1_60XE_BUS_DATA_BEATS: OSPerfMonMMCR0Flags = 1472;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_CURRENT: OSPerfMonMMCR0Flags = 0;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_CPU_CYCLES: OSPerfMonMMCR0Flags = 1;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_INSTRUCTIONS_COMPLETED: OSPerfMonMMCR0Flags = 2;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_TBL_RISING_TRANSITIONS: OSPerfMonMMCR0Flags = 3;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_INSTRUCTIONS_DISPATCHED: OSPerfMonMMCR0Flags = 4;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_L1_ICACHE_MISSES: OSPerfMonMMCR0Flags = 5;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_ITLB_MISSES: OSPerfMonMMCR0Flags = 6;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_L2_INSTRUCTION_MISSES: OSPerfMonMMCR0Flags = 7;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_PRED_BRANCHES_NOT_TAKEN: OSPerfMonMMCR0Flags = 8;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_RESERVED_LOADS: OSPerfMonMMCR0Flags = 10;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_LOADS_AND_STORES: OSPerfMonMMCR0Flags = 11;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_CACHE_SNOOPS: OSPerfMonMMCR0Flags = 12;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_L1_TO_L2_CASTOUTS: OSPerfMonMMCR0Flags = 13;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_SYSTEM_UNIT_INSTRUCTIONS: OSPerfMonMMCR0Flags = 14;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_L1_INSTRUCTION_MISS_CYCLES: OSPerfMonMMCR0Flags = 15;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_FIRST_SPECULATIVE_BRANCH_RESOLVES:
    OSPerfMonMMCR0Flags = 16;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_L2_SHARED_STORES: OSPerfMonMMCR0Flags = 17;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_L1_SHARED_INTERVENTIONS: OSPerfMonMMCR0Flags = 18;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_CIU_STORE_REQUESTS: OSPerfMonMMCR0Flags = 20;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_SLOW_OUTSTANDING_BIU_TRANSACTIONS:
    OSPerfMonMMCR0Flags = 21;
pub const OSPerfMonMMCR0Flags_OS_PM_MMCR0_PMC2_CIU_MODIFIED_INTERVENTIONS: OSPerfMonMMCR0Flags = 22;
#[doc = " Flags to write to (U)MMCR0 register.\n\n \\sa OSSetPerformanceMonitor"]
pub type OSPerfMonMMCR0Flags = ::core::ffi::c_uint;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_CURRENT: OSPerfMonMMCR1Flags = 0;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_CPU_CYCLES: OSPerfMonMMCR1Flags = 134217728;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_INSTRUCTIONS_COMPLETED: OSPerfMonMMCR1Flags =
    268435456;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_TBL_RISING_TRANSITIONS: OSPerfMonMMCR1Flags =
    402653184;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_INSTRUCTIONS_DISPATCHED: OSPerfMonMMCR1Flags =
    536870912;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_L1_DCACHE_MISSES: OSPerfMonMMCR1Flags = 671088640;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_DTLB_MISSES: OSPerfMonMMCR1Flags = 805306368;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_L2_DATA_MISSES: OSPerfMonMMCR1Flags = 939524096;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_PRED_BRANCHES_TAKEN: OSPerfMonMMCR1Flags =
    1073741824;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_COND_STORES_COMPLETED: OSPerfMonMMCR1Flags =
    1342177280;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_FPU_INSTRUCTIONS_COMPLETED: OSPerfMonMMCR1Flags =
    1476395008;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_L2_CASTOUTS_BY_SNOOPS: OSPerfMonMMCR1Flags =
    1610612736;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_L2_CACHE_OPERATIONS: OSPerfMonMMCR1Flags =
    1744830464;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_L1_LOAD_MISS_CYCLES: OSPerfMonMMCR1Flags =
    2013265920;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_SECOND_SPECULATIVE_BRANCH_RESOLVES:
    OSPerfMonMMCR1Flags = 2147483648;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_BPU_STALL_LR_CR_CYCLES: OSPerfMonMMCR1Flags =
    2281701376;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_L1_MODIFIED_INTERVENTIONS: OSPerfMonMMCR1Flags =
    2415919104;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_ICBI_SNOOPS: OSPerfMonMMCR1Flags = 2550136832;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_CIU_ADDRESS_ONLY_REQUESTS: OSPerfMonMMCR1Flags =
    2684354560;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_BIU_LOAD_REQUESTS: OSPerfMonMMCR1Flags = 2818572288;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC3_CIU_SHARED_INTERVENTIONS: OSPerfMonMMCR1Flags =
    2952790016;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_CURRENT: OSPerfMonMMCR1Flags = 0;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_CPU_CYCLES: OSPerfMonMMCR1Flags = 4194304;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_INSTRUCTIONS_COMPLETED: OSPerfMonMMCR1Flags =
    8388608;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_TBL_RISING_TRANSITIONS: OSPerfMonMMCR1Flags =
    12582912;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_INSTRUCTIONS_DISPATCHED: OSPerfMonMMCR1Flags =
    16777216;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_L2_CASTOUTS: OSPerfMonMMCR1Flags = 20971520;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_DTLB_SEARCH_CYCLES: OSPerfMonMMCR1Flags = 25165824;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_BRANCHES_MISPREDICTED: OSPerfMonMMCR1Flags =
    33554432;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_INTACT_COND_STORES_COMPLETED: OSPerfMonMMCR1Flags =
    41943040;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_SYNC_INSTRUCTIONS_COMPLETED: OSPerfMonMMCR1Flags =
    46137344;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_SNOOP_RETRIES: OSPerfMonMMCR1Flags = 50331648;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_INTEGER_OPERATIONS: OSPerfMonMMCR1Flags = 54525952;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_BPU_STALL_TWO_BRANCHES_CYCLES: OSPerfMonMMCR1Flags =
    58720256;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_L2_MODIFIED_INTERVENTIONS: OSPerfMonMMCR1Flags =
    67108864;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_TLBIE_SNOOPS: OSPerfMonMMCR1Flags = 71303168;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_L2_BANK_REFRESH_OVERFLOWS: OSPerfMonMMCR1Flags =
    75497472;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_CIU_ARTRY_COUNT: OSPerfMonMMCR1Flags = 83886080;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_BIU_STORE_REQUESTS: OSPerfMonMMCR1Flags = 88080384;
pub const OSPerfMonMMCR1Flags_OS_PM_MMCR1_PMC4_CIU_TWO_CORE_SHARED_INTERVENTIONS:
    OSPerfMonMMCR1Flags = 92274688;
#[doc = " Flags to write to (U)MMCR1 register.\n\n \\sa OSSetPerformanceMonitor"]
pub type OSPerfMonMMCR1Flags = ::core::ffi::c_uint;
extern "C" {
    #[doc = " Write to performance monitor registers.\n\n Performance monitor registers can only be written by the kernel, this allows userspace\n to write to them.\n\n \\param arg_mask OR-ed values from `OSPerfMonArg`, indicating which of the following\n arguments are to be written to registers.\n\n \\param mmcr0 OR-ed values from `OSPerfMonMMCR0Flags` to write to register MMCR0.\n \\param mmcr1 OR-ed values from `OSPerfMonMMCR1Flags` to write to register MMCR1.\n \\param pmc1 Value to write to register PMC1.\n \\param pmc2 Value to write to register PMC2.\n \\param pmc3 Value to write to register PMC3.\n \\param pmc4 Value to write to register PMC4."]
...
pub const MEMFrmHeapFreeMode_MEM_FRM_HEAP_FREE_HEAD: MEMFrmHeapFreeMode = 1;
pub const MEMFrmHeapFreeMode_MEM_FRM_HEAP_FREE_TAIL: MEMFrmHeapFreeMode = 2;
pub const MEMFrmHeapFreeMode_MEM_FRM_HEAP_FREE_ALL: MEMFrmHeapFreeMode = 3;
...
pub const OSCodegenSecMode_CODEGEN_RW_: OSCodegenSecMode = 0;
#[doc = "! The area can be read or executed, but not written to."]
pub const OSCodegenSecMode_CODEGEN_R_X: OSCodegenSecMode = 1;
...
pub const OSMemoryType_OS_MEM1: OSMemoryType = 1;
pub const OSMemoryType_OS_MEM2: OSMemoryType = 2;
pub type OSMemoryType = ::core::ffi::c_uint;
pub const OSSharedDataType_OS_SHAREDDATATYPE_FONT_CHINESE: OSSharedDataType = 0;
pub const OSSharedDataType_OS_SHAREDDATATYPE_FONT_KOREAN: OSSharedDataType = 1;
pub const OSSharedDataType_OS_SHAREDDATATYPE_FONT_STANDARD: OSSharedDataType = 2;
pub const OSSharedDataType_OS_SHAREDDATATYPE_FONT_TAIWANESE: OSSharedDataType = 3;
pub const OSSharedDataType_OS_SHAREDDATATYPE_FONT_MAX: OSSharedDataType = 4;
...
pub const OSScreenID_SCREEN_TV: OSScreenID = 0;
#[doc = "! Represents the screen in the DRC (gamepad)."]
pub const OSScreenID_SCREEN_DRC: OSScreenID = 1;
